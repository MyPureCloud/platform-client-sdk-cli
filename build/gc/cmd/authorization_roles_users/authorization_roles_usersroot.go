...
func init() {
	...
	authorization_roles_usersCmd.Short = utils.GenerateCustomDescription(authorization_roles_usersCmd.Short, authorization_roles_users_remove.Description, authorization_roles_users_add.Description, )
