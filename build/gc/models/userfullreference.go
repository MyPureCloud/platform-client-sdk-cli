...
var (
    UserfullreferenceMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type UserfullreferenceDud struct { 
...
func (u *Userfullreference) MarshalJSON() ([]byte, error) {
    type Alias Userfullreference

    if UserfullreferenceMarshalled {
        return []byte("{}"), nil
    }
    UserfullreferenceMarshalled = true
