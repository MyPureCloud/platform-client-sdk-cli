...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/knowledge_knowledgebases_contexts"
)
...
func init() {
	...
	knowledge_knowledgebasesCmd.AddCommand(knowledge_knowledgebases_contexts.Cmdknowledge_knowledgebases_contexts())
	knowledge_knowledgebasesCmd.Short = utils.GenerateCustomDescription(knowledge_knowledgebasesCmd.Short, knowledge_knowledgebases_search.Description, knowledge_knowledgebases_languages.Description, knowledge_knowledgebases_contexts.Description, )
