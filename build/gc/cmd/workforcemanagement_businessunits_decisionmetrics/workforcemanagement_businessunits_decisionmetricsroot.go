...
func init() {
	...
	workforcemanagement_businessunits_decisionmetricsCmd.Short = utils.GenerateCustomDescription(workforcemanagement_businessunits_decisionmetricsCmd.Short, workforcemanagement_businessunits_decisionmetrics_jobs.Description, workforcemanagement_businessunits_decisionmetrics_update.Description, )
