...
var (
    WorkitemversionMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type WorkitemversionDud struct { 
    Id string `json:"id"`
...
func (u *Workitemversion) MarshalJSON() ([]byte, error) {
    type Alias Workitemversion

    if WorkitemversionMarshalled {
        return []byte("{}"), nil
    }
    WorkitemversionMarshalled = true
