...
func init() {
	...
	workforcemanagement_agentsCmd.Short = utils.GenerateCustomDescription(workforcemanagement_agentsCmd.Short, workforcemanagement_agents_me.Description, workforcemanagement_agents_managementunit.Description, workforcemanagement_agents_adherence.Description, workforcemanagement_agents_integrations.Description, )
