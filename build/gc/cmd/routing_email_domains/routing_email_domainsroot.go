...
func init() {
	...
	routing_email_domainsCmd.Short = utils.GenerateCustomDescription(routing_email_domainsCmd.Short, routing_email_domains_validate.Description, routing_email_domains_testconnection.Description, routing_email_domains_dkim.Description, routing_email_domains_verification.Description, routing_email_domains_mailfrom.Description, routing_email_domains_routes.Description, )
