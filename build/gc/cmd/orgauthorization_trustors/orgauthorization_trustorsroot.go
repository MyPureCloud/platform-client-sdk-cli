...
func init() {
	...
	orgauthorization_trustorsCmd.Short = utils.GenerateCustomDescription(orgauthorization_trustorsCmd.Short, orgauthorization_trustors_clonedusers.Description, orgauthorization_trustors_users.Description, )
