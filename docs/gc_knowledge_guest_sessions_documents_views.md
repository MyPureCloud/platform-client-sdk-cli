## gc knowledge guest sessions documents views
...
* [gc knowledge guest sessions documents views create](gc_knowledge_guest_sessions_documents_views_create.html)	 - Create view event for a document.
