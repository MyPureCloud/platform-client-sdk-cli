...
var (
    JourneyasyncaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type JourneyasyncaggregationqueryDud struct { 
...
type Journeyasyncaggregationquery struct { 
...
func (o *Journeyasyncaggregationquery) String() string {
...
func (u *Journeyasyncaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Journeyasyncaggregationquery

    if JourneyasyncaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    JourneyasyncaggregationqueryMarshalled = true
