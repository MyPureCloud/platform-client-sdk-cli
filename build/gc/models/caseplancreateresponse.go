...
var (
    CaseplancreateresponseMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type CaseplancreateresponseDud struct { 
    Id string `json:"id"`
...
type Caseplancreateresponse struct { 
...
func (o *Caseplancreateresponse) String() string {
...
func (u *Caseplancreateresponse) MarshalJSON() ([]byte, error) {
    type Alias Caseplancreateresponse

    if CaseplancreateresponseMarshalled {
        return []byte("{}"), nil
    }
    CaseplancreateresponseMarshalled = true
