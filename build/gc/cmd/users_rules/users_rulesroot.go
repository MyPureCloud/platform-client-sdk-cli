...
func init() {
	...
	users_rulesCmd.Short = utils.GenerateCustomDescription(users_rulesCmd.Short, users_rules_dependents.Description, users_rules_settings.Description, users_rules_query.Description, )
