## gc businessrules decisiontables versions rows bulk update
...
* [gc businessrules decisiontables versions rows bulk update create](gc_businessrules_decisiontables_versions_rows_bulk_update_create.html)	 - Bulk update decision table rows
