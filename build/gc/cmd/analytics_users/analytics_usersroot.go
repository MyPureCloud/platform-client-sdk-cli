...
func init() {
	...
	analytics_usersCmd.Short = utils.GenerateCustomDescription(analytics_usersCmd.Short, analytics_users_details.Description, analytics_users_observations.Description, analytics_users_aggregates.Description, )
