## gc usage client aggregates query jobs list
...
```
gc usage client aggregates query jobs list [clientId] [jobId] [flags]
```
...
```
  ...
  -h, --help                     help for list
      --pageSize string          Page size of the results. Max is 1000. (default "100")
