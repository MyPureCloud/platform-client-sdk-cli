...
func init() {
	...
	analytics_actions_aggregatesCmd.Short = utils.GenerateCustomDescription(analytics_actions_aggregatesCmd.Short, analytics_actions_aggregates_jobs.Description, analytics_actions_aggregates_query.Description, )
