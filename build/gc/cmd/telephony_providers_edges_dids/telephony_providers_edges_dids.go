...
var (
	Description = utils.FormatUsageDescription("telephony_providers_edges_dids", "SWAGGER_OVERRIDE_/api/v2/telephony/providers/edges/dids", "SWAGGER_OVERRIDE_/api/v2/telephony/providers/edges/dids", )
...
var listCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if didPoolId != "" {
			queryParams["didPool.id"] = didPoolId
		}
