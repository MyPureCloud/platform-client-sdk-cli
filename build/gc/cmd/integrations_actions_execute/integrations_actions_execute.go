...
func Cmdintegrations_actions_execute() *cobra.Command { 
	createCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", createCmd.UsageTemplate(), "POST", "/api/v2/integrations/actions/{actionId}/execute", utils.FormatPermissions([]string{ "integrations:action:execute", "bridge:actions:execute",  })))
