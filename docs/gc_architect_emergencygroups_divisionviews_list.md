## gc architect emergencygroups divisionviews list
...
```
gc architect emergencygroups divisionviews list [flags]
```
...
```
  ...
  -h, --help                     help for list
      --id strings               ID of the Emergency Groups to filter by.
