## gc knowledge knowledgebases documents feedback update
...
```
gc knowledge knowledgebases documents feedback update [knowledgeBaseId] [documentId] [feedbackId] [flags]
```
