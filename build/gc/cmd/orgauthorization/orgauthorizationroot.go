...
func init() {
	...
	orgauthorizationCmd.Short = utils.GenerateCustomDescription(orgauthorizationCmd.Short, orgauthorization_trustors.Description, orgauthorization_trustees.Description, orgauthorization_trustor.Description, orgauthorization_pairings.Description, )
