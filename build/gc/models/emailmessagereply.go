...
var (
    EmailmessagereplyMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type EmailmessagereplyDud struct { 
...
func (u *Emailmessagereply) MarshalJSON() ([]byte, error) {
    type Alias Emailmessagereply

    if EmailmessagereplyMarshalled {
        return []byte("{}"), nil
    }
    EmailmessagereplyMarshalled = true
