...
func init() {
	...
	recordings_screensessionsCmd.Short = utils.GenerateCustomDescription(recordings_screensessionsCmd.Short, recordings_screensessions_metadata.Description, recordings_screensessions_details.Description, recordings_screensessions_acknowledge.Description, )
