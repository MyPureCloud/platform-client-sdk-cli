...
func Cmdusers_station_associatedstation() *cobra.Command { 
	deleteCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", deleteCmd.UsageTemplate(), "DELETE", "/api/v2/users/{userId}/station/associatedstation", utils.FormatPermissions([]string{ "telephony:station:disassociate",  }), utils.GenerateDevCentreLink("DELETE", "Users", "/api/v2/users/{userId}/station/associatedstation")))
  ...
  "content" : { }
	...
	updateCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", updateCmd.UsageTemplate(), "PUT", "/api/v2/users/{userId}/station/associatedstation/{stationId}", utils.FormatPermissions([]string{ "telephony:otherStationAssociation:edit",  }), utils.GenerateDevCentreLink("PUT", "Users", "/api/v2/users/{userId}/station/associatedstation/{stationId}")))
