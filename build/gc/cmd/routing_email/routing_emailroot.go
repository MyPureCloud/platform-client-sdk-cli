...
func init() {
	...
	routing_emailCmd.Short = utils.GenerateCustomDescription(routing_emailCmd.Short, routing_email_domains.Description, routing_email_setup.Description, routing_email_outbound.Description, )
