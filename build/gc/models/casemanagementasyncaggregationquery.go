...
var (
    CasemanagementasyncaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type CasemanagementasyncaggregationqueryDud struct { 
...
type Casemanagementasyncaggregationquery struct { 
    ...
    Filter Casemanagementaggregatequeryfilter `json:"filter"`
    ...
    Views []Casemanagementaggregationview `json:"views"`
...
func (o *Casemanagementasyncaggregationquery) String() string {
     ...
     o.Views = []Casemanagementaggregationview{{}} 
...
func (u *Casemanagementasyncaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Casemanagementasyncaggregationquery

    if CasemanagementasyncaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    CasemanagementasyncaggregationqueryMarshalled = true
    ...
    return json.Marshal(&struct {
        ...
        *Alias
        ...
        Views: []Casemanagementaggregationview{{}},
