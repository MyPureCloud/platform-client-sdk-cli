...
var (
    TelephonysearchcriteriaMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type TelephonysearchcriteriaDud struct { 
...
type Telephonysearchcriteria struct { 
    ...
    Group []Telephonysearchcriteria `json:"group"`
...
func (o *Telephonysearchcriteria) String() string {
    
     o.Values = []string{""} 
    
    
    
     o.Group = []Telephonysearchcriteria{{}} 
...
func (u *Telephonysearchcriteria) MarshalJSON() ([]byte, error) {
    type Alias Telephonysearchcriteria

    if TelephonysearchcriteriaMarshalled {
        return []byte("{}"), nil
    }
    TelephonysearchcriteriaMarshalled = true
