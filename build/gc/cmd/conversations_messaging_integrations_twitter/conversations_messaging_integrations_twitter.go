...
func Cmdconversations_messaging_integrations_twitter() *cobra.Command { 
	createCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", createCmd.UsageTemplate(), "POST", "/api/v2/conversations/messaging/integrations/twitter", utils.FormatPermissions([]string{ "messaging:XIntegration:add",  }), utils.GenerateDevCentreLink("POST", "Conversations", "/api/v2/conversations/messaging/integrations/twitter")))
	utils.AddFileFlagIfUpsert(createCmd.Flags(), "POST", `{
  "description" : "TwitterIntegrationRequest",
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/TwitterIntegrationRequest"
      }
    }
  },
  "required" : true
  ...
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/TwitterIntegration"
      }
    }
  }
}`)
  ...
  "content" : {
	...
	updateCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", updateCmd.UsageTemplate(), "PATCH", "/api/v2/conversations/messaging/integrations/twitter/{integrationId}", utils.FormatPermissions([]string{ "messaging:XIntegration:edit",  }), utils.GenerateDevCentreLink("PATCH", "Conversations", "/api/v2/conversations/messaging/integrations/twitter/{integrationId}")))
	utils.AddFileFlagIfUpsert(updateCmd.Flags(), "PATCH", `{
  "description" : "TwitterIntegrationUpdateRequest",
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/TwitterIntegrationUpdateRequest"
      }
    }
  },
  "required" : true
...
var createCmd = &cobra.Command{
	Use:   "create",
	Short: "Create Twitter Integration",
	Long:  "Create Twitter Integration",
...
var deleteCmd = &cobra.Command{
	...
	Short: "Delete Twitter messaging integration",
	Long:  "Delete Twitter messaging integration",
...
var getCmd = &cobra.Command{
	...
	Short: "Get Twitter messaging integration",
	Long:  "Get Twitter messaging integration",
	Args:  utils.DetermineArgs([]string{ "integrationId", }),
...
var updateCmd = &cobra.Command{
	...
	Short: "Update a Twitter messaging integration",
	Long:  "Update a Twitter messaging integration",
	Args:  utils.DetermineArgs([]string{ "integrationId", }),
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if printReqBody {
			...
			reqModel := models.Twitterintegrationupdaterequest{}
			utils.Render(reqModel.String())
