...
func init() {
	...
	journeyCmd.Short = utils.GenerateCustomDescription(journeyCmd.Short, journey_segments.Description, journey_outcomes.Description, journey_actiontemplates.Description, journey_actiontargets.Description, journey_actionmaps.Description, )
