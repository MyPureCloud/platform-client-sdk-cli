...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/assistants_variations"
...
func init() {
	...
	assistantsCmd.AddCommand(assistants_variations.Cmdassistants_variations())
	assistantsCmd.AddCommand(assistants_queues.Cmdassistants_queues())
	assistantsCmd.Short = utils.GenerateCustomDescription(assistantsCmd.Short, assistants_agentchecklists.Description, assistants_copilot.Description, assistants_variations.Description, assistants_queues.Description, )
