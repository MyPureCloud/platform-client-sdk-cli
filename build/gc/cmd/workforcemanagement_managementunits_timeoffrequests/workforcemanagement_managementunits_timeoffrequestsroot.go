...
func init() {
	...
	workforcemanagement_managementunits_timeoffrequestsCmd.Short = utils.GenerateCustomDescription(workforcemanagement_managementunits_timeoffrequestsCmd.Short, workforcemanagement_managementunits_timeoffrequests_query.Description, workforcemanagement_managementunits_timeoffrequests_users.Description, workforcemanagement_managementunits_timeoffrequests_integrationstatus.Description, workforcemanagement_managementunits_timeoffrequests_waitlistpositions.Description, )
