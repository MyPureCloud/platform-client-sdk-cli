...
func init() {
	...
	contentmanagement_workspacesCmd.Short = utils.GenerateCustomDescription(contentmanagement_workspacesCmd.Short, contentmanagement_workspaces_tagvalues.Description, contentmanagement_workspaces_documents.Description, contentmanagement_workspaces_members.Description, )
