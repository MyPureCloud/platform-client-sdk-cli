...
var (
	Description = utils.FormatUsageDescription("webchat_settings", "SWAGGER_OVERRIDE_/api/v2/webchat/settings", "SWAGGER_OVERRIDE_/api/v2/webchat/settings", "SWAGGER_OVERRIDE_/api/v2/webchat/settings", )
	webchat_settingsCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("webchat_settings"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(webchat_settingsCmd)
}
...
var deleteCmd = &cobra.Command{
	Use:   "delete",
	Short: "Remove WebChat deployment settings",
	Long:  "Remove WebChat deployment settings",
...
var getCmd = &cobra.Command{
	Use:   "get",
	Short: "Get WebChat deployment settings",
	Long:  "Get WebChat deployment settings",
	Args:  utils.DetermineArgs([]string{ }),
...
var updateCmd = &cobra.Command{
	Use:   "update",
	Short: "Update WebChat deployment settings",
	Long:  "Update WebChat deployment settings",
	Args:  utils.DetermineArgs([]string{ }),
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if printReqBody {
			...
			reqModel := models.Webchatsettings{}
