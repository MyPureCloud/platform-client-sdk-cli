...
var (
    CasemanagementaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type CasemanagementaggregationqueryDud struct { 
...
type Casemanagementaggregationquery struct { 
...
func (o *Casemanagementaggregationquery) String() string {
...
func (u *Casemanagementaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Casemanagementaggregationquery

    if CasemanagementaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    CasemanagementaggregationqueryMarshalled = true
