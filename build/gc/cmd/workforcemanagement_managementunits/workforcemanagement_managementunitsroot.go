...
func init() {
	...
	workforcemanagement_managementunitsCmd.Short = utils.GenerateCustomDescription(workforcemanagement_managementunitsCmd.Short, workforcemanagement_managementunits_adherence.Description, workforcemanagement_managementunits_divisionviews.Description, workforcemanagement_managementunits_workplans.Description, workforcemanagement_managementunits_weeks.Description, workforcemanagement_managementunits_users.Description, workforcemanagement_managementunits_timeoffrequests.Description, workforcemanagement_managementunits_schedules.Description, workforcemanagement_managementunits_agentschedules.Description, workforcemanagement_managementunits_historicaladherencequery.Description, workforcemanagement_managementunits_move.Description, workforcemanagement_managementunits_activitycodes.Description, workforcemanagement_managementunits_shifttrades.Description, workforcemanagement_managementunits_workplanrotations.Description, workforcemanagement_managementunits_agents.Description, )
