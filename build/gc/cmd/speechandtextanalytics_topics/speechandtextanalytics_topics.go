...
func Cmdspeechandtextanalytics_topics() *cobra.Command { 
  ...
  "content" : {
	...
	utils.AddFlag(listCmd.Flags(), "int", "pageNumber", "", "The page number for the listing")
	...
	utils.AddFlag(listCmd.Flags(), "string", "sortBy", "", "Sort results by. Defaults to name Valid values: name, matchingType, realTime")
