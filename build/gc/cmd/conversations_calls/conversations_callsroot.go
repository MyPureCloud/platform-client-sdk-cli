...
func init() {
	...
	conversations_callsCmd.Short = utils.GenerateCustomDescription(conversations_callsCmd.Short, conversations_calls_participants.Description, conversations_calls_recordingstate.Description, conversations_calls_history.Description, conversations_calls_maximumconferenceparties.Description, )
