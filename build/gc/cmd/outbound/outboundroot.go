...
func init() {
	...
	outboundCmd.Short = utils.GenerateCustomDescription(outboundCmd.Short, outbound_wrapupcodemappings.Description, outbound_campaigns.Description, outbound_contactlists.Description, outbound_messagingcampaigns.Description, outbound_events.Description, outbound_dnclists.Description, outbound_contactlistfilters.Description, outbound_schedules.Description, outbound_attemptlimits.Description, outbound_callabletimesets.Description, outbound_conversations.Description, outbound_callanalysisresponsesets.Description, outbound_rulesets.Description, outbound_sequences.Description, outbound_audits.Description, outbound_settings.Description, outbound_campaignrules.Description, )
