...
func init() {
	...
	orgauthorization_trusteesCmd.Short = utils.GenerateCustomDescription(orgauthorization_trusteesCmd.Short, orgauthorization_trustees_audits.Description, orgauthorization_trustees_default.Description, orgauthorization_trustees_users.Description, orgauthorization_trustees_clonedusers.Description, )
