...
func init() {
	...
	speechandtextanalyticsCmd.Short = utils.GenerateCustomDescription(speechandtextanalyticsCmd.Short, speechandtextanalytics_programs.Description, speechandtextanalytics_topics.Description, speechandtextanalytics_conversations.Description, speechandtextanalytics_dialects.Description, speechandtextanalytics_settings.Description, speechandtextanalytics_transcripts.Description, )
