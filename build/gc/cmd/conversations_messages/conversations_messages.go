...
func Cmdconversations_messages() *cobra.Command { 
  ...
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/CreateOutboundMessagingConversationRequest"
      }
    }
  },
  "required" : true
...
var listCmd = &cobra.Command{
	Use:   "list",
	Short: "Get the logged-in user`s active conversations and their Message participants state.",
	Long:  "Get the logged-in user`s active conversations and their Message participants state.",
	Args:  utils.DetermineArgs([]string{ }),
