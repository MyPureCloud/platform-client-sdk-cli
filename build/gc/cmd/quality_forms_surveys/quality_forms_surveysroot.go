...
func init() {
	...
	quality_forms_surveysCmd.Short = utils.GenerateCustomDescription(quality_forms_surveysCmd.Short, quality_forms_surveys_bulk.Description, quality_forms_surveys_versions.Description, )
