...
var (
    EvaluationaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type EvaluationaggregationqueryDud struct { 
...
func (u *Evaluationaggregationquery) MarshalJSON() ([]byte, error) {
    ...
    if EvaluationaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    EvaluationaggregationqueryMarshalled = true
