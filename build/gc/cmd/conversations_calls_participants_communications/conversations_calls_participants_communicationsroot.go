...
func init() {
	...
	conversations_calls_participants_communicationsCmd.Short = utils.GenerateCustomDescription(conversations_calls_participants_communicationsCmd.Short, conversations_calls_participants_communications_uuidata.Description, )
