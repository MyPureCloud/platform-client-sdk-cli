...
var (
    AgentadherencedaymetricsMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type AgentadherencedaymetricsDud struct { 
...
func (u *Agentadherencedaymetrics) MarshalJSON() ([]byte, error) {
    type Alias Agentadherencedaymetrics

    if AgentadherencedaymetricsMarshalled {
        return []byte("{}"), nil
    }
    AgentadherencedaymetricsMarshalled = true
