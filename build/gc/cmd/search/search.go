...
func Cmdsearch() *cobra.Command { 
	...
	createCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", createCmd.UsageTemplate(), "POST", "/api/v2/search", utils.FormatPermissions([]string{ "directory:user:divisionview",  }), utils.GenerateDevCentreLink("POST", "Search", "/api/v2/search")))
  ...
  &quot;schema&quot; : {
	...
	listCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", listCmd.UsageTemplate(), "GET", "/api/v2/search", utils.FormatPermissions([]string{ "directory:user:divisionview",  }), utils.GenerateDevCentreLink("GET", "Search", "/api/v2/search")))
