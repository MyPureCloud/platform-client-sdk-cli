## gc businessrules decisiontables versions rows bulk add
...
* [gc businessrules decisiontables versions rows bulk add create](gc_businessrules_decisiontables_versions_rows_bulk_add_create.html)	 - Bulk add decision table rows
