...
func init() {
	...
	alerting_interactionstatsCmd.Short = utils.GenerateCustomDescription(alerting_interactionstatsCmd.Short, alerting_interactionstats_alerts.Description, alerting_interactionstats_rules.Description, )
