...
func init() {
	...
	languageunderstanding_domainsCmd.Short = utils.GenerateCustomDescription(languageunderstanding_domainsCmd.Short, languageunderstanding_domains_versions.Description, languageunderstanding_domains_feedback.Description, )
