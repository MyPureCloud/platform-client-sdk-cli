...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/routing_email_setting"
...
func init() {
	...
	routing_emailCmd.AddCommand(routing_email_setting.Cmdrouting_email_setting())
	...
	routing_emailCmd.Short = utils.GenerateCustomDescription(routing_emailCmd.Short, routing_email_domains.Description, routing_email_setting.Description, routing_email_setup.Description, routing_email_outbound.Description, )
