...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/workforcemanagement_historicaldata_bulk"
...
func init() {
	workforcemanagement_historicaldataCmd.AddCommand(workforcemanagement_historicaldata_bulk.Cmdworkforcemanagement_historicaldata_bulk())
	...
	workforcemanagement_historicaldataCmd.Short = utils.GenerateCustomDescription(workforcemanagement_historicaldataCmd.Short, workforcemanagement_historicaldata_bulk.Description, workforcemanagement_historicaldata_deletejob.Description, workforcemanagement_historicaldata_importstatus.Description, workforcemanagement_historicaldata_validate.Description, )
