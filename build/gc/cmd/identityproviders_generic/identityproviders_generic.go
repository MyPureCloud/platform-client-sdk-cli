...
func Cmdidentityproviders_generic() *cobra.Command { 
	deleteCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", deleteCmd.UsageTemplate(), "DELETE", "/api/v2/identityproviders/generic", utils.FormatPermissions([]string{ "sso:provider:delete",  }), utils.GenerateDevCentreLink("DELETE", "Identity Provider", "/api/v2/identityproviders/generic")))
