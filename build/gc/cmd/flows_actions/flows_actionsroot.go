...
func init() {
	...
	flows_actionsCmd.Short = utils.GenerateCustomDescription(flows_actionsCmd.Short, flows_actions_publish.Description, flows_actions_checkin.Description, flows_actions_checkout.Description, flows_actions_deactivate.Description, flows_actions_revert.Description, flows_actions_unlock.Description, )
