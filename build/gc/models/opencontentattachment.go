...
var (
    OpencontentattachmentMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type OpencontentattachmentDud struct { 
...
type Opencontentattachment struct { 
    // Id - Provider specific ID for attachment. For example, middleware media UUID.
    Id string `json:"id"`
...
func (u *Opencontentattachment) MarshalJSON() ([]byte, error) {
    type Alias Opencontentattachment

    if OpencontentattachmentMarshalled {
        return []byte("{}"), nil
    }
    OpencontentattachmentMarshalled = true
