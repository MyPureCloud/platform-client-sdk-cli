...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/outbound_contactlists_contacts_bulk_jobs"
...
func init() {
	outbound_contactlists_contacts_bulkCmd.AddCommand(outbound_contactlists_contacts_bulk_jobs.Cmdoutbound_contactlists_contacts_bulk_jobs())
	...
	outbound_contactlists_contacts_bulkCmd.Short = utils.GenerateCustomDescription(outbound_contactlists_contacts_bulkCmd.Short, outbound_contactlists_contacts_bulk_jobs.Description, outbound_contactlists_contacts_bulk_remove.Description, outbound_contactlists_contacts_bulk_update.Description, )
