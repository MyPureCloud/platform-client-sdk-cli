...
var (
    ConversationaggregationviewMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type ConversationaggregationviewDud struct { 
...
func (u *Conversationaggregationview) MarshalJSON() ([]byte, error) {
    type Alias Conversationaggregationview

    if ConversationaggregationviewMarshalled {
        return []byte("{}"), nil
    }
    ConversationaggregationviewMarshalled = true
