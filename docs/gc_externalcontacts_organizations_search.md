...
```
gc externalcontacts organizations search [flags]
```
...
```
  ...
  -s, --stream                   Paginate and stream data as it is being processed leaving page information intact
      --trustorId q              Search for external organizations by trustorIds (limit 25). If supplied, the q parameters is ignored. Items are returned in the order requested
```
