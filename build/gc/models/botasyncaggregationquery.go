...
var (
    BotasyncaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type BotasyncaggregationqueryDud struct { 
...
type Botasyncaggregationquery struct { 
    ...
    SortMetric Botaggregationsort `json:"sortMetric"`
...
func (o *Botasyncaggregationquery) String() string {
...
func (u *Botasyncaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Botasyncaggregationquery

    if BotasyncaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    BotasyncaggregationqueryMarshalled = true
