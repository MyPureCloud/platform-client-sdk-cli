...
var (
    ProgresstransfereventMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type ProgresstransfereventDud struct { 
...
func (u *Progresstransferevent) MarshalJSON() ([]byte, error) {
    type Alias Progresstransferevent

    if ProgresstransfereventMarshalled {
        return []byte("{}"), nil
    }
    ProgresstransfereventMarshalled = true
