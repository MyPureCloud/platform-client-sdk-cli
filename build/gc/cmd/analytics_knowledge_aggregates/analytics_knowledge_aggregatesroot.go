...
func init() {
	...
	analytics_knowledge_aggregatesCmd.Short = utils.GenerateCustomDescription(analytics_knowledge_aggregatesCmd.Short, analytics_knowledge_aggregates_jobs.Description, analytics_knowledge_aggregates_query.Description, )
