...
var (
	Description = utils.FormatUsageDescription("analytics_knowledge_aggregates_jobs", "SWAGGER_OVERRIDE_/api/v2/analytics/knowledge/aggregates/jobs", "SWAGGER_OVERRIDE_/api/v2/analytics/knowledge/aggregates/jobs", "SWAGGER_OVERRIDE_/api/v2/analytics/knowledge/aggregates/jobs", )
...
func Cmdanalytics_knowledge_aggregates_jobs() *cobra.Command { 
  ...
  "content" : {
	...
	deleteCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", deleteCmd.UsageTemplate(), "DELETE", "/api/v2/analytics/knowledge/aggregates/jobs/{jobId}", utils.FormatPermissions([]string{ "analytics:knowledgeAggregate:view",  }), utils.GenerateDevCentreLink("DELETE", "Analytics", "/api/v2/analytics/knowledge/aggregates/jobs/{jobId}")))
  ...
  "content" : { }
	...
	analytics_knowledge_aggregates_jobsCmd.AddCommand(deleteCmd)
...
var deleteCmd = &cobra.Command{
	Use:   "delete [jobId]",
	Short: "Delete/cancel an async request for knowledge aggregates",
	Long:  "Delete/cancel an async request for knowledge aggregates",
