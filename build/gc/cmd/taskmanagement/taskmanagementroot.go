...
func init() {
	...
	taskmanagementCmd.Short = utils.GenerateCustomDescription(taskmanagementCmd.Short, taskmanagement_workbins.Description, taskmanagement_workitems.Description, taskmanagement_worktypes.Description, )
