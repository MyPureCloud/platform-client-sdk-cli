...
func init() {
	...
	screenmonitors_sessionsCmd.Short = utils.GenerateCustomDescription(screenmonitors_sessionsCmd.Short, screenmonitors_sessions_users.Description, screenmonitors_sessions_details.Description, )
