...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/analytics_botflows_divisions"
...
func init() {
	analytics_botflowsCmd.AddCommand(analytics_botflows_divisions.Cmdanalytics_botflows_divisions())
	...
	analytics_botflowsCmd.Short = utils.GenerateCustomDescription(analytics_botflowsCmd.Short, analytics_botflows_divisions.Description, analytics_botflows_reportingturns.Description, analytics_botflows_sessions.Description, )
