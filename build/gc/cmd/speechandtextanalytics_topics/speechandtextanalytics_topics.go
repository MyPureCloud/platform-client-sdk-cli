...
func Cmdspeechandtextanalytics_topics() *cobra.Command { 
	createCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", createCmd.UsageTemplate(), "POST", "/api/v2/speechandtextanalytics/topics", utils.FormatPermissions([]string{ "speechAndTextAnalytics:topic:add",  })))
  ...
  &quot;schema&quot; : {
	...
	deleteCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", deleteCmd.UsageTemplate(), "DELETE", "/api/v2/speechandtextanalytics/topics/{topicId}", utils.FormatPermissions([]string{ "speechAndTextAnalytics:topic:delete",  })))
  ...
  &quot;description&quot; : &quot;The topic was deleted successfully&quot;
	...
	getCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", getCmd.UsageTemplate(), "GET", "/api/v2/speechandtextanalytics/topics/{topicId}", utils.FormatPermissions([]string{ "speechAndTextAnalytics:topic:view",  })))
  ...
  &quot;schema&quot; : {
	...
	listCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", listCmd.UsageTemplate(), "GET", "/api/v2/speechandtextanalytics/topics", utils.FormatPermissions([]string{ "speechAndTextAnalytics:topic:view",  })))
  ...
  &quot;schema&quot; : {
	...
	updateCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", updateCmd.UsageTemplate(), "PUT", "/api/v2/speechandtextanalytics/topics/{topicId}", utils.FormatPermissions([]string{ "speechAndTextAnalytics:topic:edit",  })))
