## gc workforcemanagement businessunits schedulebids groups get
...
```
gc workforcemanagement businessunits schedulebids groups get [businessUnitId] [bidId] [bidGroupId] [flags]
```
