...
var (
    LearningmoduleinformstepMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type LearningmoduleinformstepDud struct { 
...
func (u *Learningmoduleinformstep) MarshalJSON() ([]byte, error) {
    ...
    if LearningmoduleinformstepMarshalled {
        return []byte("{}"), nil
    }
    LearningmoduleinformstepMarshalled = true
