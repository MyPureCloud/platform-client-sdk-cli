...
func init() {
	...
	taskmanagement_worktypes_flowsCmd.Short = utils.GenerateCustomDescription(taskmanagement_worktypes_flowsCmd.Short, taskmanagement_worktypes_flows_onattributechange.Description, taskmanagement_worktypes_flows_oncreate.Description, )
