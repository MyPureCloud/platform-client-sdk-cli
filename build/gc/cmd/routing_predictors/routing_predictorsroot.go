...
func init() {
	...
	routing_predictorsCmd.Short = utils.GenerateCustomDescription(routing_predictorsCmd.Short, routing_predictors_keyperformanceindicators.Description, routing_predictors_keyperformanceindicatortypes.Description, routing_predictors_models.Description, )
