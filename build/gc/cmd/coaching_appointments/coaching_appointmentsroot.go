...
func init() {
	...
	coaching_appointmentsCmd.Short = utils.GenerateCustomDescription(coaching_appointmentsCmd.Short, coaching_appointments_annotations.Description, coaching_appointments_conversations.Description, coaching_appointments_statuses.Description, coaching_appointments_status.Description, coaching_appointments_aggregates.Description, coaching_appointments_me.Description, )
