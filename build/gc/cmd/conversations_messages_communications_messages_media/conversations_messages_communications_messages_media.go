...
func Cmdconversations_messages_communications_messages_media() *cobra.Command { 
	createCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", createCmd.UsageTemplate(), "POST", "/api/v2/conversations/messages/{conversationId}/communications/{communicationId}/messages/media", utils.FormatPermissions([]string{ "conversation:message:create", "conversation:webmessaging:create", "conversation:socialmedia:create",  }), utils.GenerateDevCentreLink("POST", "Conversations", "/api/v2/conversations/messages/{conversationId}/communications/{communicationId}/messages/media")))
  ...
  "content" : {
	...
	utils.AddFlag(listCmd.Flags(), "string", "status", "", "The status on which to filter the response. Valid values: uploading, valid, invalid")
	utils.AddFlag(listCmd.Flags(), "int", "pageNumber", "1", "Page number")
	utils.AddFlag(listCmd.Flags(), "int", "pageSize", "25", "Page size")
	listCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", listCmd.UsageTemplate(), "GET", "/api/v2/conversations/messages/{conversationId}/communications/{communicationId}/messages/media", utils.FormatPermissions([]string{ "conversation:messageMedia:view",  }), utils.GenerateDevCentreLink("GET", "Conversations", "/api/v2/conversations/messages/{conversationId}/communications/{communicationId}/messages/media")))
  ...
  "content" : {
	...
	conversations_messages_communications_messages_mediaCmd.AddCommand(listCmd)
...
var listCmd = &cobra.Command{
	...
	Short: "Get message media list by status",
	Long:  "Get message media list by status",
	Args:  utils.DetermineArgs([]string{ "conversationId", "communicationId", }),
