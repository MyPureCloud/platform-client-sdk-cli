...
var (
	Description = utils.FormatUsageDescription("locations_search", "SWAGGER_OVERRIDE_/api/v2/locations/search", "SWAGGER_OVERRIDE_/api/v2/locations/search", )
	locations_searchCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("locations_search"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(locations_searchCmd)
}
...
var createCmd = &cobra.Command{
	Use:   "create",
	Short: "Search locations",
	Long:  "Search locations",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if printReqBody {
			...
			reqModel := models.Locationsearchrequest{}
...
var listCmd = &cobra.Command{
	Use:   "list",
	Short: "Search locations using the q64 value returned from a previous search",
	Long:  "Search locations using the q64 value returned from a previous search",
	Args:  utils.DetermineArgs([]string{ }),
