...
func Cmdanalytics_users_aggregates_query() *cobra.Command { 
	createCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", createCmd.UsageTemplate(), "POST", "/api/v2/analytics/users/aggregates/query", utils.FormatPermissions([]string{ "analytics:userAggregate:view",  }), utils.GenerateDevCentreLink("POST", "Users", "/api/v2/analytics/users/aggregates/query")))
  ...
  &quot;required&quot; : true,
  &quot;schema&quot; : {
    &quot;$ref&quot; : &quot;#/definitions/UserAggregationQuery&quot;
  }
}`)
  ...
  &quot;schema&quot; : {
    &quot;$ref&quot; : &quot;#/definitions/UserAggregateQueryResponse&quot;
  }
}`)
