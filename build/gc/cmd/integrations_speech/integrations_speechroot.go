...
func init() {
	...
	integrations_speechCmd.Short = utils.GenerateCustomDescription(integrations_speechCmd.Short, integrations_speech_tts.Description, integrations_speech_lex.Description, integrations_speech_dialogflow.Description, )
