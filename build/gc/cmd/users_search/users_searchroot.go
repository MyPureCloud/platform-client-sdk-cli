...
func init() {
	...
	users_searchCmd.Short = utils.GenerateCustomDescription(users_searchCmd.Short, users_search_teams.Description, users_search_queuemembers.Description, users_search_conversation.Description, )
