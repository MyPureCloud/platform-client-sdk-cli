...
var (
    FlowaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type FlowaggregationqueryDud struct { 
...
func (u *Flowaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Flowaggregationquery

    if FlowaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    FlowaggregationqueryMarshalled = true
