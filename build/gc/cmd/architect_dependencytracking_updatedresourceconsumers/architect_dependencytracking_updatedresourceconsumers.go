...
func Cmdarchitect_dependencytracking_updatedresourceconsumers() *cobra.Command { 
	...
	listCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", listCmd.UsageTemplate(), "GET", "/api/v2/architect/dependencytracking/updatedresourceconsumers", utils.FormatPermissions([]string{ "architect:dependencyTracking:view",  })))
