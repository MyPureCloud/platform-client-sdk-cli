...
func init() {
	...
	authorization_subjectsCmd.Short = utils.GenerateCustomDescription(authorization_subjectsCmd.Short, authorization_subjects_divisions.Description, authorization_subjects_bulkremove.Description, authorization_subjects_bulkadd.Description, authorization_subjects_bulkreplace.Description, authorization_subjects_me.Description, authorization_subjects_rolecounts.Description, )
