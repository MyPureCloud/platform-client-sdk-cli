...
func init() {
	...
	architect_dependencytrackingCmd.Short = utils.GenerateCustomDescription(architect_dependencytrackingCmd.Short, architect_dependencytracking_consumedresources.Description, architect_dependencytracking_consumingresources.Description, architect_dependencytracking_deletedresourceconsumers.Description, architect_dependencytracking_build.Description, architect_dependencytracking_object.Description, architect_dependencytracking_types.Description, architect_dependencytracking_updatedresourceconsumers.Description, )
