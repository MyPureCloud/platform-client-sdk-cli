package telephony_providers_edges_extensions
...
func init() {
	CommandService = services.NewCommandService(telephony_providers_edges_extensionsCmd)
}

func Cmdtelephony_providers_edges_extensions() *cobra.Command { 
	getCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", getCmd.UsageTemplate(), "GET", "/api/v2/telephony/providers/edges/extensions/{extensionId}", utils.FormatPermissions([]string{ "telephony:extensionPool:view",  }), utils.GenerateDevCentreLink("GET", "Telephony Providers Edge", "/api/v2/telephony/providers/edges/extensions/{extensionId}")))
  ...
  "content" : {
	...
	utils.AddFlag(listCmd.Flags(), "string", "number", "", "Filter by number")
	listCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", listCmd.UsageTemplate(), "GET", "/api/v2/telephony/providers/edges/extensions", utils.FormatPermissions([]string{ "telephony:extensionPool:view",  }), utils.GenerateDevCentreLink("GET", "Telephony Providers Edge", "/api/v2/telephony/providers/edges/extensions")))
...
var listCmd = &cobra.Command{
	Use:   "list",
	Short: "Get a listing of extensions",
	Long:  "Get a listing of extensions",
