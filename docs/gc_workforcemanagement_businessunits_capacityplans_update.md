## gc workforcemanagement businessunits capacityplans update
...
```
gc workforcemanagement businessunits capacityplans update [businessUnitId] [capacityPlanId] [flags]
```
