...
var (
	Description = utils.FormatUsageDescription("responsemanagement_libraries", "SWAGGER_OVERRIDE_/api/v2/responsemanagement/libraries", "SWAGGER_OVERRIDE_/api/v2/responsemanagement/libraries", "SWAGGER_OVERRIDE_/api/v2/responsemanagement/libraries", "SWAGGER_OVERRIDE_/api/v2/responsemanagement/libraries", "SWAGGER_OVERRIDE_/api/v2/responsemanagement/libraries", )
	responsemanagement_librariesCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("responsemanagement_libraries"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(responsemanagement_librariesCmd)
}
...
func Cmdresponsemanagement_libraries() *cobra.Command { 
  ...
  "content" : {
	...
	responsemanagement_librariesCmd.AddCommand(getCmd)
  ...
  "content" : {
	...
	responsemanagement_librariesCmd.AddCommand(updateCmd)
	return responsemanagement_librariesCmd
}
