...
func init() {
	...
	scim_v2Cmd.Short = utils.GenerateCustomDescription(scim_v2Cmd.Short, scim_v2_resourcetypes.Description, scim_v2_schemas.Description, scim_v2_serviceproviderconfig.Description, scim_v2_groups.Description, scim_v2_users.Description, )
