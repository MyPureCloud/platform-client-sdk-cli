package conversations_cobrowse
...
var (
	Description = utils.FormatUsageDescription("conversations_cobrowse", "SWAGGER_OVERRIDE_/api/v2/conversations/{conversationId}/cobrowse", )
	conversations_cobrowseCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("conversations_cobrowse"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(conversations_cobrowseCmd)
}
...
func Cmdconversations_cobrowse() *cobra.Command { 
  ...
  "content" : {
	...
	conversations_cobrowseCmd.AddCommand(createCmd)
	return conversations_cobrowseCmd
}
...
var createCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/conversations/{conversationId}/cobrowse"
