...
func Cmdquality_conversations_evaluations() *cobra.Command { 
	...
	utils.AddFlag(createCmd.Flags(), "string", "idempotencyKey", "", "Idempotency key for request deduplication")
  ...
  "content" : {
	...
	utils.AddFlag(updateCmd.Flags(), "string", "expand", "", "evaluatorId, evaluationForm, assignee, evaluator")
...
var createCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		idempotencyKey := utils.GetFlag(cmd.Flags(), "string", "idempotencyKey")
		if idempotencyKey != "" {
