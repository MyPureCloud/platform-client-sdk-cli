...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/conversations_chats_recordingstate"
)
...
func init() {
	...
	conversations_chatsCmd.AddCommand(conversations_chats_recordingstate.Cmdconversations_chats_recordingstate())
	conversations_chatsCmd.Short = utils.GenerateCustomDescription(conversations_chatsCmd.Short, conversations_chats_messages.Description, conversations_chats_communications.Description, conversations_chats_participants.Description, conversations_chats_recordingstate.Description, )
