...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/outbound_contactlists_bulk"
...
func init() {
	...
	outbound_contactlistsCmd.AddCommand(outbound_contactlists_bulk.Cmdoutbound_contactlists_bulk())
