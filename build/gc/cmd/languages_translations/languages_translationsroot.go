...
func init() {
	...
	languages_translationsCmd.Short = utils.GenerateCustomDescription(languages_translationsCmd.Short, languages_translations_users.Description, languages_translations_organization.Description, languages_translations_builtin.Description, )
