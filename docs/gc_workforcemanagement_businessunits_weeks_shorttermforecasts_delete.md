## gc workforcemanagement businessunits weeks shorttermforecasts delete
...
```
gc workforcemanagement businessunits weeks shorttermforecasts delete [businessUnitId] [weekDateId] [forecastId] [flags]
```
