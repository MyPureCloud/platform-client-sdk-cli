...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/conversations_messages_participants_parkingstate"
)
...
func init() {
	...
	conversations_messages_participantsCmd.AddCommand(conversations_messages_participants_parkingstate.Cmdconversations_messages_participants_parkingstate())
	conversations_messages_participantsCmd.Short = utils.GenerateCustomDescription(conversations_messages_participantsCmd.Short, conversations_messages_participants_replace.Description, conversations_messages_participants_wrapupcodes.Description, conversations_messages_participants_monitor.Description, conversations_messages_participants_wrapup.Description, conversations_messages_participants_attributes.Description, conversations_messages_participants_communications.Description, conversations_messages_participants_parkingstate.Description, )
