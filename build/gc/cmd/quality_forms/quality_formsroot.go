...
func init() {
	...
	quality_formsCmd.Short = utils.GenerateCustomDescription(quality_formsCmd.Short, quality_forms_evaluations.Description, quality_forms_versions.Description, quality_forms_surveys.Description, )
