...
```
gc telephony prefixes list [flags]
```
...
```
  ...
  -h, --help                     help for list
      ...
      --prefix string            Filter by phone number prefix
  -s, --stream                   Paginate and stream data as it is being processed leaving page information intact
      --varType string           Filter by prefix type - REQUIRED Valid values: Allow, Block
```
