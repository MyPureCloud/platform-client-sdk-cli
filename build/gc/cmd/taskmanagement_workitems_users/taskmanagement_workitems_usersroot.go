...
func init() {
	...
	taskmanagement_workitems_usersCmd.Short = utils.GenerateCustomDescription(taskmanagement_workitems_usersCmd.Short, taskmanagement_workitems_users_wrapups.Description, taskmanagement_workitems_users_me.Description, )
