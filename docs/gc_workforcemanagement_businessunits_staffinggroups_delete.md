## gc workforcemanagement businessunits staffinggroups delete
...
```
gc workforcemanagement businessunits staffinggroups delete [businessUnitId] [staffingGroupId] [flags]
```
