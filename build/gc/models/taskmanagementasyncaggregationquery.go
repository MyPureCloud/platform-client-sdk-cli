...
var (
    TaskmanagementasyncaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type TaskmanagementasyncaggregationqueryDud struct { 
...
type Taskmanagementasyncaggregationquery struct { 
    ...
    Filter Taskmanagementaggregatequeryfilter `json:"filter"`
    ...
    Views []Taskmanagementaggregationview `json:"views"`
...
func (o *Taskmanagementasyncaggregationquery) String() string {
     ...
     o.Views = []Taskmanagementaggregationview{{}} 
...
func (u *Taskmanagementasyncaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Taskmanagementasyncaggregationquery

    if TaskmanagementasyncaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    TaskmanagementasyncaggregationqueryMarshalled = true
    ...
    return json.Marshal(&struct {
        ...
        *Alias
        ...
        Views: []Taskmanagementaggregationview{{}},
