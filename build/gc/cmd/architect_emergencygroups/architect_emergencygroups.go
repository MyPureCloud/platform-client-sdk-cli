...
var (
	Description = utils.FormatUsageDescription("architect_emergencygroups", "SWAGGER_OVERRIDE_/api/v2/architect/emergencygroups", "SWAGGER_OVERRIDE_/api/v2/architect/emergencygroups", "SWAGGER_OVERRIDE_/api/v2/architect/emergencygroups", "SWAGGER_OVERRIDE_/api/v2/architect/emergencygroups", "SWAGGER_OVERRIDE_/api/v2/architect/emergencygroups", )
	architect_emergencygroupsCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("architect_emergencygroups"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(architect_emergencygroupsCmd)
}
...
func Cmdarchitect_emergencygroups() *cobra.Command { 
  ...
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/EmergencyGroup"
      }
    }
  },
  "required" : true
  ...
  "content" : {
	...
	architect_emergencygroupsCmd.AddCommand(getCmd)
  ...
  "content" : {
	...
	architect_emergencygroupsCmd.AddCommand(updateCmd)
	return architect_emergencygroupsCmd
}

var createCmd = &cobra.Command{
	Use:   "create",
	Short: "Creates a new emergency group",
	Long:  "Creates a new emergency group",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if printReqBody {
			...
			reqModel := models.Emergencygroup{}
...
var deleteCmd = &cobra.Command{
	Use:   "delete [emergencyGroupId]",
	Short: "Deletes a emergency group by ID",
	Long:  "Deletes a emergency group by ID",
	Args:  utils.DetermineArgs([]string{ "emergencyGroupId", }),
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		emergencyGroupId, args := args[0], args[1:]
...
var getCmd = &cobra.Command{
	Use:   "get [emergencyGroupId]",
	Short: "Gets a emergency group by ID",
	Long:  "Gets a emergency group by ID",
	Args:  utils.DetermineArgs([]string{ "emergencyGroupId", }),
...
var listCmd = &cobra.Command{
	Use:   "list",
	Short: "Get a list of emergency groups.",
	Long:  "Get a list of emergency groups.",
	Args:  utils.DetermineArgs([]string{ }),
...
var updateCmd = &cobra.Command{
	Use:   "update [emergencyGroupId]",
	Short: "Updates a emergency group by ID",
	Long:  "Updates a emergency group by ID",
	Args:  utils.DetermineArgs([]string{ "emergencyGroupId", }),
