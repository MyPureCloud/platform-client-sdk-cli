package gamification_insights_details
...
var (
	Description = utils.FormatUsageDescription("gamification_insights_details", "SWAGGER_OVERRIDE_/api/v2/gamification/insights/details", )
	gamification_insights_detailsCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("gamification_insights_details"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(gamification_insights_detailsCmd)
}

func Cmdgamification_insights_details() *cobra.Command { 
	...
	getCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", getCmd.UsageTemplate(), "GET", "/api/v2/gamification/insights/details", utils.FormatPermissions([]string{ "gamification:insights:view",  }), utils.GenerateDevCentreLink("GET", "Gamification", "/api/v2/gamification/insights/details")))
  ...
  "content" : {
	...
	gamification_insights_detailsCmd.AddCommand(getCmd)
	return gamification_insights_detailsCmd
}
...
var getCmd = &cobra.Command{
	Use:   "get",
	Short: "Get insights details for the current user",
	Long:  "Get insights details for the current user",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/gamification/insights/details"
