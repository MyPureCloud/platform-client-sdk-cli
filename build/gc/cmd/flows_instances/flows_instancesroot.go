...
func init() {
	...
	flows_instancesCmd.Short = utils.GenerateCustomDescription(flows_instancesCmd.Short, flows_instances_jobs.Description, flows_instances_querycapabilities.Description, flows_instances_query.Description, )
