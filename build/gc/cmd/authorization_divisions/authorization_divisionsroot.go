...
func init() {
	...
	authorization_divisionsCmd.Short = utils.GenerateCustomDescription(authorization_divisionsCmd.Short, authorization_divisions_restore.Description, authorization_divisions_objects.Description, authorization_divisions_grants.Description, authorization_divisions_home.Description, authorization_divisions_limit.Description, )
