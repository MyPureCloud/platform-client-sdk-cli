...
func init() {
	...
	learning_scheduleslotsCmd.Short = utils.GenerateCustomDescription(learning_scheduleslotsCmd.Short, learning_scheduleslots_jobs.Description, learning_scheduleslots_query.Description, )
