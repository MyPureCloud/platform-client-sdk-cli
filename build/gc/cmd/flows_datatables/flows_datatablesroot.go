...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/flows_datatables_divisionviews"
...
func init() {
	flows_datatablesCmd.AddCommand(flows_datatables_divisionviews.Cmdflows_datatables_divisionviews())
	...
	flows_datatablesCmd.Short = utils.GenerateCustomDescription(flows_datatablesCmd.Short, flows_datatables_divisionviews.Description, flows_datatables_export.Description, flows_datatables_import.Description, flows_datatables_rows.Description, )
