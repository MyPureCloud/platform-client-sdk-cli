...
```
gc learning assignments list [flags]
```
...
```
  ...
  -h, --help                        help for list
      ...
      --maxPercentageScore string   The maximum assessment score for an assignment (completed with assessment) to be included in the results (inclusive)
      --minPercentageScore string   The minimum assessment score for an assignment (completed with assessment) to be included in the results (inclusive)
  ...
  -s, --stream                      Paginate and stream data as it is being processed leaving page information intact
      ...
      --userId strings              Specifies the list of user IDs to be queried, up to 100 user IDs.
```
