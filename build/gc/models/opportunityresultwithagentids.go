...
var (
    OpportunityresultwithagentidsMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type OpportunityresultwithagentidsDud struct { 
...
type Opportunityresultwithagentids struct { 
...
func (o *Opportunityresultwithagentids) String() string {
...
func (u *Opportunityresultwithagentids) MarshalJSON() ([]byte, error) {
    type Alias Opportunityresultwithagentids

    if OpportunityresultwithagentidsMarshalled {
        return []byte("{}"), nil
    }
    OpportunityresultwithagentidsMarshalled = true
