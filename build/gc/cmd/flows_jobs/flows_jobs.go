...
var (
	Description = utils.FormatUsageDescription("flows_jobs", "SWAGGER_OVERRIDE_/api/v2/flows/jobs", "SWAGGER_OVERRIDE_/api/v2/flows/jobs", )
	flows_jobsCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("flows_jobs"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(flows_jobsCmd)
}
...
var createCmd = &cobra.Command{
	Use:   "create",
	Short: "Register Architect Job. Returns a URL where a file, such as an Architect flow YAML file, can be PUT which will then initiate the job.",
	Long:  "Register Architect Job. Returns a URL where a file, such as an Architect flow YAML file, can be PUT which will then initiate the job.",
...
var getCmd = &cobra.Command{
	Use:   "get [jobId]",
	Short: "Fetch Architect Job Status",
	Long:  "Fetch Architect Job Status",
