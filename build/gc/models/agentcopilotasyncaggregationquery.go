...
var (
    AgentcopilotasyncaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type AgentcopilotasyncaggregationqueryDud struct { 
...
type Agentcopilotasyncaggregationquery struct { 
    ...
    Filter Agentcopilotaggregatequeryfilter `json:"filter"`
    ...
    Views []Agentcopilotaggregationview `json:"views"`
...
func (o *Agentcopilotasyncaggregationquery) String() string {
...
func (u *Agentcopilotasyncaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Agentcopilotasyncaggregationquery

    if AgentcopilotasyncaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    AgentcopilotasyncaggregationqueryMarshalled = true
