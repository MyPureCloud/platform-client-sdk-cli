...
var (
    UseraggregatequerypredicateMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type UseraggregatequerypredicateDud struct { 
...
func (u *Useraggregatequerypredicate) MarshalJSON() ([]byte, error) {
    type Alias Useraggregatequerypredicate

    if UseraggregatequerypredicateMarshalled {
        return []byte("{}"), nil
    }
    UseraggregatequerypredicateMarshalled = true
