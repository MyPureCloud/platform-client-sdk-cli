...
func init() {
	...
	analytics_taskmanagement_aggregatesCmd.Short = utils.GenerateCustomDescription(analytics_taskmanagement_aggregatesCmd.Short, analytics_taskmanagement_aggregates_jobs.Description, analytics_taskmanagement_aggregates_query.Description, )
