...
func init() {
	...
	authorization_rolesCmd.Short = utils.GenerateCustomDescription(authorization_rolesCmd.Short, authorization_roles_subjectgrants.Description, authorization_roles_users.Description, authorization_roles_comparedefault.Description, authorization_roles_default.Description, )
