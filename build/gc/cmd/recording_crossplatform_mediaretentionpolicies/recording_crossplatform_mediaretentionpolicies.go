package recording_crossplatform_mediaretentionpolicies
...
var (
	Description = utils.FormatUsageDescription("recording_crossplatform_mediaretentionpolicies", "SWAGGER_OVERRIDE_/api/v2/recording/crossplatform/mediaretentionpolicies", "SWAGGER_OVERRIDE_/api/v2/recording/crossplatform/mediaretentionpolicies", "SWAGGER_OVERRIDE_/api/v2/recording/crossplatform/mediaretentionpolicies", "SWAGGER_OVERRIDE_/api/v2/recording/crossplatform/mediaretentionpolicies", "SWAGGER_OVERRIDE_/api/v2/recording/crossplatform/mediaretentionpolicies", "SWAGGER_OVERRIDE_/api/v2/recording/crossplatform/mediaretentionpolicies", "SWAGGER_OVERRIDE_/api/v2/recording/crossplatform/mediaretentionpolicies", )
	recording_crossplatform_mediaretentionpoliciesCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("recording_crossplatform_mediaretentionpolicies"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(recording_crossplatform_mediaretentionpoliciesCmd)
}
...
func Cmdrecording_crossplatform_mediaretentionpolicies() *cobra.Command { 
  ...
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/CrossPlatformPolicyUpdate"
      }
    }
  },
  "required" : true
  ...
  "content" : {
	...
	return recording_crossplatform_mediaretentionpoliciesCmd
}
