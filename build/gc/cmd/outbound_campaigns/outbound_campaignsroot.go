...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/outbound_campaigns_skillcombinations"
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/outbound_campaigns_start"
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/outbound_campaigns_stop"
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/outbound_campaigns_performance"
...
func init() {
	...
	outbound_campaignsCmd.AddCommand(outbound_campaigns_skillcombinations.Cmdoutbound_campaigns_skillcombinations())
	outbound_campaignsCmd.AddCommand(outbound_campaigns_start.Cmdoutbound_campaigns_start())
	outbound_campaignsCmd.AddCommand(outbound_campaigns_stop.Cmdoutbound_campaigns_stop())
	...
	outbound_campaignsCmd.AddCommand(outbound_campaigns_performance.Cmdoutbound_campaigns_performance())
	outbound_campaignsCmd.AddCommand(outbound_campaigns_all.Cmdoutbound_campaigns_all())
	outbound_campaignsCmd.Short = utils.GenerateCustomDescription(outbound_campaignsCmd.Short, outbound_campaigns_agents.Description, outbound_campaigns_callback.Description, outbound_campaigns_divisionviews.Description, outbound_campaigns_interactions.Description, outbound_campaigns_linedistribution.Description, outbound_campaigns_agentownedmappingpreview.Description, outbound_campaigns_diagnostics.Description, outbound_campaigns_skillcombinations.Description, outbound_campaigns_start.Description, outbound_campaigns_stop.Description, outbound_campaigns_progress.Description, outbound_campaigns_stats.Description, outbound_campaigns_performance.Description, outbound_campaigns_all.Description, )
