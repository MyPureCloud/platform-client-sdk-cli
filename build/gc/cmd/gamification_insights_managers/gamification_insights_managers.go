package gamification_insights_managers
...
var (
	Description = utils.FormatUsageDescription("gamification_insights_managers", "SWAGGER_OVERRIDE_/api/v2/gamification/insights/managers", )
	gamification_insights_managersCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("gamification_insights_managers"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(gamification_insights_managersCmd)
}

func Cmdgamification_insights_managers() *cobra.Command { 
	...
	listCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", listCmd.UsageTemplate(), "GET", "/api/v2/gamification/insights/managers", utils.FormatPermissions([]string{ "gamification:insights:viewAll",  }), utils.GenerateDevCentreLink("GET", "Gamification", "/api/v2/gamification/insights/managers")))
  ...
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/InsightsAgents"
      }
    }
  }
}`)
	gamification_insights_managersCmd.AddCommand(listCmd)
	return gamification_insights_managersCmd
}
...
var listCmd = &cobra.Command{
	Use:   "list",
	Short: "Query managers in a profile during a period of time",
	Long:  "Query managers in a profile during a period of time",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/gamification/insights/managers"
