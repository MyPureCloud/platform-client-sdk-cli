...
func Cmdworkforcemanagement_businessunits_weeks_shorttermforecasts_copy() *cobra.Command { 
	...
	createCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", createCmd.UsageTemplate(), "POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekDateId}/shorttermforecasts/{forecastId}/copy", utils.FormatPermissions([]string{ "wfm:shortTermForecast:add",  })))
