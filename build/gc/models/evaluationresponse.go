...
var (
    EvaluationresponseMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type EvaluationresponseDud struct { 
    Id string `json:"id"`
...
func (u *Evaluationresponse) MarshalJSON() ([]byte, error) {
    type Alias Evaluationresponse

    if EvaluationresponseMarshalled {
        return []byte("{}"), nil
    }
    EvaluationresponseMarshalled = true
