...
func init() {
	...
	organizations_limitsCmd.Short = utils.GenerateCustomDescription(organizations_limitsCmd.Short, organizations_limits_namespaces.Description, organizations_limits_changerequests.Description, organizations_limits_docs.Description, )
