...
var (
    TeamsearchcriteriaMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type TeamsearchcriteriaDud struct { 
...
func (u *Teamsearchcriteria) MarshalJSON() ([]byte, error) {
    type Alias Teamsearchcriteria

    if TeamsearchcriteriaMarshalled {
        return []byte("{}"), nil
    }
    TeamsearchcriteriaMarshalled = true
