...
var (
	Description = utils.FormatUsageDescription("voicemail_userpolicies", "SWAGGER_OVERRIDE_/api/v2/voicemail/userpolicies", "SWAGGER_OVERRIDE_/api/v2/voicemail/userpolicies", )
...
func Cmdvoicemail_userpolicies() *cobra.Command { 
	getCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", getCmd.UsageTemplate(), "GET", "/api/v2/voicemail/userpolicies/{userId}", utils.FormatPermissions([]string{  })))
  ...
  &quot;schema&quot; : {
	...
	updateCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", updateCmd.UsageTemplate(), "PATCH", "/api/v2/voicemail/userpolicies/{userId}", utils.FormatPermissions([]string{  })))
