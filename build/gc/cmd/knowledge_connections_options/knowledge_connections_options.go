package knowledge_connections_options
...
var (
	Description = utils.FormatUsageDescription("knowledge_connections_options", "SWAGGER_OVERRIDE_/api/v2/knowledge/connections/{connectionId}/options", )
	knowledge_connections_optionsCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("knowledge_connections_options"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(knowledge_connections_optionsCmd)
}
...
func Cmdknowledge_connections_options() *cobra.Command { 
  ...
  "content" : {
	...
	knowledge_connections_optionsCmd.AddCommand(listCmd)
	return knowledge_connections_optionsCmd
}
...
var listCmd = &cobra.Command{
	Use:   "list [connectionId]",
	Short: "Get connection options",
	Long:  "Get connection options",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/knowledge/connections/{connectionId}/options"
