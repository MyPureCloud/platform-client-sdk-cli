...
func init() {
	...
	knowledgeCmd.Short = utils.GenerateCustomDescription(knowledgeCmd.Short, knowledge_knowledgebases.Description, knowledge_integrations.Description, knowledge_documentuploads.Description, knowledge_guest.Description, )
