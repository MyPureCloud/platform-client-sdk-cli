...
func init() {
	...
	scriptsCmd.Short = utils.GenerateCustomDescription(scriptsCmd.Short, scripts_published.Description, scripts_pages.Description, scripts_export.Description, scripts_uploads.Description, )
