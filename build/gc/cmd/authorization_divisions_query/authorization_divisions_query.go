package authorization_divisions_query
...
var (
	Description = utils.FormatUsageDescription("authorization_divisions_query", "SWAGGER_OVERRIDE_/api/v2/authorization/divisions/query", )
	authorization_divisions_queryCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("authorization_divisions_query"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(authorization_divisions_queryCmd)
}
...
func Cmdauthorization_divisions_query() *cobra.Command { 
  ...
  "content" : {
	...
	authorization_divisions_queryCmd.AddCommand(listCmd)
	return authorization_divisions_queryCmd
}
...
var listCmd = &cobra.Command{
	Use:   "list",
	Short: "Retrieve a list of all divisions defined for the organization with cursor",
	Long:  "Retrieve a list of all divisions defined for the organization with cursor",
