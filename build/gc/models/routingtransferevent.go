...
var (
    RoutingtransfereventMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type RoutingtransfereventDud struct { 
...
func (u *Routingtransferevent) MarshalJSON() ([]byte, error) {
    type Alias Routingtransferevent

    if RoutingtransfereventMarshalled {
        return []byte("{}"), nil
    }
    RoutingtransfereventMarshalled = true
