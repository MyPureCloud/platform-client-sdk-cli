...
func init() {
	...
	assistants_queues_usersCmd.Short = utils.GenerateCustomDescription(assistants_queues_usersCmd.Short, assistants_queues_users_bulk.Description, assistants_queues_users_query.Description, )
