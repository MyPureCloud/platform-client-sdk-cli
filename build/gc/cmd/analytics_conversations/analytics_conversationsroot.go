...
func init() {
	...
	analytics_conversationsCmd.Short = utils.GenerateCustomDescription(analytics_conversationsCmd.Short, analytics_conversations_aggregates.Description, analytics_conversations_activity.Description, analytics_conversations_details.Description, analytics_conversations_transcripts.Description, )
