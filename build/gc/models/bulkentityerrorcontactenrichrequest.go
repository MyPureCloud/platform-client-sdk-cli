...
var (
    BulkentityerrorcontactenrichrequestMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type BulkentityerrorcontactenrichrequestDud struct { 
...
type Bulkentityerrorcontactenrichrequest struct { 
    ...
    Entity Contactenrichrequest `json:"entity"`
...
func (u *Bulkentityerrorcontactenrichrequest) MarshalJSON() ([]byte, error) {
    type Alias Bulkentityerrorcontactenrichrequest

    if BulkentityerrorcontactenrichrequestMarshalled {
        return []byte("{}"), nil
    }
    BulkentityerrorcontactenrichrequestMarshalled = true
