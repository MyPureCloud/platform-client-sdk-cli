...
func init() {
	...
	gamification_scorecardsCmd.Short = utils.GenerateCustomDescription(gamification_scorecardsCmd.Short, gamification_scorecards_profiles.Description, gamification_scorecards_bestpoints.Description, gamification_scorecards_points.Description, gamification_scorecards_values.Description, gamification_scorecards_attendance.Description, gamification_scorecards_users.Description, )
