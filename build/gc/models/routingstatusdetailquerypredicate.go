...
var (
    RoutingstatusdetailquerypredicateMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type RoutingstatusdetailquerypredicateDud struct { 
...
func (u *Routingstatusdetailquerypredicate) MarshalJSON() ([]byte, error) {
    type Alias Routingstatusdetailquerypredicate

    if RoutingstatusdetailquerypredicateMarshalled {
        return []byte("{}"), nil
    }
    RoutingstatusdetailquerypredicateMarshalled = true
