...
var (
	Description = utils.FormatUsageDescription("gamification_profiles", "SWAGGER_OVERRIDE_/api/v2/gamification/profiles", "SWAGGER_OVERRIDE_/api/v2/gamification/profiles", "SWAGGER_OVERRIDE_/api/v2/gamification/profiles", )
...
func Cmdgamification_profiles() *cobra.Command { 
	getCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", getCmd.UsageTemplate(), "GET", "/api/v2/gamification/profiles/{performanceProfileId}", utils.FormatPermissions([]string{ "gamification:profile:view",  })))
  ...
  &quot;schema&quot; : {
	...
	listCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", listCmd.UsageTemplate(), "GET", "/api/v2/gamification/profiles", utils.FormatPermissions([]string{ "gamification:profile:view",  })))
  ...
  &quot;schema&quot; : {
	...
	updateCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", updateCmd.UsageTemplate(), "PUT", "/api/v2/gamification/profiles/{performanceProfileId}", utils.FormatPermissions([]string{ "gamification:profile:update",  })))
