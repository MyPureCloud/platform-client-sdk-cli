...
var (
    AgentutilizationaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type AgentutilizationaggregationqueryDud struct { 
...
type Agentutilizationaggregationquery struct { 
...
func (o *Agentutilizationaggregationquery) String() string {
...
func (u *Agentutilizationaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Agentutilizationaggregationquery

    if AgentutilizationaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    AgentutilizationaggregationqueryMarshalled = true
