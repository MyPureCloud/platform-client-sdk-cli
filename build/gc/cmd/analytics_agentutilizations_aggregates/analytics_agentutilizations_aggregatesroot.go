...
func init() {
	...
	analytics_agentutilizations_aggregatesCmd.Short = utils.GenerateCustomDescription(analytics_agentutilizations_aggregatesCmd.Short, analytics_agentutilizations_aggregates_jobs.Description, analytics_agentutilizations_aggregates_query.Description, )
