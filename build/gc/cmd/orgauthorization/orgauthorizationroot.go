...
func init() {
	...
	orgauthorizationCmd.Short = utils.GenerateCustomDescription(orgauthorizationCmd.Short, orgauthorization_trustees.Description, orgauthorization_trustors.Description, orgauthorization_pairings.Description, orgauthorization_trustor.Description, )
