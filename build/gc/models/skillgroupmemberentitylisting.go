...
var (
    SkillgroupmemberentitylistingMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type SkillgroupmemberentitylistingDud struct { 
...
func (u *Skillgroupmemberentitylisting) MarshalJSON() ([]byte, error) {
    type Alias Skillgroupmemberentitylisting

    if SkillgroupmemberentitylistingMarshalled {
        return []byte("{}"), nil
    }
    SkillgroupmemberentitylistingMarshalled = true
