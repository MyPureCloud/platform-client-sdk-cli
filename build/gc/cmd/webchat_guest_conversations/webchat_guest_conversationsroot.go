...
func init() {
	...
	webchat_guest_conversationsCmd.Short = utils.GenerateCustomDescription(webchat_guest_conversationsCmd.Short, webchat_guest_conversations_members.Description, webchat_guest_conversations_mediarequests.Description, webchat_guest_conversations_messages.Description, )
