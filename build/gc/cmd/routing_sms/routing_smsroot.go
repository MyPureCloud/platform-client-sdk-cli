...
func init() {
	...
	routing_smsCmd.Short = utils.GenerateCustomDescription(routing_smsCmd.Short, routing_sms_phonenumbers.Description, routing_sms_addresses.Description, routing_sms_availablephonenumbers.Description, )
