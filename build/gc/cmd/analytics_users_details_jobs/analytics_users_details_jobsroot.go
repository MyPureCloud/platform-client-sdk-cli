...
func init() {
	...
	analytics_users_details_jobsCmd.Short = utils.GenerateCustomDescription(analytics_users_details_jobsCmd.Short, analytics_users_details_jobs_availability.Description, analytics_users_details_jobs_results.Description, )
