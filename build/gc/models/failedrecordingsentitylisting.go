...
var (
    FailedrecordingsentitylistingMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type FailedrecordingsentitylistingDud struct { 
...
func (u *Failedrecordingsentitylisting) MarshalJSON() ([]byte, error) {
    type Alias Failedrecordingsentitylisting

    if FailedrecordingsentitylistingMarshalled {
        return []byte("{}"), nil
    }
    FailedrecordingsentitylistingMarshalled = true
