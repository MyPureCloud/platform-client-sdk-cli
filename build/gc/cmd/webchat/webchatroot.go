...
func init() {
	...
	webchatCmd.Short = utils.GenerateCustomDescription(webchatCmd.Short, webchat_deployments.Description, webchat_guest.Description, webchat_settings.Description, )
