## gc workforcemanagement businessunits shifttrading trades query jobs get
...
```
gc workforcemanagement businessunits shifttrading trades query jobs get [businessUnitId] [jobId] [flags]
```
