...
var (
    MessagingflowestablishedeventMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type MessagingflowestablishedeventDud struct { 
...
type Messagingflowestablishedevent struct { 
...
func (o *Messagingflowestablishedevent) String() string {
...
func (u *Messagingflowestablishedevent) MarshalJSON() ([]byte, error) {
    type Alias Messagingflowestablishedevent

    if MessagingflowestablishedeventMarshalled {
        return []byte("{}"), nil
    }
    MessagingflowestablishedeventMarshalled = true
