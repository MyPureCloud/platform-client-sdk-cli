...
func init() {
	...
	analytics_bots_aggregatesCmd.Short = utils.GenerateCustomDescription(analytics_bots_aggregatesCmd.Short, analytics_bots_aggregates_jobs.Description, analytics_bots_aggregates_query.Description, )
