## gc authorization divisions grants
...
* [gc authorization divisions grants list](gc_authorization_divisions_grants_list.html)	 - Gets all grants for a given division.
