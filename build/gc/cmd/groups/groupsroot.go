...
func init() {
	...
	groupsCmd.Short = utils.GenerateCustomDescription(groupsCmd.Short, groups_greetings.Description, groups_search.Description, groups_individuals.Description, groups_members.Description, groups_profile.Description, )
