...
var (
    UserasyncaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type UserasyncaggregationqueryDud struct { 
...
type Userasyncaggregationquery struct { 
...
func (o *Userasyncaggregationquery) String() string {
...
func (u *Userasyncaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Userasyncaggregationquery

    if UserasyncaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    UserasyncaggregationqueryMarshalled = true
