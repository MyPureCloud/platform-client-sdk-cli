...
var (
	Description = utils.FormatUsageDescription("alerting_alerts", "SWAGGER_OVERRIDE_/api/v2/alerting/alerts", "SWAGGER_OVERRIDE_/api/v2/alerting/alerts", "SWAGGER_OVERRIDE_/api/v2/alerting/alerts", "SWAGGER_OVERRIDE_/api/v2/alerting/alerts", )
...
func Cmdalerting_alerts() *cobra.Command { 
	deleteCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", deleteCmd.UsageTemplate(), "DELETE", "/api/v2/alerting/alerts/{alertId}", utils.FormatPermissions([]string{ "alerting:alert:delete",  }), utils.GenerateDevCentreLink("DELETE", "Alerting", "/api/v2/alerting/alerts/{alertId}")))
  ...
  "content" : { }
	...
	alerting_alertsCmd.AddCommand(deleteCmd)

	getCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", getCmd.UsageTemplate(), "GET", "/api/v2/alerting/alerts/{alertId}", utils.FormatPermissions([]string{ "alerting:alert:view",  }), utils.GenerateDevCentreLink("GET", "Alerting", "/api/v2/alerting/alerts/{alertId}")))
...
var updateCmd = &cobra.Command{
	...
	Long:  "Update an alert read status",
	Args:  utils.DetermineArgs([]string{ "alertId", }),
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if printReqBody {
			...
			reqModel := models.Alertingunreadstatus{}
