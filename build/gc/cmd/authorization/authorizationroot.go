...
func init() {
	...
	authorizationCmd.Short = utils.GenerateCustomDescription(authorizationCmd.Short, authorization_divisions.Description, authorization_subjects.Description, authorization_roles.Description, authorization_divisionspermitted.Description, authorization_permissions.Description, authorization_products.Description, )
