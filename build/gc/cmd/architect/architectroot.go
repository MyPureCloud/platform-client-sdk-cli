...
func init() {
	...
	architectCmd.Short = utils.GenerateCustomDescription(architectCmd.Short, architect_emergencygroups.Description, architect_systemprompts.Description, architect_prompts.Description, architect_dependencytracking.Description, architect_ivrs.Description, architect_schedules.Description, architect_schedulegroups.Description, )
