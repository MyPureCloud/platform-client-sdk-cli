...
func init() {
	...
	webchat_guest_conversations_membersCmd.Short = utils.GenerateCustomDescription(webchat_guest_conversations_membersCmd.Short, webchat_guest_conversations_members_messages.Description, webchat_guest_conversations_members_typing.Description, )
