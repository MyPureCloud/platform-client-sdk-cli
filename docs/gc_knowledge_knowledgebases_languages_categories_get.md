## gc knowledge knowledgebases languages categories get
...
```
gc knowledge knowledgebases languages categories get [categoryId] [knowledgeBaseId] [languageCode] [flags]
```
