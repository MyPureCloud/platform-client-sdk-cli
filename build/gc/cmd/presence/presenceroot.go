...
func init() {
	...
	presenceCmd.Short = utils.GenerateCustomDescription(presenceCmd.Short, presence_settings.Description, presence_sources.Description, presence_users.Description, )
