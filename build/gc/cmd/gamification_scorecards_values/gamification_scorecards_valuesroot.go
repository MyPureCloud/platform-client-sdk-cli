...
func init() {
	...
	gamification_scorecards_valuesCmd.Short = utils.GenerateCustomDescription(gamification_scorecards_valuesCmd.Short, gamification_scorecards_values_average.Description, gamification_scorecards_values_trends.Description, )
