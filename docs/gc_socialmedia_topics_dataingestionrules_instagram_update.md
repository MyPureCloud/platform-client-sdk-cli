## gc socialmedia topics dataingestionrules instagram update
...
```
gc socialmedia topics dataingestionrules instagram update [topicId] [instagramIngestionRuleId] [flags]
```
