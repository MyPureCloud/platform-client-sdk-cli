...
Switching the CLI generation from a model where resources are added manually to one where all resources are included with the ability to override operation names if necessary.
Also adding pagination support to cursor and index pagination responses.
