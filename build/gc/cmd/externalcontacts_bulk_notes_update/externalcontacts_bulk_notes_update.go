...
func Cmdexternalcontacts_bulk_notes_update() *cobra.Command { 
	createCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", createCmd.UsageTemplate(), "POST", "/api/v2/externalcontacts/bulk/notes/update", utils.FormatPermissions([]string{ "externalContacts:contact:edit", "externalContacts:externalOrganization:edit",  })))
