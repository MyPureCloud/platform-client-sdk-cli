...
func init() {
	...
	routing_queuesCmd.Short = utils.GenerateCustomDescription(routing_queuesCmd.Short, routing_queues_users.Description, routing_queues_divisionviews.Description, routing_queues_comparisonperiods.Description, routing_queues_mediatypes.Description, routing_queues_members.Description, routing_queues_wrapupcodes.Description, routing_queues_me.Description, routing_queues_estimatedwaittime.Description, )
