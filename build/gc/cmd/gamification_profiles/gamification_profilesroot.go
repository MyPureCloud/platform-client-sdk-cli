...
func init() {
	...
	gamification_profilesCmd.Short = utils.GenerateCustomDescription(gamification_profilesCmd.Short, gamification_profiles_users.Description, gamification_profiles_activate.Description, gamification_profiles_deactivate.Description, gamification_profiles_metrics.Description, gamification_profiles_members.Description, )
