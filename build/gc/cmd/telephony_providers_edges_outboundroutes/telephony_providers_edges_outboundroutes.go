...
var (
	Description = utils.FormatUsageDescription("telephony_providers_edges_outboundroutes", "SWAGGER_OVERRIDE_/api/v2/telephony/providers/edges/outboundroutes", "SWAGGER_OVERRIDE_/api/v2/telephony/providers/edges/outboundroutes", )
