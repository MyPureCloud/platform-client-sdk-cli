## gc workforcemanagement businessunits weeks schedules copy create
...
```
gc workforcemanagement businessunits weeks schedules copy create [businessUnitId] [weekId] [scheduleId] [flags]
```
