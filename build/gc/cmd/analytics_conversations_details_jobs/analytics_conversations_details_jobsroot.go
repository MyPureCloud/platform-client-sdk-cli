...
func init() {
	...
	analytics_conversations_details_jobsCmd.Short = utils.GenerateCustomDescription(analytics_conversations_details_jobsCmd.Short, analytics_conversations_details_jobs_results.Description, analytics_conversations_details_jobs_availability.Description, )
