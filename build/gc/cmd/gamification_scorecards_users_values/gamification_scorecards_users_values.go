...
func init() {
	CommandService = services.NewCommandService(gamification_scorecards_users_valuesCmd)
}

func Cmdgamification_scorecards_users_values() *cobra.Command {
	return gamification_scorecards_users_valuesCmd
}
