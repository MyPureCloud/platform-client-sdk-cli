...
var (
    EvaluationsearchitemresponseMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type EvaluationsearchitemresponseDud struct { 
    Id string `json:"id"`
...
type Evaluationsearchitemresponse struct { 
    ...
    EvaluationForm Evaluationformsearchresponse `json:"evaluationForm"`
...
func (u *Evaluationsearchitemresponse) MarshalJSON() ([]byte, error) {
    type Alias Evaluationsearchitemresponse

    if EvaluationsearchitemresponseMarshalled {
        return []byte("{}"), nil
    }
    EvaluationsearchitemresponseMarshalled = true
