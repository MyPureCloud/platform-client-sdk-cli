...
func init() {
	...
	contentmanagement_documentsCmd.Short = utils.GenerateCustomDescription(contentmanagement_documentsCmd.Short, contentmanagement_documents_content.Description, )
