...
func init() {
	...
	languageunderstanding_domains_versionsCmd.Short = utils.GenerateCustomDescription(languageunderstanding_domains_versionsCmd.Short, languageunderstanding_domains_versions_publish.Description, languageunderstanding_domains_versions_report.Description, languageunderstanding_domains_versions_detect.Description, languageunderstanding_domains_versions_train.Description, )
