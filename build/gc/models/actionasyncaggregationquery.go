...
var (
    ActionasyncaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type ActionasyncaggregationqueryDud struct { 
...
type Actionasyncaggregationquery struct { 
    ...
    Filter Actionaggregatequeryfilter `json:"filter"`
    ...
    Views []Actionaggregationview `json:"views"`
...
func (o *Actionasyncaggregationquery) String() string {
...
func (u *Actionasyncaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Actionasyncaggregationquery

    if ActionasyncaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    ActionasyncaggregationqueryMarshalled = true
