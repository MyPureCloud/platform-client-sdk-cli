## gc workforcemanagement businessunits weeks schedules update uploadurl create
...
```
gc workforcemanagement businessunits weeks schedules update uploadurl create [businessUnitId] [weekId] [scheduleId] [flags]
```
