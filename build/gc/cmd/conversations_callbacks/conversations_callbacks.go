...
var (
	Description = utils.FormatUsageDescription("conversations_callbacks", "SWAGGER_OVERRIDE_/api/v2/conversations/callbacks", "SWAGGER_OVERRIDE_/api/v2/conversations/callbacks", "SWAGGER_OVERRIDE_/api/v2/conversations/callbacks", "SWAGGER_OVERRIDE_/api/v2/conversations/callbacks", )
