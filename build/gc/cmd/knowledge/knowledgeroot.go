...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/knowledge_connections"
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/knowledge_sources"
...
func init() {
	...
	knowledgeCmd.AddCommand(knowledge_connections.Cmdknowledge_connections())
	...
	knowledgeCmd.AddCommand(knowledge_sources.Cmdknowledge_sources())
	knowledgeCmd.AddCommand(knowledge_guest.Cmdknowledge_guest())
	knowledgeCmd.Short = utils.GenerateCustomDescription(knowledgeCmd.Short, knowledge_knowledgebases.Description, knowledge_integrations.Description, knowledge_documentuploads.Description, knowledge_connections.Description, knowledge_settings.Description, knowledge_search.Description, knowledge_sources.Description, knowledge_guest.Description, )
