...
func init() {
	...
	workforcemanagementCmd.Short = utils.GenerateCustomDescription(workforcemanagementCmd.Short, workforcemanagement_managementunits.Description, workforcemanagement_historicaldata.Description, workforcemanagement_timeoffrequests.Description, workforcemanagement_businessunits.Description, workforcemanagement_notifications.Description, workforcemanagement_adherence.Description, workforcemanagement_agentschedules.Description, workforcemanagement_shifttrades.Description, workforcemanagement_schedules.Description, workforcemanagement_schedulingjobs.Description, workforcemanagement_agents.Description, workforcemanagement_adhocmodelingjobs.Description, )
