## gc socialmedia topics dataingestionrules open reactions bulk create
...
```
gc socialmedia topics dataingestionrules open reactions bulk create [topicId] [ruleId] [flags]
```
