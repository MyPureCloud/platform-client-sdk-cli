...
var (
	Description = utils.FormatUsageDescription("analytics_reporting_settings", "SWAGGER_OVERRIDE_/api/v2/analytics/reporting/settings", "SWAGGER_OVERRIDE_/api/v2/analytics/reporting/settings", )
...
func Cmdanalytics_reporting_settings() *cobra.Command { 
	getCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", getCmd.UsageTemplate(), "GET", "/api/v2/analytics/reporting/settings", utils.FormatPermissions([]string{  }), utils.GenerateDevCentreLink("GET", "Analytics", "/api/v2/analytics/reporting/settings")))
...
var getCmd = &cobra.Command{
	Use:   "get",
	Short: "Get AnalyticsReportingSettings for an organization",
	Long:  "Get AnalyticsReportingSettings for an organization",
