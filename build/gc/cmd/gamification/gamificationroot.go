...
func init() {
	...
	gamificationCmd.Short = utils.GenerateCustomDescription(gamificationCmd.Short, gamification_leaderboard.Description, gamification_metrics.Description, gamification_templates.Description, gamification_profiles.Description, gamification_status.Description, gamification_metricdefinitions.Description, gamification_scorecards.Description, )
