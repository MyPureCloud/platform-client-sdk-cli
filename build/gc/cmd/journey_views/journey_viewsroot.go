...
func init() {
	...
	journey_viewsCmd.Short = utils.GenerateCustomDescription(journey_viewsCmd.Short, journey_views_versions.Description, journey_views_jobs.Description, journey_views_encodings.Description, journey_views_eventdefinitions.Description, )
