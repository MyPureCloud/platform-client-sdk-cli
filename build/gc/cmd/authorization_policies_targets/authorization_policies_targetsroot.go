...
func init() {
	...
	authorization_policies_targetsCmd.Short = utils.GenerateCustomDescription(authorization_policies_targetsCmd.Short, authorization_policies_targets_validate.Description, authorization_policies_targets_subject.Description, )
