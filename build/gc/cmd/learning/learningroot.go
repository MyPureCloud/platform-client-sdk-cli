...
func init() {
	...
	learningCmd.Short = utils.GenerateCustomDescription(learningCmd.Short, learning_rules.Description, learning_assignments.Description, learning_modules.Description, )
