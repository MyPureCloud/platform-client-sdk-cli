...
var (
    UseraggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type UseraggregationqueryDud struct { 
...
func (u *Useraggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Useraggregationquery

    if UseraggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    UseraggregationqueryMarshalled = true
