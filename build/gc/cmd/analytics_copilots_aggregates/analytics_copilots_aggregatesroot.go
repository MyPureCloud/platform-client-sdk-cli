...
func init() {
	...
	analytics_copilots_aggregatesCmd.Short = utils.GenerateCustomDescription(analytics_copilots_aggregatesCmd.Short, analytics_copilots_aggregates_jobs.Description, analytics_copilots_aggregates_query.Description, )
