...
func init() {
	...
	telephony_providers_edgesCmd.Short = utils.GenerateCustomDescription(telephony_providers_edgesCmd.Short, telephony_providers_edges_extensions.Description, telephony_providers_edges_timezones.Description, telephony_providers_edges_edgeversionreport.Description, telephony_providers_edges_sites.Description, telephony_providers_edges_logicalinterfaces.Description, telephony_providers_edges_diagnostic.Description, telephony_providers_edges_lines.Description, telephony_providers_edges_phonebasesettings.Description, telephony_providers_edges_didpools.Description, telephony_providers_edges_trunkbasesettings.Description, telephony_providers_edges_certificateauthorities.Description, telephony_providers_edges_physicalinterfaces.Description, telephony_providers_edges_unpair.Description, telephony_providers_edges_logs.Description, telephony_providers_edges_phones.Description, telephony_providers_edges_metrics.Description, telephony_providers_edges_reboot.Description, telephony_providers_edges_trunks.Description, telephony_providers_edges_edgegroups.Description, telephony_providers_edges_setuppackage.Description, telephony_providers_edges_outboundroutes.Description, telephony_providers_edges_softwareupdate.Description, telephony_providers_edges_extensionpools.Description, telephony_providers_edges_trunkswithrecording.Description, telephony_providers_edges_linebasesettings.Description, telephony_providers_edges_addressvalidation.Description, telephony_providers_edges_availablelanguages.Description, telephony_providers_edges_statuscode.Description, telephony_providers_edges_dids.Description, telephony_providers_edges_softwareversions.Description, )
