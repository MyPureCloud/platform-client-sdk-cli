...
var (
    JourneyaggregatequerypredicateMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type JourneyaggregatequerypredicateDud struct { 
...
func (o *Journeyaggregatequerypredicate) String() string {
...
func (u *Journeyaggregatequerypredicate) MarshalJSON() ([]byte, error) {
    type Alias Journeyaggregatequerypredicate

    if JourneyaggregatequerypredicateMarshalled {
        return []byte("{}"), nil
    }
    JourneyaggregatequerypredicateMarshalled = true
