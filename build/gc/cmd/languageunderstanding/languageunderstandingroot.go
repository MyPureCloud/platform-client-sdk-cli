...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/languageunderstanding_ignorephrases"
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/languageunderstanding_ignoretopics"
...
func init() {
	...
	languageunderstandingCmd.AddCommand(languageunderstanding_ignorephrases.Cmdlanguageunderstanding_ignorephrases())
	languageunderstandingCmd.AddCommand(languageunderstanding_ignoretopics.Cmdlanguageunderstanding_ignoretopics())
	languageunderstandingCmd.AddCommand(languageunderstanding_settings.Cmdlanguageunderstanding_settings())
	languageunderstandingCmd.Short = utils.GenerateCustomDescription(languageunderstandingCmd.Short, languageunderstanding_domains.Description, languageunderstanding_miners.Description, languageunderstanding_ignorephrases.Description, languageunderstanding_ignoretopics.Description, languageunderstanding_settings.Description, )
