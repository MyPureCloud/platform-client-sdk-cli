...
func init() {
	...
	coaching_scheduleslotsCmd.Short = utils.GenerateCustomDescription(coaching_scheduleslotsCmd.Short, coaching_scheduleslots_query.Description, coaching_scheduleslots_jobs.Description, )
