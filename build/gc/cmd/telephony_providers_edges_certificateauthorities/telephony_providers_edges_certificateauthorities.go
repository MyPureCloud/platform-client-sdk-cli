...
func Cmdtelephony_providers_edges_certificateauthorities() *cobra.Command { 
	createCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", createCmd.UsageTemplate(), "POST", "/api/v2/telephony/providers/edges/certificateauthorities", utils.FormatPermissions([]string{ "telephony:plugin:all",  })))
  ...
  &quot;schema&quot; : {
	...
	deleteCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", deleteCmd.UsageTemplate(), "DELETE", "/api/v2/telephony/providers/edges/certificateauthorities/{certificateId}", utils.FormatPermissions([]string{ "telephony:plugin:all",  })))
  ...
  &quot;description&quot; : &quot;Operation was successful.&quot;
	...
	getCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", getCmd.UsageTemplate(), "GET", "/api/v2/telephony/providers/edges/certificateauthorities/{certificateId}", utils.FormatPermissions([]string{ "telephony:plugin:all",  })))
  ...
  &quot;schema&quot; : {
	...
	listCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", listCmd.UsageTemplate(), "GET", "/api/v2/telephony/providers/edges/certificateauthorities", utils.FormatPermissions([]string{ "telephony:plugin:all",  })))
  ...
  &quot;schema&quot; : {
	...
	updateCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", updateCmd.UsageTemplate(), "PUT", "/api/v2/telephony/providers/edges/certificateauthorities/{certificateId}", utils.FormatPermissions([]string{ "telephony:plugin:all",  })))
