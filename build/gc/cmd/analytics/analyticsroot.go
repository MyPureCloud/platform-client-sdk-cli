...
func init() {
	...
	analyticsCmd.Short = utils.GenerateCustomDescription(analyticsCmd.Short, analytics_reporting.Description, analytics_surveys.Description, analytics_bots.Description, analytics_conversations.Description, analytics_queues.Description, analytics_journeys.Description, analytics_evaluations.Description, analytics_transcripts.Description, analytics_flows.Description, analytics_users.Description, )
