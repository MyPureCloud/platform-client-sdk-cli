...
func init() {
	...
	conversations_chats_communicationsCmd.Short = utils.GenerateCustomDescription(conversations_chats_communicationsCmd.Short, conversations_chats_communications_messages.Description, conversations_chats_communications_typing.Description, )
