...
func init() {
	...
	telephony_providers_edges_sitesCmd.Short = utils.GenerateCustomDescription(telephony_providers_edges_sitesCmd.Short, telephony_providers_edges_sites_numberplans.Description, telephony_providers_edges_sites_siteconnections.Description, telephony_providers_edges_sites_outboundroutes.Description, )
