...
var (
	Description = utils.FormatUsageDescription("knowledge_sources_synchronizations_uploads", "SWAGGER_OVERRIDE_/api/v2/knowledge/sources/{sourceId}/synchronizations/{synchronizationId}/uploads", )
