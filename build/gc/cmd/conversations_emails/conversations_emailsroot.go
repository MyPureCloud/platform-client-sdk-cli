...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/conversations_emails_agentless"
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/conversations_emails_reconnect"
)
...
func init() {
	...
	conversations_emailsCmd.AddCommand(conversations_emails_agentless.Cmdconversations_emails_agentless())
	...
	conversations_emailsCmd.AddCommand(conversations_emails_reconnect.Cmdconversations_emails_reconnect())
	conversations_emailsCmd.Short = utils.GenerateCustomDescription(conversations_emailsCmd.Short, conversations_emails_participants.Description, conversations_emails_messages.Description, conversations_emails_inboundmessages.Description, conversations_emails_agentless.Description, conversations_emails_recordingstate.Description, conversations_emails_settings.Description, conversations_emails_reconnect.Description, )
