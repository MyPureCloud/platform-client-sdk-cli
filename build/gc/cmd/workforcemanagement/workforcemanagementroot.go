...
func init() {
	...
	workforcemanagementCmd.Short = utils.GenerateCustomDescription(workforcemanagementCmd.Short, workforcemanagement_historicaldata.Description, workforcemanagement_notifications.Description, workforcemanagement_businessunits.Description, workforcemanagement_managementunits.Description, workforcemanagement_agents.Description, workforcemanagement_schedules.Description, workforcemanagement_timeoffrequests.Description, workforcemanagement_shifttrades.Description, workforcemanagement_adhocmodelingjobs.Description, workforcemanagement_adherence.Description, workforcemanagement_agentschedules.Description, workforcemanagement_schedulingjobs.Description, )
