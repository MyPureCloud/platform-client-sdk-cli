## gc responsemanagement responseassets bulk
...
* [gc responsemanagement responseassets bulk create](gc_responsemanagement_responseassets_bulk_create.html)	 - Get response assets.
