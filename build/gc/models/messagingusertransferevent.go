...
var (
    MessagingusertransfereventMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type MessagingusertransfereventDud struct { 
...
func (u *Messagingusertransferevent) MarshalJSON() ([]byte, error) {
    type Alias Messagingusertransferevent

    if MessagingusertransfereventMarshalled {
        return []byte("{}"), nil
    }
    MessagingusertransfereventMarshalled = true
