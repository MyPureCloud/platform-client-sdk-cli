package gamification_scorecards_users_points_average
...
var (
	Description = utils.FormatUsageDescription("gamification_scorecards_users_points_average", "SWAGGER_OVERRIDE_/api/v2/gamification/scorecards/users/points/average", )
	gamification_scorecards_users_points_averageCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("gamification_scorecards_users_points_average"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(gamification_scorecards_users_points_averageCmd)
}

func Cmdgamification_scorecards_users_points_average() *cobra.Command { 
  ...
  "schema" : {
    "$ref" : "#/definitions/SingleWorkdayAveragePoints"
  }
}`)
	gamification_scorecards_users_points_averageCmd.AddCommand(getCmd)
	
	return gamification_scorecards_users_points_averageCmd
}

var getCmd = &cobra.Command{
	Use:   "get",
	Short: "Workday average points by target group",
	Long:  "Workday average points by target group",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/gamification/scorecards/users/points/average"
