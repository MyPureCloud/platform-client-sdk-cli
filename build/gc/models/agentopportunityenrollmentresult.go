...
var (
    AgentopportunityenrollmentresultMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type AgentopportunityenrollmentresultDud struct { 
    Id string `json:"id"`
...
type Agentopportunityenrollmentresult struct { 
...
func (o *Agentopportunityenrollmentresult) String() string {
...
func (u *Agentopportunityenrollmentresult) MarshalJSON() ([]byte, error) {
    type Alias Agentopportunityenrollmentresult

    if AgentopportunityenrollmentresultMarshalled {
        return []byte("{}"), nil
    }
    AgentopportunityenrollmentresultMarshalled = true
