...
var (
    TranscriptasyncaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type TranscriptasyncaggregationqueryDud struct { 
...
type Transcriptasyncaggregationquery struct { 
...
func (o *Transcriptasyncaggregationquery) String() string {
...
func (u *Transcriptasyncaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Transcriptasyncaggregationquery

    if TranscriptasyncaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    TranscriptasyncaggregationqueryMarshalled = true
