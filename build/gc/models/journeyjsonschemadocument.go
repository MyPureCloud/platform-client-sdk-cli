...
var (
    JourneyjsonschemadocumentMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type JourneyjsonschemadocumentDud struct { 
...
func (u *Journeyjsonschemadocument) MarshalJSON() ([]byte, error) {
    type Alias Journeyjsonschemadocument

    if JourneyjsonschemadocumentMarshalled {
        return []byte("{}"), nil
    }
    JourneyjsonschemadocumentMarshalled = true
