## gc knowledge sources synchronizations

/api/v2/knowledge/sources/{sourceId}/synchronizations /api/v2/knowledge/sources/synchronizations
...
```
  -h, --help   help for synchronizations
```
...
* [gc knowledge sources synchronizations update](gc_knowledge_sources_synchronizations_update.html)	 - Update synchronization.
