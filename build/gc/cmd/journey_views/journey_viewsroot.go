...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/journey_views_data"
...
func init() {
	...
	journey_viewsCmd.AddCommand(journey_views_data.Cmdjourney_views_data())
	...
	journey_viewsCmd.Short = utils.GenerateCustomDescription(journey_viewsCmd.Short, journey_views_versions.Description, journey_views_data.Description, journey_views_encodings.Description, journey_views_eventdefinitions.Description, journey_views_jobs.Description, journey_views_schedules.Description, )
