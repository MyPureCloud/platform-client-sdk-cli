package conversations_cobrowsesessions_participants_wrapup
...
var (
	Description = utils.FormatUsageDescription("conversations_cobrowsesessions_participants_wrapup", "SWAGGER_OVERRIDE_/api/v2/conversations/cobrowsesessions/{conversationId}/participants/{participantId}/wrapup", )
	conversations_cobrowsesessions_participants_wrapupCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("conversations_cobrowsesessions_participants_wrapup"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(conversations_cobrowsesessions_participants_wrapupCmd)
}
...
func Cmdconversations_cobrowsesessions_participants_wrapup() *cobra.Command { 
  ...
  "schema" : {
	...
	conversations_cobrowsesessions_participants_wrapupCmd.AddCommand(getCmd)
	
	return conversations_cobrowsesessions_participants_wrapupCmd
}
...
var getCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/conversations/cobrowsesessions/{conversationId}/participants/{participantId}/wrapup"
