## gc socialmedia topics dataingestionrules instagram patch
...
```
gc socialmedia topics dataingestionrules instagram patch [topicId] [instagramIngestionRuleId] [flags]
```
