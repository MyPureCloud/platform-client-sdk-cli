...
func init() {
	...
	taskmanagement_workbinsCmd.Short = utils.GenerateCustomDescription(taskmanagement_workbinsCmd.Short, taskmanagement_workbins_query.Description, taskmanagement_workbins_history.Description, taskmanagement_workbins_versions.Description, )
