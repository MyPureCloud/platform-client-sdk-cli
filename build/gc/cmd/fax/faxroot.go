...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/fax_status"
...
func init() {
	...
	faxCmd.AddCommand(fax_status.Cmdfax_status())
	faxCmd.AddCommand(fax_summary.Cmdfax_summary())
	faxCmd.Short = utils.GenerateCustomDescription(faxCmd.Short, fax_settings.Description, fax_documents.Description, fax_status.Description, fax_summary.Description, )
