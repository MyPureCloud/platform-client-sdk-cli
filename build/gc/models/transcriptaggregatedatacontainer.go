...
var (
    TranscriptaggregatedatacontainerMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type TranscriptaggregatedatacontainerDud struct { 
...
func (u *Transcriptaggregatedatacontainer) MarshalJSON() ([]byte, error) {
    ...
    if TranscriptaggregatedatacontainerMarshalled {
        return []byte("{}"), nil
    }
    TranscriptaggregatedatacontainerMarshalled = true
