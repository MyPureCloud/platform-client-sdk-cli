...
func init() {
	...
	chatsCmd.Short = utils.GenerateCustomDescription(chatsCmd.Short, chats_settings.Description, chats_rooms.Description, chats_users.Description, chats_messages.Description, chats_threads.Description, )
