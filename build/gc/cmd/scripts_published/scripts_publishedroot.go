...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/scripts_published_divisionviews"
...
func init() {
	...
	scripts_publishedCmd.AddCommand(scripts_published_divisionviews.Cmdscripts_published_divisionviews())
	scripts_publishedCmd.AddCommand(scripts_published_variables.Cmdscripts_published_variables())
	scripts_publishedCmd.Short = utils.GenerateCustomDescription(scripts_publishedCmd.Short, scripts_published_pages.Description, scripts_published_divisionviews.Description, scripts_published_variables.Description, )
