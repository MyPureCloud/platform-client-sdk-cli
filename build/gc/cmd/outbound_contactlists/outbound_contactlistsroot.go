...
func init() {
	...
	outbound_contactlistsCmd.Short = utils.GenerateCustomDescription(outbound_contactlistsCmd.Short, outbound_contactlists_export.Description, outbound_contactlists_divisionviews.Description, outbound_contactlists_contacts.Description, outbound_contactlists_importstatus.Description, outbound_contactlists_clear.Description, outbound_contactlists_timezonemappingpreview.Description, )
