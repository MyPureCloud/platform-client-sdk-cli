...
var (
    FlowexecutionaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type FlowexecutionaggregationqueryDud struct { 
...
type Flowexecutionaggregationquery struct { 
...
func (o *Flowexecutionaggregationquery) String() string {
...
func (u *Flowexecutionaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Flowexecutionaggregationquery

    if FlowexecutionaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    FlowexecutionaggregationqueryMarshalled = true
