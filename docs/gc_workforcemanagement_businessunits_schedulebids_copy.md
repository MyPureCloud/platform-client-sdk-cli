## gc workforcemanagement businessunits schedulebids copy
...
* [gc workforcemanagement businessunits schedulebids copy create](gc_workforcemanagement_businessunits_schedulebids_copy_create.html)	 - Copy a schedule bid
