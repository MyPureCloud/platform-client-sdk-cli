...
func Cmdgamification_scorecards_users_values_trends() *cobra.Command { 
	...
	getCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", getCmd.UsageTemplate(), "GET", "/api/v2/gamification/scorecards/users/values/trends", utils.FormatPermissions([]string{ "gamification:scorecard:viewAll",  })))
  ...
  &quot;schema&quot; : {
	...
	listCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", listCmd.UsageTemplate(), "GET", "/api/v2/gamification/scorecards/users/{userId}/values/trends", utils.FormatPermissions([]string{ "gamification:scorecard:viewAll",  })))
