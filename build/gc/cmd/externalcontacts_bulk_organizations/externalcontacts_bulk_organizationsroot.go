...
func init() {
	...
	externalcontacts_bulk_organizationsCmd.Short = utils.GenerateCustomDescription(externalcontacts_bulk_organizationsCmd.Short, externalcontacts_bulk_organizations_add.Description, externalcontacts_bulk_organizations_update.Description, externalcontacts_bulk_organizations_remove.Description, )
