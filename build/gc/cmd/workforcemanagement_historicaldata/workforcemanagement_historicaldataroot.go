...
func init() {
	...
	workforcemanagement_historicaldataCmd.Short = utils.GenerateCustomDescription(workforcemanagement_historicaldataCmd.Short, workforcemanagement_historicaldata_deletejob.Description, workforcemanagement_historicaldata_validate.Description, workforcemanagement_historicaldata_importstatus.Description, )
