...
func init() {
	...
	architectCmd.Short = utils.GenerateCustomDescription(architectCmd.Short, architect_dependencytracking.Description, architect_emergencygroups.Description, architect_ivrs.Description, architect_prompts.Description, architect_schedulegroups.Description, architect_schedules.Description, architect_systemprompts.Description, architect_grammars.Description, )
