## gc businessrules decisiontables versions rows bulk remove
...
* [gc businessrules decisiontables versions rows bulk remove create](gc_businessrules_decisiontables_versions_rows_bulk_remove_create.html)	 - Bulk delete decision table rows
