...
func Cmdusage_query() *cobra.Command { 
	createCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", createCmd.UsageTemplate(), "POST", "/api/v2/usage/query", utils.FormatPermissions([]string{ "oauth:client:view", "usage:organization:view",  }), utils.GenerateDevCentreLink("POST", "Usage", "/api/v2/usage/query")))
