## gc workforcemanagement managementunits agents workplans bulk update
...
```
gc workforcemanagement managementunits agents workplans bulk update [managementUnitId] [flags]
```
