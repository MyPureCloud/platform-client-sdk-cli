...
func init() {
	...
	conversations_chats_participantsCmd.Short = utils.GenerateCustomDescription(conversations_chats_participantsCmd.Short, conversations_chats_participants_wrapupcodes.Description, conversations_chats_participants_replace.Description, conversations_chats_participants_attributes.Description, conversations_chats_participants_wrapup.Description, conversations_chats_participants_communications.Description, )
