...
func Cmdstations_associateduser() *cobra.Command { 
	deleteCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", deleteCmd.UsageTemplate(), "DELETE", "/api/v2/stations/{stationId}/associateduser", utils.FormatPermissions([]string{ "telephony:station:disassociate",  }), utils.GenerateDevCentreLink("DELETE", "Stations", "/api/v2/stations/{stationId}/associateduser")))
