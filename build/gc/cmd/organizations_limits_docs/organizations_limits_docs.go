...
var (
	Description = utils.FormatUsageDescription("organizations_limits_docs", "SWAGGER_OVERRIDE_/api/v2/organizations/limits/docs", )
	organizations_limits_docsCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("organizations_limits_docs"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(organizations_limits_docsCmd)
}
