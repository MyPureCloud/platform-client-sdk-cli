...
func Cmdarchitect_prompts_history() *cobra.Command { 
	createCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", createCmd.UsageTemplate(), "POST", "/api/v2/architect/prompts/{promptId}/history", utils.FormatPermissions([]string{ "architect:userPrompt:view",  })))
  ...
  &quot;schema&quot; : {
	...
	listCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", listCmd.UsageTemplate(), "GET", "/api/v2/architect/prompts/{promptId}/history/{historyId}", utils.FormatPermissions([]string{ "architect:userPrompt:view",  })))
