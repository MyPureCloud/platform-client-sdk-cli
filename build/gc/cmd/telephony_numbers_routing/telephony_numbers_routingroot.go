...
func init() {
	...
	telephony_numbers_routingCmd.Short = utils.GenerateCustomDescription(telephony_numbers_routingCmd.Short, telephony_numbers_routing_reset.Description, telephony_numbers_routing_all.Description, )
