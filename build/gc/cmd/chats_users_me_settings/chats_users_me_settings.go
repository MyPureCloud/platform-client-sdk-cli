...
var (
	Description = utils.FormatUsageDescription("chats_users_me_settings", "SWAGGER_OVERRIDE_/api/v2/chats/users/me/settings", "SWAGGER_OVERRIDE_/api/v2/chats/users/me/settings", "SWAGGER_OVERRIDE_/api/v2/chats/users/me/settings", "SWAGGER_OVERRIDE_/api/v2/chats/users/me/settings", )
...
func Cmdchats_users_me_settings() *cobra.Command { 
	createCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", createCmd.UsageTemplate(), "POST", "/api/v2/chats/users/me/settings", utils.FormatPermissions([]string{  }), utils.GenerateDevCentreLink("POST", "Chat", "/api/v2/chats/users/me/settings")))
	utils.AddFileFlagIfUpsert(createCmd.Flags(), "POST", `{
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/UserChatSettingsPost"
      }
    }
  },
  "required" : true
  ...
  "description" : "User Chat settings created successfully",
  "content" : { }
}`)
	chats_users_me_settingsCmd.AddCommand(createCmd)

	deleteCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", deleteCmd.UsageTemplate(), "DELETE", "/api/v2/chats/users/me/settings", utils.FormatPermissions([]string{  }), utils.GenerateDevCentreLink("DELETE", "Chat", "/api/v2/chats/users/me/settings")))
	utils.AddFileFlagIfUpsert(deleteCmd.Flags(), "DELETE", ``)
	
	
	utils.AddPaginateFlagsIfListingResponse(deleteCmd.Flags(), "DELETE", `{
  "description" : "User Chat settings deleted successfully",
  "content" : { }
}`)
	chats_users_me_settingsCmd.AddCommand(deleteCmd)
...
var createCmd = &cobra.Command{
	Use:   "create",
	Short: "Create a user`s chat settings",
	Long:  "Create a user`s chat settings",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if printReqBody {
			...
			reqModel := models.Userchatsettingspost{}
...
var deleteCmd = &cobra.Command{
	Use:   "delete",
	Short: "Delete a user`s chat settings",
	Long:  "Delete a user`s chat settings",
	Args:  utils.DetermineArgs([]string{ }),
