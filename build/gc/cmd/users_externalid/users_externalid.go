...
var (
	Description = utils.FormatUsageDescription("users_externalid", "SWAGGER_OVERRIDE_/api/v2/users/{userId}/externalid", "SWAGGER_OVERRIDE_/api/v2/users/{userId}/externalid/{authorityName}", "SWAGGER_OVERRIDE_/api/v2/users/externalid/{authorityName}", "SWAGGER_OVERRIDE_/api/v2/users/{userId}/externalid", "SWAGGER_OVERRIDE_/api/v2/users/{userId}/externalid", )
...
func Cmdusers_externalid() *cobra.Command { 
  ...
  "content" : { }
	...
	getCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", getCmd.UsageTemplate(), "GET", "/api/v2/users/externalid/{authorityName}/{externalKey}", utils.FormatPermissions([]string{  }), utils.GenerateDevCentreLink("GET", "Users", "/api/v2/users/externalid/{authorityName}/{externalKey}")))
  ...
  "content" : {
	...
	users_externalidCmd.AddCommand(getCmd)

	getCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", getCmd.UsageTemplate(), "GET", "/api/v2/users/{userId}/externalid/{authorityName}", utils.FormatPermissions([]string{  }), utils.GenerateDevCentreLink("GET", "Users", "/api/v2/users/{userId}/externalid/{authorityName}")))
	utils.AddFileFlagIfUpsert(getCmd.Flags(), "GET", ``)
  ...
  "content" : {
	...
	getCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", getCmd.UsageTemplate(), "GET", "/api/v2/users/{userId}/externalid", utils.FormatPermissions([]string{  }), utils.GenerateDevCentreLink("GET", "Users", "/api/v2/users/{userId}/externalid")))
	utils.AddFileFlagIfUpsert(getCmd.Flags(), "GET", ``)
...
var getCmd = &cobra.Command{
	Use:   "get [authorityName] [externalKey]",
