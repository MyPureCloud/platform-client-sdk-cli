...
func init() {
	...
	qualityCmd.Short = utils.GenerateCustomDescription(qualityCmd.Short, quality_forms.Description, quality_surveys.Description, quality_evaluations.Description, quality_conversations.Description, quality_publishedforms.Description, quality_calibrations.Description, quality_agents.Description, quality_evaluators.Description, )
