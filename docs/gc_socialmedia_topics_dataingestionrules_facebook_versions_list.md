## gc socialmedia topics dataingestionrules facebook versions list
...
```
gc socialmedia topics dataingestionrules facebook versions list [topicId] [facebookIngestionRuleId] [flags]
```
