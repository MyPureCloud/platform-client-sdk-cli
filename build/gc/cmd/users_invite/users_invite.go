...
func Cmdusers_invite() *cobra.Command { 
	...
	createCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", createCmd.UsageTemplate(), "POST", "/api/v2/users/{userId}/invite", utils.FormatPermissions([]string{ "admin", "directory:organization:admin", "directory:user:setPassword",  }), utils.GenerateDevCentreLink("POST", "Users", "/api/v2/users/{userId}/invite")))
