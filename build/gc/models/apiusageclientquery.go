...
var (
    ApiusageclientqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type ApiusageclientqueryDud struct { 
...
func (u *Apiusageclientquery) MarshalJSON() ([]byte, error) {
    type Alias Apiusageclientquery

    if ApiusageclientqueryMarshalled {
        return []byte("{}"), nil
    }
    ApiusageclientqueryMarshalled = true
