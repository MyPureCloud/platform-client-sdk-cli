...
func init() {
	...
	integrations_speechCmd.Short = utils.GenerateCustomDescription(integrations_speechCmd.Short, integrations_speech_dialogflow.Description, integrations_speech_dialogflowcx.Description, integrations_speech_lex.Description, integrations_speech_lexv2.Description, integrations_speech_nuance.Description, integrations_speech_stt.Description, integrations_speech_tts.Description, )
