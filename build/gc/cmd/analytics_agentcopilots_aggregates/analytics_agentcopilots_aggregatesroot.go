...
func init() {
	...
	analytics_agentcopilots_aggregatesCmd.Short = utils.GenerateCustomDescription(analytics_agentcopilots_aggregatesCmd.Short, analytics_agentcopilots_aggregates_query.Description, analytics_agentcopilots_aggregates_jobs.Description, )
