...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/externalcontacts_organizations_exports"
)
...
func init() {
	...
	externalcontacts_organizationsCmd.AddCommand(externalcontacts_organizations_exports.Cmdexternalcontacts_organizations_exports())
	externalcontacts_organizationsCmd.Short = utils.GenerateCustomDescription(externalcontacts_organizationsCmd.Short, externalcontacts_organizations_enrich.Description, externalcontacts_organizations_contacts.Description, externalcontacts_organizations_identifiers.Description, externalcontacts_organizations_notes.Description, externalcontacts_organizations_relationships.Description, externalcontacts_organizations_schemas.Description, externalcontacts_organizations_trustor.Description, externalcontacts_organizations_exports.Description, )
