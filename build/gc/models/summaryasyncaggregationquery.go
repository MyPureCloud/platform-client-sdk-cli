...
var (
    SummaryasyncaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type SummaryasyncaggregationqueryDud struct { 
...
type Summaryasyncaggregationquery struct { 
    ...
    SortMetric Summaryaggregationsort `json:"sortMetric"`
...
func (o *Summaryasyncaggregationquery) String() string {
...
func (u *Summaryasyncaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Summaryasyncaggregationquery

    if SummaryasyncaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    SummaryasyncaggregationqueryMarshalled = true
