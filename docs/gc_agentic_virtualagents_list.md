...
```
gc agentic virtualagents list [flags]
```
...
```
  ...
  -h, --help                     help for list
      ...
      --status string            Filter by status. Valid values: Draft, Published
...
* [gc agentic virtualagents](gc_agentic_virtualagents.html)	 - /api/v2/agentic/virtualagents
