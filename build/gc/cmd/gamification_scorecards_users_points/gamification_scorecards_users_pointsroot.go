...
func init() {
	...
	gamification_scorecards_users_pointsCmd.Short = utils.GenerateCustomDescription(gamification_scorecards_users_pointsCmd.Short, gamification_scorecards_users_points_average.Description, gamification_scorecards_users_points_trends.Description, gamification_scorecards_users_points_alltime.Description, )
