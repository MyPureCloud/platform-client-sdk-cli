...
func init() {
	...
	analytics_users_detailsCmd.Short = utils.GenerateCustomDescription(analytics_users_detailsCmd.Short, analytics_users_details_jobs.Description, analytics_users_details_query.Description, )
