...
func init() {
	...
	analytics_agents_statusCmd.Short = utils.GenerateCustomDescription(analytics_agents_statusCmd.Short, analytics_agents_status_query.Description, analytics_agents_status_counts.Description, )
