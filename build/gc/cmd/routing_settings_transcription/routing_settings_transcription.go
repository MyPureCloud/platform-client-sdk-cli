...
var (
	Description = utils.FormatUsageDescription("routing_settings_transcription", "SWAGGER_OVERRIDE_/api/v2/routing/settings/transcription", "SWAGGER_OVERRIDE_/api/v2/routing/settings/transcription", "SWAGGER_OVERRIDE_/api/v2/routing/settings/transcription", )
...
func Cmdrouting_settings_transcription() *cobra.Command { 
  ...
  "content" : {
	...
	modifyCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", modifyCmd.UsageTemplate(), "PATCH", "/api/v2/routing/settings/transcription", utils.FormatPermissions([]string{ "routing:transcriptionSettings:edit",  }), utils.GenerateDevCentreLink("PATCH", "Routing", "/api/v2/routing/settings/transcription")))
  ...
  "content" : {
	...
	routing_settings_transcriptionCmd.AddCommand(modifyCmd)
...
var modifyCmd = &cobra.Command{
	Use:   "modify",
	Short: "Patch Transcription Settings",
	Long:  "Patch Transcription Settings",
	Args:  utils.DetermineArgs([]string{ }),
