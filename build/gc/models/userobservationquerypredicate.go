...
var (
    UserobservationquerypredicateMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type UserobservationquerypredicateDud struct { 
...
func (u *Userobservationquerypredicate) MarshalJSON() ([]byte, error) {
    ...
    if UserobservationquerypredicateMarshalled {
        return []byte("{}"), nil
    }
    UserobservationquerypredicateMarshalled = true
