## gc workforcemanagement managementunits users timeoffrequests get
...
```
gc workforcemanagement managementunits users timeoffrequests get [managementUnitId] [userId] [timeOffRequestId] [flags]
```
