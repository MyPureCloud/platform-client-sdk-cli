...
var (
	Description = utils.FormatUsageDescription("workforcemanagement_historicaldata_importstatus", "SWAGGER_OVERRIDE_/api/v2/workforcemanagement/historicaldata/importstatus", "SWAGGER_OVERRIDE_/api/v2/workforcemanagement/historicaldata/importstatus", )
...
func Cmdworkforcemanagement_historicaldata_importstatus() *cobra.Command { 
	getCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", getCmd.UsageTemplate(), "GET", "/api/v2/workforcemanagement/historicaldata/importstatus/{jobId}", utils.FormatPermissions([]string{ "wfm:historicalData:upload",  }), utils.GenerateDevCentreLink("GET", "Workforce Management", "/api/v2/workforcemanagement/historicaldata/importstatus/{jobId}")))
  ...
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/HistoricalImportStatusJobResponse"
      }
    }
  }
}`)
	workforcemanagement_historicaldata_importstatusCmd.AddCommand(getCmd)
...
var getCmd = &cobra.Command{
	Use:   "get [jobId]",
	Short: "Retrieves status of the historical data imports associated with job id",
	Long:  "Retrieves status of the historical data imports associated with job id",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/workforcemanagement/historicaldata/importstatus/{jobId}"
