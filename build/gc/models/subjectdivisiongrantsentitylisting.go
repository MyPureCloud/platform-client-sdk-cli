...
var (
    SubjectdivisiongrantsentitylistingMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type SubjectdivisiongrantsentitylistingDud struct { 
...
func (u *Subjectdivisiongrantsentitylisting) MarshalJSON() ([]byte, error) {
    type Alias Subjectdivisiongrantsentitylisting

    if SubjectdivisiongrantsentitylistingMarshalled {
        return []byte("{}"), nil
    }
