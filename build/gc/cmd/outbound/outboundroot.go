...
func init() {
	...
	outboundCmd.Short = utils.GenerateCustomDescription(outboundCmd.Short, outbound_dnclists.Description, outbound_contactlists.Description, outbound_campaigns.Description, outbound_settings.Description, outbound_campaignrules.Description, outbound_attemptlimits.Description, outbound_messagingcampaigns.Description, outbound_callanalysisresponsesets.Description, outbound_schedules.Description, outbound_rulesets.Description, outbound_events.Description, outbound_contactlistfilters.Description, outbound_sequences.Description, outbound_callabletimesets.Description, outbound_conversations.Description, outbound_wrapupcodemappings.Description, outbound_audits.Description, )
