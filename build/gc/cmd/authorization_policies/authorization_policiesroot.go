...
func init() {
	...
	authorization_policiesCmd.Short = utils.GenerateCustomDescription(authorization_policiesCmd.Short, authorization_policies_targets.Description, authorization_policies_subject.Description, authorization_policies_attributes.Description, authorization_policies_simulate.Description, )
