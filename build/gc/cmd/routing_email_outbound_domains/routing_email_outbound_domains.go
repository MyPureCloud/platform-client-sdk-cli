...
func Cmdrouting_email_outbound_domains() *cobra.Command { 
	createCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", createCmd.UsageTemplate(), "POST", "/api/v2/routing/email/outbound/domains", utils.FormatPermissions([]string{ "routing:email:manage",  }), utils.GenerateDevCentreLink("POST", "Routing", "/api/v2/routing/email/outbound/domains")))
  ...
  "content" : {
	...
	routing_email_outbound_domainsCmd.AddCommand(createCmd)

	deleteCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", deleteCmd.UsageTemplate(), "DELETE", "/api/v2/routing/email/outbound/domains/{domainId}", utils.FormatPermissions([]string{ "routing:email:manage",  }), utils.GenerateDevCentreLink("DELETE", "Routing", "/api/v2/routing/email/outbound/domains/{domainId}")))
  ...
  "content" : { }
	...
	routing_email_outbound_domainsCmd.AddCommand(deleteCmd)

	getCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", getCmd.UsageTemplate(), "GET", "/api/v2/routing/email/outbound/domains/{domainId}", utils.FormatPermissions([]string{ "routing:email:manage",  }), utils.GenerateDevCentreLink("GET", "Routing", "/api/v2/routing/email/outbound/domains/{domainId}")))
...
var createCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if printReqBody {
			...
			reqModel := models.Outbounddomain{}
...
var deleteCmd = &cobra.Command{
	Use:   "delete [domainId]",
	Short: "Delete an outbound domain",
	Long:  "Delete an outbound domain",
...
var listCmd = &cobra.Command{
	Use:   "list",
	Short: "Get outbound domains",
	Long:  "Get outbound domains",
	Args:  utils.DetermineArgs([]string{ }),
