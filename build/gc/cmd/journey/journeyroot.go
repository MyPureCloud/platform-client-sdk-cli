...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/journey_externalevents"
...
func init() {
	...
	journeyCmd.AddCommand(journey_externalevents.Cmdjourney_externalevents())
	...
	journeyCmd.Short = utils.GenerateCustomDescription(journeyCmd.Short, journey_actionmaps.Description, journey_actiontargets.Description, journey_actiontemplates.Description, journey_sessions.Description, journey_externalevents.Description, journey_flows.Description, journey_outcomes.Description, journey_segments.Description, journey_views.Description, journey_deployments.Description, )
