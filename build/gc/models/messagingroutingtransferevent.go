...
var (
    MessagingroutingtransfereventMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type MessagingroutingtransfereventDud struct { 
...
func (u *Messagingroutingtransferevent) MarshalJSON() ([]byte, error) {
    type Alias Messagingroutingtransferevent

    if MessagingroutingtransfereventMarshalled {
        return []byte("{}"), nil
    }
    MessagingroutingtransfereventMarshalled = true
