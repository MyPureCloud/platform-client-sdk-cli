...
func init() {
	...
	webdeployments_deploymentsCmd.Short = utils.GenerateCustomDescription(webdeployments_deploymentsCmd.Short, webdeployments_deployments_cobrowse.Description, webdeployments_deployments_configurations.Description, webdeployments_deployments_identityresolution.Description, )
