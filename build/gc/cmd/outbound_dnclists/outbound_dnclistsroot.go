...
func init() {
	...
	outbound_dnclistsCmd.Short = utils.GenerateCustomDescription(outbound_dnclistsCmd.Short, outbound_dnclists_importstatus.Description, outbound_dnclists_divisionviews.Description, outbound_dnclists_phonenumbers.Description, outbound_dnclists_export.Description, )
