## gc socialmedia topics dataingestionrules googlebusinessprofile get
...
```
gc socialmedia topics dataingestionrules googlebusinessprofile get [topicId] [googleBusinessProfileIngestionRuleId] [flags]
```
