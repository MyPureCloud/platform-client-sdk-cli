## gc workforcemanagement managementunits weeks shifttrades state

/api/v2/workforcemanagement/managementunits/{managementUnitId}/weeks/{weekDateId}/shifttrades/state
