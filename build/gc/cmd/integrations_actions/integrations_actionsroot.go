...
func init() {
	...
	integrations_actionsCmd.Short = utils.GenerateCustomDescription(integrations_actionsCmd.Short, integrations_actions_categories.Description, integrations_actions_certificates.Description, integrations_actions_draft.Description, integrations_actions_execute.Description, integrations_actions_schemas.Description, integrations_actions_templates.Description, integrations_actions_testfile.Description, integrations_actions_drafts.Description, integrations_actions_function.Description, integrations_actions_functions.Description, )
