...
func init() {
	...
	qualityCmd.Short = utils.GenerateCustomDescription(qualityCmd.Short, quality_publishedforms.Description, quality_surveys.Description, quality_conversations.Description, quality_forms.Description, quality_evaluators.Description, quality_calibrations.Description, quality_evaluations.Description, quality_agents.Description, )
