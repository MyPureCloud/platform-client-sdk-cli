...
var (
    InternalmessagemediaparticipantMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type InternalmessagemediaparticipantDud struct { 
...
type Internalmessagemediaparticipant struct { 
    ...
    // InternalMessageId - The internal message communication ID.
    InternalMessageId string `json:"internalMessageId"`


    // TargetUser - The user participant on receiving side of the internal message conversation.
    TargetUser Addressableentityref `json:"targetUser"`


    // SourceUser - The user participant on sending side of the internal message conversation.
...
func (o *Internalmessagemediaparticipant) String() string {
...
func (u *Internalmessagemediaparticipant) MarshalJSON() ([]byte, error) {
    type Alias Internalmessagemediaparticipant

    if InternalmessagemediaparticipantMarshalled {
        return []byte("{}"), nil
    }
    InternalmessagemediaparticipantMarshalled = true
