...
func init() {
	...
	analytics_surveys_aggregatesCmd.Short = utils.GenerateCustomDescription(analytics_surveys_aggregatesCmd.Short, analytics_surveys_aggregates_jobs.Description, analytics_surveys_aggregates_query.Description, )
