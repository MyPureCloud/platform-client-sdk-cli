...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/webdeployments_deployments_identityresolution"
...
func init() {
	...
	webdeployments_deploymentsCmd.AddCommand(webdeployments_deployments_identityresolution.Cmdwebdeployments_deployments_identityresolution())
	...
	webdeployments_deploymentsCmd.Short = utils.GenerateCustomDescription(webdeployments_deploymentsCmd.Short, webdeployments_deployments_cobrowse.Description, webdeployments_deployments_identityresolution.Description, webdeployments_deployments_configurations.Description, )
