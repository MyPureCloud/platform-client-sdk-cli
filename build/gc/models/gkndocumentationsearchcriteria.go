...
var (
    GkndocumentationsearchcriteriaMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type GkndocumentationsearchcriteriaDud struct { 
...
func (o *Gkndocumentationsearchcriteria) String() string {
     ...
     o.Group = []Gkndocumentationsearchcriteria{{}} 
...
func (u *Gkndocumentationsearchcriteria) MarshalJSON() ([]byte, error) {
    type Alias Gkndocumentationsearchcriteria

    if GkndocumentationsearchcriteriaMarshalled {
        return []byte("{}"), nil
    }
    GkndocumentationsearchcriteriaMarshalled = true
