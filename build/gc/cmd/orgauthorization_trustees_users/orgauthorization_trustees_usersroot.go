...
func init() {
	...
	orgauthorization_trustees_usersCmd.Short = utils.GenerateCustomDescription(orgauthorization_trustees_usersCmd.Short, orgauthorization_trustees_users_roledivisions.Description, orgauthorization_trustees_users_roles.Description, )
