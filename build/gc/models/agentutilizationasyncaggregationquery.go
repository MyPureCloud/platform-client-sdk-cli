...
var (
    AgentutilizationasyncaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type AgentutilizationasyncaggregationqueryDud struct { 
...
type Agentutilizationasyncaggregationquery struct { 
    ...
    Filter Agentutilizationaggregatequeryfilter `json:"filter"`
    ...
    Views []Agentutilizationaggregationview `json:"views"`
...
func (o *Agentutilizationasyncaggregationquery) String() string {
     ...
     o.Views = []Agentutilizationaggregationview{{}} 
...
func (u *Agentutilizationasyncaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Agentutilizationasyncaggregationquery

    if AgentutilizationasyncaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    AgentutilizationasyncaggregationqueryMarshalled = true
    ...
    return json.Marshal(&struct {
        ...
        *Alias
        ...
        Views: []Agentutilizationaggregationview{{}},
