## gc workforcemanagement managementunits workplanrotations update
...
```
gc workforcemanagement managementunits workplanrotations update [managementUnitId] [workPlanRotationId] [flags]
```
