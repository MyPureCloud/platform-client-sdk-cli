## gc knowledge knowledgebases languages documents delete
...
```
gc knowledge knowledgebases languages documents delete [documentId] [knowledgeBaseId] [languageCode] [flags]
```
