...
var deletecontactsCmd = &cobra.Command{
	...
	Short: "Delete contacts from a contact list. Only contacts that are not in use by any campaign will be deleted",
	Long:  "Delete contacts from a contact list. Only contacts that are not in use by any campaign will be deleted",
	Args:  utils.DetermineArgs([]string{ "contactListId", }),
