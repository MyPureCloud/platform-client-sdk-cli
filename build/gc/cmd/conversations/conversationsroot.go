...
func init() {
	...
	conversationsCmd.Short = utils.GenerateCustomDescription(conversationsCmd.Short, conversations_cobrowsesessions.Description, conversations_participants.Description, conversations_messaging.Description, conversations_recordings.Description, conversations_messages.Description, conversations_callbacks.Description, conversations_chats.Description, conversations_emails.Description, conversations_recordingmetadata.Description, conversations_faxes.Description, conversations_disconnect.Description, conversations_assign.Description, conversations_calls.Description, )
