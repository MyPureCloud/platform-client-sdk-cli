...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/uploads_learning"
...
func init() {
	uploadsCmd.AddCommand(uploads_learning.Cmduploads_learning())
	...
	uploadsCmd.Short = utils.GenerateCustomDescription(uploadsCmd.Short, uploads_learning.Description, uploads_workforcemanagement.Description, uploads_publicassets.Description, uploads_recordings.Description, )
