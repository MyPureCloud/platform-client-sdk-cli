...
var (
	Description = utils.FormatUsageDescription("analytics_conversations_details", "SWAGGER_OVERRIDE_/api/v2/analytics/conversations/{conversationId}/details", "SWAGGER_OVERRIDE_/api/v2/analytics/conversations/details", )
	analytics_conversations_detailsCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("analytics_conversations_details"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(analytics_conversations_detailsCmd)
}

func Cmdanalytics_conversations_details() *cobra.Command { 
	getCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", getCmd.UsageTemplate(), "GET", "/api/v2/analytics/conversations/{conversationId}/details", utils.FormatPermissions([]string{ "analytics:conversationDetail:view", "analytics:agentConversationDetail:view",  }), utils.GenerateDevCentreLink("GET", "Analytics", "/api/v2/analytics/conversations/{conversationId}/details")))
...
var listCmd = &cobra.Command{
	Use:   "list",
	Short: "Gets multiple conversations by id",
	Long:  "Gets multiple conversations by id",
