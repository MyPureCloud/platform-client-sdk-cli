...
var (
    ActionaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type ActionaggregationqueryDud struct { 
...
type Actionaggregationquery struct { 
...
func (o *Actionaggregationquery) String() string {
...
func (u *Actionaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Actionaggregationquery

    if ActionaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    ActionaggregationqueryMarshalled = true
