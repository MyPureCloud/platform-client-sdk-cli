...
func init() {
	...
	outbound_campaignsCmd.Short = utils.GenerateCustomDescription(outbound_campaignsCmd.Short, outbound_campaigns_agents.Description, outbound_campaigns_callback.Description, outbound_campaigns_divisionviews.Description, outbound_campaigns_interactions.Description, outbound_campaigns_agentownedmappingpreview.Description, outbound_campaigns_diagnostics.Description, outbound_campaigns_progress.Description, outbound_campaigns_stats.Description, outbound_campaigns_all.Description, )
