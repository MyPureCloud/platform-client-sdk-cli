...
func Cmdoutbound_callabletimesets() *cobra.Command { 
  ...
  "schema" : {
	...
	listCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", listCmd.UsageTemplate(), "GET", "/api/v2/outbound/callabletimesets", utils.FormatPermissions([]string{ "outbound:callableTimeSet:view",  }), utils.GenerateDevCentreLink("GET", "Outbound", "/api/v2/outbound/callabletimesets")))
...
var createCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if printReqBody {
			...
			reqModel := models.Callabletimeset{}
