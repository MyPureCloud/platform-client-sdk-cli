...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/chats_users_me"
...
func init() {
	...
	chats_usersCmd.AddCommand(chats_users_me.Cmdchats_users_me())
	chats_usersCmd.AddCommand(chats_users_settings.Cmdchats_users_settings())
	chats_usersCmd.Short = utils.GenerateCustomDescription(chats_usersCmd.Short, chats_users_messages.Description, chats_users_me.Description, chats_users_settings.Description, )
