...
func init() {
	...
	gamification_scorecards_usersCmd.Short = utils.GenerateCustomDescription(gamification_scorecards_usersCmd.Short, gamification_scorecards_users_points.Description, gamification_scorecards_users_bestpoints.Description, gamification_scorecards_users_attendance.Description, gamification_scorecards_users_values.Description, )
