## gc workforcemanagement businessunits planninggroups update
...
```
gc workforcemanagement businessunits planninggroups update [businessUnitId] [planningGroupId] [flags]
```
