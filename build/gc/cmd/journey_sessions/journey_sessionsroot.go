...
func init() {
	...
	journey_sessionsCmd.Short = utils.GenerateCustomDescription(journey_sessionsCmd.Short, journey_sessions_events.Description, journey_sessions_outcomescores.Description, )
