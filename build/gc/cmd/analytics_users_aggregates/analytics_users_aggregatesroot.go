...
func init() {
	...
	analytics_users_aggregatesCmd.Short = utils.GenerateCustomDescription(analytics_users_aggregatesCmd.Short, analytics_users_aggregates_jobs.Description, analytics_users_aggregates_query.Description, )
