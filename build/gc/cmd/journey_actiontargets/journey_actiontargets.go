...
var (
	Description = utils.FormatUsageDescription("journey_actiontargets", "SWAGGER_OVERRIDE_/api/v2/journey/actiontargets", "SWAGGER_OVERRIDE_/api/v2/journey/actiontargets", "SWAGGER_OVERRIDE_/api/v2/journey/actiontargets", )
	journey_actiontargetsCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("journey_actiontargets"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(journey_actiontargetsCmd)
}
...
func Cmdjourney_actiontargets() *cobra.Command { 
  ...
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/PatchActionTarget"
      }
    }
  },
  "required" : false
  ...
  "content" : {
	...
	return journey_actiontargetsCmd
}
