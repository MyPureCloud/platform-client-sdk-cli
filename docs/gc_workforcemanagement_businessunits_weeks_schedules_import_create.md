## gc workforcemanagement businessunits weeks schedules import create
...
```
gc workforcemanagement businessunits weeks schedules import create [businessUnitId] [weekId] [flags]
```
