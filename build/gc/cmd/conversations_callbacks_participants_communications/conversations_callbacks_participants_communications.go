...
var (
	Description = utils.FormatUsageDescription("conversations_callbacks_participants_communications", "SWAGGER_OVERRIDE_/api/v2/conversations/callbacks/{conversationId}/participants/{participantId}/communications", )
	conversations_callbacks_participants_communicationsCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("conversations_callbacks_participants_communications"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(conversations_callbacks_participants_communicationsCmd)
}

func Cmdconversations_callbacks_participants_communications() *cobra.Command { 
	updateCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", updateCmd.UsageTemplate(), "PATCH", "/api/v2/conversations/callbacks/{conversationId}/participants/{participantId}/communications/{communicationId}", utils.FormatPermissions([]string{  })))
  ...
  &quot;schema&quot; : {
	...
	return conversations_callbacks_participants_communicationsCmd
}
