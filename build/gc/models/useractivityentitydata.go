...
var (
    UseractivityentitydataMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type UseractivityentitydataDud struct { 
...
type Useractivityentitydata struct { 
...
func (o *Useractivityentitydata) String() string {
...
func (u *Useractivityentitydata) MarshalJSON() ([]byte, error) {
    type Alias Useractivityentitydata

    if UseractivityentitydataMarshalled {
        return []byte("{}"), nil
    }
    UseractivityentitydataMarshalled = true
