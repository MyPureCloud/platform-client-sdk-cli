...
func init() {
	...
	integrations_actions_draftCmd.Short = utils.GenerateCustomDescription(integrations_actions_draftCmd.Short, integrations_actions_draft_validation.Description, integrations_actions_draft_schemas.Description, integrations_actions_draft_templates.Description, integrations_actions_draft_publish.Description, integrations_actions_draft_testfile.Description, integrations_actions_draft_function.Description, )
