...
func init() {
	...
	analytics_taskmanagementCmd.Short = utils.GenerateCustomDescription(analytics_taskmanagementCmd.Short, analytics_taskmanagement_metrics.Description, analytics_taskmanagement_aggregates.Description, )
