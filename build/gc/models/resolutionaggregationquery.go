...
var (
    ResolutionaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type ResolutionaggregationqueryDud struct { 
...
type Resolutionaggregationquery struct { 
...
func (o *Resolutionaggregationquery) String() string {
...
func (u *Resolutionaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Resolutionaggregationquery

    if ResolutionaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    ResolutionaggregationqueryMarshalled = true
