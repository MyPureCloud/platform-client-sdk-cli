...
func init() {
	...
	usersCmd.Short = utils.GenerateCustomDescription(usersCmd.Short, users_profile.Description, users_routingstatus.Description, users_me.Description, users_development.Description, users_profileskills.Description, users_station.Description, users_presences.Description, users_outofoffice.Description, users_search.Description, users_roles.Description, users_password.Description, users_invite.Description, users_greetings.Description, users_bulk.Description, users_queues.Description, users_routinglanguages.Description, users_adjacents.Description, users_superiors.Description, users_directreports.Description, users_favorites.Description, users_callforwarding.Description, users_trustors.Description, users_routingskills.Description, users_geolocations.Description, )
