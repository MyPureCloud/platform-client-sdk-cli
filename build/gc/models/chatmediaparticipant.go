...
var (
    ChatmediaparticipantMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type ChatmediaparticipantDud struct { 
...
func (u *Chatmediaparticipant) MarshalJSON() ([]byte, error) {
    type Alias Chatmediaparticipant

    if ChatmediaparticipantMarshalled {
        return []byte("{}"), nil
    }
    ChatmediaparticipantMarshalled = true
