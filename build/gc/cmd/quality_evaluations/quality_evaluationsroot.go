...
func init() {
	...
	quality_evaluationsCmd.Short = utils.GenerateCustomDescription(quality_evaluationsCmd.Short, quality_evaluations_aggregates.Description, quality_evaluations_query.Description, quality_evaluations_scoring.Description, )
