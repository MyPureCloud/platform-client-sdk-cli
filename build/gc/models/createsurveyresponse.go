...
var (
    CreatesurveyresponseMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type CreatesurveyresponseDud struct { 
    Id string `json:"id"`
...
type Createsurveyresponse struct { 
    ...
    // CustomerSurveyUrl - The URL for the customer survey.
    CustomerSurveyUrl string `json:"customerSurveyUrl"`
...
func (o *Createsurveyresponse) String() string {
...
func (u *Createsurveyresponse) MarshalJSON() ([]byte, error) {
    type Alias Createsurveyresponse

    if CreatesurveyresponseMarshalled {
        return []byte("{}"), nil
    }
    CreatesurveyresponseMarshalled = true
