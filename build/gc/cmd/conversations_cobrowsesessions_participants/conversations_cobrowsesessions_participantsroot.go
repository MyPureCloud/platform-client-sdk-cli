...
func init() {
	...
	conversations_cobrowsesessions_participantsCmd.Short = utils.GenerateCustomDescription(conversations_cobrowsesessions_participantsCmd.Short, conversations_cobrowsesessions_participants_wrapupcodes.Description, conversations_cobrowsesessions_participants_communications.Description, conversations_cobrowsesessions_participants_replace.Description, conversations_cobrowsesessions_participants_attributes.Description, conversations_cobrowsesessions_participants_wrapup.Description, )
