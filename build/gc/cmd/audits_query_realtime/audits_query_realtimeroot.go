...
func init() {
	...
	audits_query_realtimeCmd.Short = utils.GenerateCustomDescription(audits_query_realtimeCmd.Short, audits_query_realtime_related.Description, audits_query_realtime_servicemapping.Description, )
