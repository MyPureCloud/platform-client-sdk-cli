...
var (
	Description = utils.FormatUsageDescription("knowledge_knowledgebases_documents", "SWAGGER_OVERRIDE_/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents", "SWAGGER_OVERRIDE_/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents", "SWAGGER_OVERRIDE_/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents", "SWAGGER_OVERRIDE_/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents", "SWAGGER_OVERRIDE_/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents", )
	knowledge_knowledgebases_documentsCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("knowledge_knowledgebases_documents"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(knowledge_knowledgebases_documentsCmd)
}

func Cmdknowledge_knowledgebases_documents() *cobra.Command { 
	createCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", createCmd.UsageTemplate(), "POST", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents", utils.FormatPermissions([]string{ "knowledge:document:add",  }), utils.GenerateDevCentreLink("POST", "Knowledge", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents")))
  ...
  "content" : {
	...
	knowledge_knowledgebases_documentsCmd.AddCommand(createCmd)

	deleteCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", deleteCmd.UsageTemplate(), "DELETE", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents/{documentId}", utils.FormatPermissions([]string{ "knowledge:document:delete",  }), utils.GenerateDevCentreLink("DELETE", "Knowledge", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents/{documentId}")))
  ...
  "content" : { }
	...
	knowledge_knowledgebases_documentsCmd.AddCommand(deleteCmd)

	utils.AddFlag(getCmd.Flags(), "[]string", "expand", "", "The specified entity attributes will be filled. Comma separated values expected. Max No. of variations that can be returned on expand is 20. Valid values: category, labels, variations")
	utils.AddFlag(getCmd.Flags(), "string", "state", "", "when state is Draft, draft version of the document is returned,otherwise by default published version is returned in the response. Valid values: Draft, Published")
	getCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", getCmd.UsageTemplate(), "GET", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents/{documentId}", utils.FormatPermissions([]string{ "knowledge:document:view",  }), utils.GenerateDevCentreLink("GET", "Knowledge", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents/{documentId}")))
  ...
  "content" : {
	...
	knowledge_knowledgebases_documentsCmd.AddCommand(getCmd)
  ...
  "content" : {
	...
	knowledge_knowledgebases_documentsCmd.AddCommand(listCmd)

	updateCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", updateCmd.UsageTemplate(), "PATCH", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents/{documentId}", utils.FormatPermissions([]string{ "knowledge:document:edit",  }), utils.GenerateDevCentreLink("PATCH", "Knowledge", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents/{documentId}")))
  ...
  "content" : {
	...
	knowledge_knowledgebases_documentsCmd.AddCommand(updateCmd)
	return knowledge_knowledgebases_documentsCmd
}
...
var createCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents"
...
var deleteCmd = &cobra.Command{
	Use:   "delete [knowledgeBaseId] [documentId]",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents/{documentId}"
		knowledgeBaseId, args := args[0], args[1:]
		path = strings.Replace(path, "{knowledgeBaseId}", fmt.Sprintf("%v", knowledgeBaseId), -1)
...
var getCmd = &cobra.Command{
	Use:   "get [knowledgeBaseId] [documentId]",
	Short: "Get document.",
	Long:  "Get document.",
	Args:  utils.DetermineArgs([]string{ "knowledgeBaseId", "documentId", }),
...
var listCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		includeSubcategories := utils.GetFlag(cmd.Flags(), "bool", "includeSubcategories")
		if includeSubcategories != "" {
			queryParams["includeSubcategories"] = includeSubcategories
		}
		includeDrafts := utils.GetFlag(cmd.Flags(), "bool", "includeDrafts")
		if includeDrafts != "" {
			queryParams["includeDrafts"] = includeDrafts
		}
		labelIds := utils.GetFlag(cmd.Flags(), "[]string", "labelIds")
		if labelIds != "" {
		...
		externalIds := utils.GetFlag(cmd.Flags(), "[]string", "externalIds")
		if externalIds != "" {
			queryParams["externalIds"] = externalIds
		}
		urlString := path
		if len(queryParams) > 0 {
			urlString = fmt.Sprintf("%v?", path)
...
var updateCmd = &cobra.Command{
	Use:   "update [knowledgeBaseId] [documentId]",
