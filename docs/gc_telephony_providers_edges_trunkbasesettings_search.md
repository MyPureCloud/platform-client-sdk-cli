## gc telephony providers edges trunkbasesettings search
...
* [gc telephony providers edges trunkbasesettings search create](gc_telephony_providers_edges_trunkbasesettings_search_create.html)	 - Search Trunk Base Settings
