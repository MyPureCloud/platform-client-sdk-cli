## gc knowledge knowledgebases languages documents imports create
...
```
gc knowledge knowledgebases languages documents imports create [knowledgeBaseId] [languageCode] [flags]
```
