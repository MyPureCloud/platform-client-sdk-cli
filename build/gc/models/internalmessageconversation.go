...
var (
    InternalmessageconversationMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type InternalmessageconversationDud struct { 
    Id string `json:"id"`
...
type Internalmessageconversation struct { 
    ...
    Participants []Internalmessagemediaparticipant `json:"participants"`
...
func (o *Internalmessageconversation) String() string {
    
     o.Participants = []Internalmessagemediaparticipant{{}} 
...
func (u *Internalmessageconversation) MarshalJSON() ([]byte, error) {
    type Alias Internalmessageconversation

    if InternalmessageconversationMarshalled {
        return []byte("{}"), nil
    }
    InternalmessageconversationMarshalled = true
    ...
    return json.Marshal(&struct {
        ...
        *Alias
        ...
        Participants: []Internalmessagemediaparticipant{{}},
