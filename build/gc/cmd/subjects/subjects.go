...
var (
	subjectsCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("subjects"),
		Short: utils.FormatUsageDescription("Manages Genesys Cloud subjects", "SWAGGER_OVERRIDE_authorization subjects", ),
		Long:  utils.FormatUsageDescription(`Manages Genesys Cloud subjects`, "SWAGGER_OVERRIDE_authorization subjects", ),
	}
	CommandService services.CommandService
)

func init() {
	CommandService = services.NewCommandService(subjectsCmd)
}

func Cmdsubjects() *cobra.Command { 
