...
var (
    EmailmessagepreviewMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type EmailmessagepreviewDud struct { 
    Id string `json:"id"`
...
type Emailmessagepreview struct { 
    ...
    TextBodyPreview string `json:"textBodyPreview"`
...
func (u *Emailmessagepreview) MarshalJSON() ([]byte, error) {
    type Alias Emailmessagepreview

    if EmailmessagepreviewMarshalled {
        return []byte("{}"), nil
    }
    EmailmessagepreviewMarshalled = true
