...
var (
    QueueobservationquerypredicateMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type QueueobservationquerypredicateDud struct { 
...
func (o *Queueobservationquerypredicate) String() string {
...
func (u *Queueobservationquerypredicate) MarshalJSON() ([]byte, error) {
    type Alias Queueobservationquerypredicate

    if QueueobservationquerypredicateMarshalled {
        return []byte("{}"), nil
    }
    QueueobservationquerypredicateMarshalled = true
