...
func init() {
	...
	alerting_alertsCmd.Short = utils.GenerateCustomDescription(alerting_alertsCmd.Short, alerting_alerts_active.Description, alerting_alerts_bulk.Description, alerting_alerts_query.Description, alerting_alerts_all.Description, )
