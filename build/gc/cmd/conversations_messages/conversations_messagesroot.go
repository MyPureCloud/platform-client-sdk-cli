...
func init() {
	...
	conversations_messagesCmd.Short = utils.GenerateCustomDescription(conversations_messagesCmd.Short, conversations_messages_participants.Description, conversations_messages_details.Description, conversations_messages_messages.Description, conversations_messages_communications.Description, conversations_messages_inbound.Description, conversations_messages_recordingstate.Description, conversations_messages_agentless.Description, )
