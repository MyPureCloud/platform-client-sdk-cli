...
func init() {
	...
	intents_customerintents_sourceintents_bulkCmd.Short = utils.GenerateCustomDescription(intents_customerintents_sourceintents_bulkCmd.Short, intents_customerintents_sourceintents_bulk_add.Description, intents_customerintents_sourceintents_bulk_remove.Description, )
