...
func init() {
	...
	screenmonitorsCmd.Short = utils.GenerateCustomDescription(screenmonitorsCmd.Short, screenmonitors_sessions.Description, screenmonitors_users.Description, screenmonitors_settings.Description, )
