...
var (
    FlowobservationquerypredicateMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type FlowobservationquerypredicateDud struct { 
...
func (u *Flowobservationquerypredicate) MarshalJSON() ([]byte, error) {
    type Alias Flowobservationquerypredicate

    if FlowobservationquerypredicateMarshalled {
        return []byte("{}"), nil
    }
    FlowobservationquerypredicateMarshalled = true
