...
func init() {
	...
	conversations_messaging_facebookCmd.Short = utils.GenerateCustomDescription(conversations_messaging_facebookCmd.Short, conversations_messaging_facebook_app.Description, )
