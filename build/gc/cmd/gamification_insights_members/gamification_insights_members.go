package gamification_insights_members
...
var (
	Description = utils.FormatUsageDescription("gamification_insights_members", "SWAGGER_OVERRIDE_/api/v2/gamification/insights/members", )
	gamification_insights_membersCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("gamification_insights_members"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(gamification_insights_membersCmd)
}

func Cmdgamification_insights_members() *cobra.Command { 
  ...
  "content" : {
	...
	gamification_insights_membersCmd.AddCommand(listCmd)
	return gamification_insights_membersCmd
}
...
var listCmd = &cobra.Command{
	Use:   "list",
	Short: "Query users in a profile during a period of time",
	Long:  "Query users in a profile during a period of time",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/gamification/insights/members"
