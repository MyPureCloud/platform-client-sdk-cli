...
func init() {
	...
	conversations_emails_participantsCmd.Short = utils.GenerateCustomDescription(conversations_emails_participantsCmd.Short, conversations_emails_participants_replace.Description, conversations_emails_participants_wrapupcodes.Description, conversations_emails_participants_parkingstate.Description, conversations_emails_participants_communications.Description, conversations_emails_participants_attributes.Description, conversations_emails_participants_wrapup.Description, )
