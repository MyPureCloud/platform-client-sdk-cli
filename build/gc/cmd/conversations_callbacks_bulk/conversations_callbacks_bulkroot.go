...
func init() {
	...
	conversations_callbacks_bulkCmd.Short = utils.GenerateCustomDescription(conversations_callbacks_bulkCmd.Short, conversations_callbacks_bulk_disconnect.Description, conversations_callbacks_bulk_update.Description, )
