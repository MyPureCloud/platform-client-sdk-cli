...
var (
    EvaluateshifttradelistjobrequestMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type EvaluateshifttradelistjobrequestDud struct { 
...
func (u *Evaluateshifttradelistjobrequest) MarshalJSON() ([]byte, error) {
    type Alias Evaluateshifttradelistjobrequest

    if EvaluateshifttradelistjobrequestMarshalled {
        return []byte("{}"), nil
    }
    EvaluateshifttradelistjobrequestMarshalled = true
