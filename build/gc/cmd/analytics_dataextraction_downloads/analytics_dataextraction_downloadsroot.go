...
func init() {
	...
	analytics_dataextraction_downloadsCmd.Short = utils.GenerateCustomDescription(analytics_dataextraction_downloadsCmd.Short, analytics_dataextraction_downloads_bulk.Description, analytics_dataextraction_downloads_metadata.Description, )
