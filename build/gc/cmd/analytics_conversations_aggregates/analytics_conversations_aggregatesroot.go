...
func init() {
	...
	analytics_conversations_aggregatesCmd.Short = utils.GenerateCustomDescription(analytics_conversations_aggregatesCmd.Short, analytics_conversations_aggregates_query.Description, )
