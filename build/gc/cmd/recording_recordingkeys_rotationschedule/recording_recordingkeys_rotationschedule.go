package recording_recordingkeys_rotationschedule
...
var (
	Description = utils.FormatUsageDescription("recording_recordingkeys_rotationschedule", "SWAGGER_OVERRIDE_/api/v2/recording/recordingkeys/rotationschedule", "SWAGGER_OVERRIDE_/api/v2/recording/recordingkeys/rotationschedule", )
	recording_recordingkeys_rotationscheduleCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("recording_recordingkeys_rotationschedule"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(recording_recordingkeys_rotationscheduleCmd)
}
...
var getCmd = &cobra.Command{
	Use:   "get",
	Short: "Get key rotation schedule",
	Long:  "Get key rotation schedule",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/recording/recordingkeys/rotationschedule"
...
var updateCmd = &cobra.Command{
	Use:   "update",
	Short: "Update key rotation schedule",
	Long:  "Update key rotation schedule",
	Args:  utils.DetermineArgs([]string{ }),
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if printReqBody {
			...
			reqModel := models.Keyrotationschedule{}
