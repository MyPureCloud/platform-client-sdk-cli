## gc socialmedia topics dataingestionrules googlebusinessprofile create
...
```
gc socialmedia topics dataingestionrules googlebusinessprofile create [topicId] [flags]
```
