...
func init() {
	...
	casemanagement_caseplansCmd.Short = utils.GenerateCustomDescription(casemanagement_caseplansCmd.Short, casemanagement_caseplans_publish.Description, casemanagement_caseplans_versions.Description, casemanagement_caseplans_intakesettings.Description, casemanagement_caseplans_stageplans.Description, )
