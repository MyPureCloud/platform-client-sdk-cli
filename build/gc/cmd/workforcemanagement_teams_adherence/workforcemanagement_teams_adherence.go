...
func Cmdworkforcemanagement_teams_adherence() *cobra.Command { 
	getCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", getCmd.UsageTemplate(), "GET", "/api/v2/workforcemanagement/teams/{teamId}/adherence", utils.FormatPermissions([]string{ "wfm:realtimeAdherence:view",  }), utils.GenerateDevCentreLink("GET", "Workforce Management", "/api/v2/workforcemanagement/teams/{teamId}/adherence")))
  ...
  "content" : {
	...
	workforcemanagement_teams_adherenceCmd.AddCommand(getCmd)
...
var getCmd = &cobra.Command{
	Use:   "get [teamId]",
	Short: "Get a list of user schedule adherence records for the requested team",
	Long:  "Get a list of user schedule adherence records for the requested team",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/workforcemanagement/teams/{teamId}/adherence"
