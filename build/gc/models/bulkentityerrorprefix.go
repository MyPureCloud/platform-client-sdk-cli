...
var (
    BulkentityerrorprefixMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type BulkentityerrorprefixDud struct { 
...
type Bulkentityerrorprefix struct { 
...
func (o *Bulkentityerrorprefix) String() string {
...
func (u *Bulkentityerrorprefix) MarshalJSON() ([]byte, error) {
    type Alias Bulkentityerrorprefix

    if BulkentityerrorprefixMarshalled {
        return []byte("{}"), nil
    }
    BulkentityerrorprefixMarshalled = true
