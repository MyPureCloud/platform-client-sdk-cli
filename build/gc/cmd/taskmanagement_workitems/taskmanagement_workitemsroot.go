...
func init() {
	...
	taskmanagement_workitemsCmd.Short = utils.GenerateCustomDescription(taskmanagement_workitemsCmd.Short, taskmanagement_workitems_query.Description, taskmanagement_workitems_disconnect.Description, taskmanagement_workitems_terminate.Description, taskmanagement_workitems_assignment.Description, taskmanagement_workitems_acd.Description, taskmanagement_workitems_schemas.Description, taskmanagement_workitems_users.Description, taskmanagement_workitems_wrapups.Description, taskmanagement_workitems_versions.Description, taskmanagement_workitems_history.Description, )
