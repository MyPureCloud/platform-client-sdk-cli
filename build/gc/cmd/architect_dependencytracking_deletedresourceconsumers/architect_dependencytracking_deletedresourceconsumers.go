...
func Cmdarchitect_dependencytracking_deletedresourceconsumers() *cobra.Command { 
	...
	listCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", listCmd.UsageTemplate(), "GET", "/api/v2/architect/dependencytracking/deletedresourceconsumers", utils.FormatPermissions([]string{ "architect:dependencyTracking:view",  })))
