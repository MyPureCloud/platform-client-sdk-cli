...
var (
	Description = utils.FormatUsageDescription("workforcemanagement_businessunits_weeks_schedules_update", "SWAGGER_OVERRIDE_/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekId}/schedules/{scheduleId}/update", )
	workforcemanagement_businessunits_weeks_schedules_updateCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("workforcemanagement_businessunits_weeks_schedules_update"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(workforcemanagement_businessunits_weeks_schedules_updateCmd)
}
...
var createCmd = &cobra.Command{
	...
	Short: "Starts processing a schedule update",
	Long:  "Starts processing a schedule update",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if printReqBody {
			...
			reqModel := models.Processscheduleupdateuploadrequest{}
		...
		path := "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekId}/schedules/{scheduleId}/update"
