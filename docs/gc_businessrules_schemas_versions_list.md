## gc businessrules schemas versions list
...
```
gc businessrules schemas versions list [schemaId] [flags]
```
...
```
  ...
  -h, --help                     help for list
      --pageSize string          Number of items per page (must be between 1 and 100)
