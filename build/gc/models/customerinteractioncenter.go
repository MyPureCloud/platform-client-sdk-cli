...
var (
    CustomerinteractioncenterMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type CustomerinteractioncenterDud struct { 
    Id string `json:"id"`
...
func (u *Customerinteractioncenter) MarshalJSON() ([]byte, error) {
    ...
    if CustomerinteractioncenterMarshalled {
        return []byte("{}"), nil
    }
    CustomerinteractioncenterMarshalled = true
