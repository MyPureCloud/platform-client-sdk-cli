...
func init() {
	...
	speechandtextanalytics_conversationsCmd.Short = utils.GenerateCustomDescription(speechandtextanalytics_conversationsCmd.Short, speechandtextanalytics_conversations_categories.Description, speechandtextanalytics_conversations_communications.Description, )
