...
var (
    GooglebusinessprofiledataingestionruleversionresponseMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type GooglebusinessprofiledataingestionruleversionresponseDud struct { 
...
type Googlebusinessprofiledataingestionruleversionresponse struct { 
...
func (u *Googlebusinessprofiledataingestionruleversionresponse) MarshalJSON() ([]byte, error) {
    type Alias Googlebusinessprofiledataingestionruleversionresponse

    if GooglebusinessprofiledataingestionruleversionresponseMarshalled {
        return []byte("{}"), nil
    }
    GooglebusinessprofiledataingestionruleversionresponseMarshalled = true
