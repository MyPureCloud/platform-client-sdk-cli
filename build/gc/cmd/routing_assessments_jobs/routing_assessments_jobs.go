package routing_assessments_jobs
...
var (
	Description = utils.FormatUsageDescription("routing_assessments_jobs", "SWAGGER_OVERRIDE_/api/v2/routing/assessments/jobs", "SWAGGER_OVERRIDE_/api/v2/routing/assessments/jobs", "SWAGGER_OVERRIDE_/api/v2/routing/assessments/jobs", )
	routing_assessments_jobsCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("routing_assessments_jobs"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(routing_assessments_jobsCmd)
}
...
var createCmd = &cobra.Command{
	Use:   "create",
	Short: "Create a benefit assessment job.",
	Long:  "Create a benefit assessment job.",
...
var getCmd = &cobra.Command{
	Use:   "get [jobId]",
	Short: "Retrieve a single benefit assessments job.",
	Long:  "Retrieve a single benefit assessments job.",
...
var listCmd = &cobra.Command{
	Use:   "list",
	Short: "Retrieve all benefit assessment jobs.",
	Long:  "Retrieve all benefit assessment jobs.",
	Args:  utils.DetermineArgs([]string{ }),
