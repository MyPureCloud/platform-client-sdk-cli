...
var (
    EmailcommunicationdispositionappliedeventMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type EmailcommunicationdispositionappliedeventDud struct { 
...
type Emailcommunicationdispositionappliedevent struct { 
...
func (o *Emailcommunicationdispositionappliedevent) String() string {
...
func (u *Emailcommunicationdispositionappliedevent) MarshalJSON() ([]byte, error) {
    type Alias Emailcommunicationdispositionappliedevent

    if EmailcommunicationdispositionappliedeventMarshalled {
        return []byte("{}"), nil
    }
    EmailcommunicationdispositionappliedeventMarshalled = true
