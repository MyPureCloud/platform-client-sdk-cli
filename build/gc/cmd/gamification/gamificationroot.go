...
func init() {
	...
	gamificationCmd.Short = utils.GenerateCustomDescription(gamificationCmd.Short, gamification_metrics.Description, gamification_scorecards.Description, gamification_profiles.Description, gamification_templates.Description, gamification_metricdefinitions.Description, gamification_status.Description, gamification_leaderboard.Description, )
