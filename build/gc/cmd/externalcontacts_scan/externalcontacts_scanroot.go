...
func init() {
	...
	externalcontacts_scanCmd.Short = utils.GenerateCustomDescription(externalcontacts_scanCmd.Short, externalcontacts_scan_notes.Description, externalcontacts_scan_relationships.Description, externalcontacts_scan_organizations.Description, externalcontacts_scan_contacts.Description, )
