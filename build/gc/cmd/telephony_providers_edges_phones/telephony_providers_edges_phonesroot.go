...
func init() {
	...
	telephony_providers_edges_phonesCmd.Short = utils.GenerateCustomDescription(telephony_providers_edges_phonesCmd.Short, telephony_providers_edges_phones_reboot.Description, telephony_providers_edges_phones_template.Description, )
