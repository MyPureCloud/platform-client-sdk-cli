## gc workforcemanagement businessunits staffinggroups update
...
```
gc workforcemanagement businessunits staffinggroups update [businessUnitId] [staffingGroupId] [flags]
```
