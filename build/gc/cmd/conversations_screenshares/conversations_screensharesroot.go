...
func init() {
	...
	conversations_screensharesCmd.Short = utils.GenerateCustomDescription(conversations_screensharesCmd.Short, conversations_screenshares_recordingstate.Description, conversations_screenshares_participants.Description, )
