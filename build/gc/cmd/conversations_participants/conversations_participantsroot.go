...
func init() {
	...
	conversations_participantsCmd.Short = utils.GenerateCustomDescription(conversations_participantsCmd.Short, conversations_participants_attributes.Description, conversations_participants_codes.Description, conversations_participants_wrapupcodes.Description, conversations_participants_replace.Description, conversations_participants_digits.Description, conversations_participants_callbacks.Description, conversations_participants_wrapup.Description, conversations_participants_flaggedreason.Description, conversations_participants_secureivrsessions.Description, )
