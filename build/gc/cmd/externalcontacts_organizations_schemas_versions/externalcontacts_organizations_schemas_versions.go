...
func Cmdexternalcontacts_organizations_schemas_versions() *cobra.Command { 
	getCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", getCmd.UsageTemplate(), "GET", "/api/v2/externalcontacts/organizations/schemas/{schemaId}/versions/{versionId}", utils.FormatPermissions([]string{ "externalContacts:customFields:view",  })))
  ...
  &quot;schema&quot; : {
	...
	listCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", listCmd.UsageTemplate(), "GET", "/api/v2/externalcontacts/organizations/schemas/{schemaId}/versions", utils.FormatPermissions([]string{ "externalContacts:customFields:view",  })))
