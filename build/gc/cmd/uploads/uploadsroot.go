...
func init() {
	...
	uploadsCmd.Short = utils.GenerateCustomDescription(uploadsCmd.Short, uploads_workforcemanagement.Description, uploads_recordings.Description, uploads_publicassets.Description, )
