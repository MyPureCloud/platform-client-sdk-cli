## gc knowledge knowledgebases documents variations update
...
```
gc knowledge knowledgebases documents variations update [documentVariationId] [documentId] [knowledgeBaseId] [flags]
```
