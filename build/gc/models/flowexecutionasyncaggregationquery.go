...
var (
    FlowexecutionasyncaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type FlowexecutionasyncaggregationqueryDud struct { 
...
type Flowexecutionasyncaggregationquery struct { 
    ...
    Filter Flowexecutionaggregatequeryfilter `json:"filter"`
    ...
    Views []Flowexecutionaggregationview `json:"views"`
...
func (o *Flowexecutionasyncaggregationquery) String() string {
     ...
     o.Views = []Flowexecutionaggregationview{{}} 
...
func (u *Flowexecutionasyncaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Flowexecutionasyncaggregationquery

    if FlowexecutionasyncaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    FlowexecutionasyncaggregationqueryMarshalled = true
    ...
    return json.Marshal(&struct {
        ...
        *Alias
        ...
        Views: []Flowexecutionaggregationview{{}},
