...
var (
    MessagingprogresstransfereventMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type MessagingprogresstransfereventDud struct { 
...
type Messagingprogresstransferevent struct { 
...
func (o *Messagingprogresstransferevent) String() string {
...
func (u *Messagingprogresstransferevent) MarshalJSON() ([]byte, error) {
    type Alias Messagingprogresstransferevent

    if MessagingprogresstransfereventMarshalled {
        return []byte("{}"), nil
    }
    MessagingprogresstransfereventMarshalled = true
