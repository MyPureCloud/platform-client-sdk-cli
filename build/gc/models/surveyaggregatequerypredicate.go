...
var (
    SurveyaggregatequerypredicateMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type SurveyaggregatequerypredicateDud struct { 
...
func (u *Surveyaggregatequerypredicate) MarshalJSON() ([]byte, error) {
    type Alias Surveyaggregatequerypredicate

    if SurveyaggregatequerypredicateMarshalled {
        return []byte("{}"), nil
    }
    SurveyaggregatequerypredicateMarshalled = true
