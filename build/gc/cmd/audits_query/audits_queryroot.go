...
func init() {
	...
	audits_queryCmd.Short = utils.GenerateCustomDescription(audits_queryCmd.Short, audits_query_results.Description, audits_query_servicemapping.Description, audits_query_realtime.Description, )
