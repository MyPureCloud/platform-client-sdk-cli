...
func init() {
	...
	knowledge_knowledgebases_languagesCmd.Short = utils.GenerateCustomDescription(knowledge_knowledgebases_languagesCmd.Short, knowledge_knowledgebases_languages_categories.Description, knowledge_knowledgebases_languages_documents.Description, knowledge_knowledgebases_languages_trainings.Description, )
