...
var (
	Description = utils.FormatUsageDescription("routing_skills", "SWAGGER_OVERRIDE_/api/v2/routing/skills", "SWAGGER_OVERRIDE_/api/v2/routing/skills", "SWAGGER_OVERRIDE_/api/v2/routing/skills", "SWAGGER_OVERRIDE_/api/v2/routing/skills", )
