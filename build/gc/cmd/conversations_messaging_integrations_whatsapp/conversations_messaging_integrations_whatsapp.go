...
func Cmdconversations_messaging_integrations_whatsapp() *cobra.Command { 
  ...
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/WhatsAppIntegrationRequest"
      }
    }
  },
  "required" : true
  ...
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/WhatsAppIntegrationUpdateRequest"
      }
    }
  },
  "required" : true
...
var createCmd = &cobra.Command{
	Use:   "create",
	Short: "[This API is deprecated. Use POST /api/v2/conversations/messaging/integrations/whatsapp/embeddedsignup instead] Create a WhatsApp Integration",
	Long:  "[This API is deprecated. Use POST /api/v2/conversations/messaging/integrations/whatsapp/embeddedsignup instead] Create a WhatsApp Integration",
...
var updateCmd = &cobra.Command{
	...
	Short: "Update a WhatsApp messaging integration",
	Long:  "Update a WhatsApp messaging integration",
	Args:  utils.DetermineArgs([]string{ "integrationId", }),
