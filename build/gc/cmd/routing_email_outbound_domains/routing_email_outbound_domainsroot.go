...
func init() {
	...
	routing_email_outbound_domainsCmd.Short = utils.GenerateCustomDescription(routing_email_outbound_domainsCmd.Short, routing_email_outbound_domains_activation.Description, routing_email_outbound_domains_search.Description, routing_email_outbound_domains_simulated.Description, )
