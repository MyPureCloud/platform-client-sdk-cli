...
func init() {
	...
	analytics_flowexecutions_aggregatesCmd.Short = utils.GenerateCustomDescription(analytics_flowexecutions_aggregatesCmd.Short, analytics_flowexecutions_aggregates_jobs.Description, analytics_flowexecutions_aggregates_query.Description, )
