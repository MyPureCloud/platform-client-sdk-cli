...
func init() {
	...
	speechandtextanalyticsCmd.Short = utils.GenerateCustomDescription(speechandtextanalyticsCmd.Short, speechandtextanalytics_conversations.Description, speechandtextanalytics_settings.Description, speechandtextanalytics_dialects.Description, speechandtextanalytics_programs.Description, speechandtextanalytics_topics.Description, speechandtextanalytics_transcripts.Description, )
