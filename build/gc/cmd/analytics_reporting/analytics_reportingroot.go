...
func init() {
	...
	analytics_reportingCmd.Short = utils.GenerateCustomDescription(analytics_reportingCmd.Short, analytics_reporting_settings.Description, analytics_reporting_dashboards.Description, analytics_reporting_reportformats.Description, analytics_reporting_schedules.Description, analytics_reporting_metadata.Description, analytics_reporting_timeperiods.Description, analytics_reporting_exports.Description, )
