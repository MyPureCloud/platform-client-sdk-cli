...
func init() {
	...
	flows_datatablesCmd.Short = utils.GenerateCustomDescription(flows_datatablesCmd.Short, flows_datatables_rows.Description, flows_datatables_export.Description, flows_datatables_import.Description, )
