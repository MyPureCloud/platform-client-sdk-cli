package gamification_insights_users_trends
...
var (
	Description = utils.FormatUsageDescription("gamification_insights_users_trends", "SWAGGER_OVERRIDE_/api/v2/gamification/insights/users/{userId}/trends", )
	gamification_insights_users_trendsCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("gamification_insights_users_trends"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(gamification_insights_users_trendsCmd)
}

func Cmdgamification_insights_users_trends() *cobra.Command { 
	...
	listCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", listCmd.UsageTemplate(), "GET", "/api/v2/gamification/insights/users/{userId}/trends", utils.FormatPermissions([]string{ "gamification:insights:viewAll",  }), utils.GenerateDevCentreLink("GET", "Gamification", "/api/v2/gamification/insights/users/{userId}/trends")))
  ...
  "content" : {
	...
	gamification_insights_users_trendsCmd.AddCommand(listCmd)
	return gamification_insights_users_trendsCmd
}
...
var listCmd = &cobra.Command{
	Use:   "list [userId]",
	Short: "Get insights user trend for the user",
	Long:  "Get insights user trend for the user",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/gamification/insights/users/{userId}/trends"
