...
func Cmdaudits_query_results() *cobra.Command { 
	...
	utils.AddFlag(listCmd.Flags(), "bool", "allowRedirect", "", "Result sets with large amounts of data will respond with a download url")
...
var listCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		allowRedirect := utils.GetFlag(cmd.Flags(), "bool", "allowRedirect")
		if allowRedirect != "" {
			queryParams["allowRedirect"] = allowRedirect
		}
		urlString := path
