...
func init() {
	...
	conversations_callbacksCmd.Short = utils.GenerateCustomDescription(conversations_callbacksCmd.Short, conversations_callbacks_bulk.Description, conversations_callbacks_recordingstate.Description, conversations_callbacks_participants.Description, )
