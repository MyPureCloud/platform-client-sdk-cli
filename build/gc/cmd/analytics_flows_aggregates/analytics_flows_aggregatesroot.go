...
func init() {
	...
	analytics_flows_aggregatesCmd.Short = utils.GenerateCustomDescription(analytics_flows_aggregatesCmd.Short, analytics_flows_aggregates_jobs.Description, analytics_flows_aggregates_query.Description, )
