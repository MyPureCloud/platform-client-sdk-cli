## gc workforcemanagement businessunits weeks schedules generate create
...
```
gc workforcemanagement businessunits weeks schedules generate create [businessUnitId] [weekId] [flags]
```
