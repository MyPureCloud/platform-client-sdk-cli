...
func init() {
	...
	voicemail_meCmd.Short = utils.GenerateCustomDescription(voicemail_meCmd.Short, voicemail_me_mailbox.Description, voicemail_me_policy.Description, voicemail_me_messages.Description, )
