## gc workforcemanagement businessunits activityplans update
...
```
gc workforcemanagement businessunits activityplans update [businessUnitId] [activityPlanId] [flags]
```
