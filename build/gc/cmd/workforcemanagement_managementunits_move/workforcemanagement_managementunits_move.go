...
func Cmdworkforcemanagement_managementunits_move() *cobra.Command { 
	createCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", createCmd.UsageTemplate(), "POST", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/move", utils.FormatPermissions([]string{ "wfm:managementUnit:edit",  })))
  ...
  &quot;required&quot; : false,
  &quot;schema&quot; : {
    &quot;$ref&quot; : &quot;#/definitions/MoveManagementUnitRequest&quot;
  }
}`)
  ...
  &quot;schema&quot; : {
    &quot;$ref&quot; : &quot;#/definitions/MoveManagementUnitResponse&quot;
  }
}`)
