...
func init() {
	...
	analytics_casemanagement_aggregatesCmd.Short = utils.GenerateCustomDescription(analytics_casemanagement_aggregatesCmd.Short, analytics_casemanagement_aggregates_jobs.Description, analytics_casemanagement_aggregates_query.Description, )
