...
func init() {
	...
	outbound_contactlists_contacts_bulkCmd.Short = utils.GenerateCustomDescription(outbound_contactlists_contacts_bulkCmd.Short, outbound_contactlists_contacts_bulk_update.Description, outbound_contactlists_contacts_bulk_remove.Description, )
