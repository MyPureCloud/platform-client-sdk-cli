package dataextensions_coretypes
...
var (
	Description = utils.FormatUsageDescription("dataextensions_coretypes", "SWAGGER_OVERRIDE_/api/v2/dataextensions/coretypes", "SWAGGER_OVERRIDE_/api/v2/dataextensions/coretypes", )
	dataextensions_coretypesCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("dataextensions_coretypes"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(dataextensions_coretypesCmd)
}
...
func Cmddataextensions_coretypes() *cobra.Command { 
  ...
  "content" : {
	...
	dataextensions_coretypesCmd.AddCommand(listCmd)
	return dataextensions_coretypesCmd
}
...
var getCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/dataextensions/coretypes/{coretypeName}"
...
var listCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/dataextensions/coretypes"
