## gc workforcemanagement businessunits servicegoaltemplates update
...
```
gc workforcemanagement businessunits servicegoaltemplates update [businessUnitId] [serviceGoalTemplateId] [flags]
```
