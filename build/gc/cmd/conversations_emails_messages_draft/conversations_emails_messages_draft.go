...
func Cmdconversations_emails_messages_draft() *cobra.Command { 
  ...
  "content" : {
	...
	utils.AddFlag(updateCmd.Flags(), "bool", "autoFill", "", "autoFill")
	utils.AddFlag(updateCmd.Flags(), "bool", "discard", "", "discard")
	updateCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", updateCmd.UsageTemplate(), "PATCH", "/api/v2/conversations/emails/{conversationId}/messages/draft", utils.FormatPermissions([]string{  }), utils.GenerateDevCentreLink("PATCH", "Conversations", "/api/v2/conversations/emails/{conversationId}/messages/draft")))
