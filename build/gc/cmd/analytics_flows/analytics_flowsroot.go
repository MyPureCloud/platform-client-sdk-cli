...
func init() {
	...
	analytics_flowsCmd.Short = utils.GenerateCustomDescription(analytics_flowsCmd.Short, analytics_flows_aggregates.Description, analytics_flows_activity.Description, analytics_flows_observations.Description, )
