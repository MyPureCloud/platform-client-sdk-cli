...
func init() {
	...
	externalcontactsCmd.Short = utils.GenerateCustomDescription(externalcontactsCmd.Short, externalcontacts_organizations.Description, externalcontacts_contacts.Description, externalcontacts_conversations.Description, externalcontacts_relationships.Description, externalcontacts_scan.Description, externalcontacts_bulk.Description, externalcontacts_reversewhitepageslookup.Description, )
