package authorization_roles_subjectgrants
...
var (
	Description = utils.FormatUsageDescription("authorization_roles_subjectgrants", "SWAGGER_OVERRIDE_/api/v2/authorization/roles/{roleId}/subjectgrants", )
	authorization_roles_subjectgrantsCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("authorization_roles_subjectgrants"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(authorization_roles_subjectgrantsCmd)
}

func Cmdauthorization_roles_subjectgrants() *cobra.Command { 
	...
	listCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", listCmd.UsageTemplate(), "GET", "/api/v2/authorization/roles/{roleId}/subjectgrants", utils.FormatPermissions([]string{ "authorization:role:view",  }), utils.GenerateDevCentreLink("GET", "Authorization", "/api/v2/authorization/roles/{roleId}/subjectgrants")))
  ...
  "content" : {
	...
	authorization_roles_subjectgrantsCmd.AddCommand(listCmd)
	return authorization_roles_subjectgrantsCmd
}
