...
func init() {
	...
	scimCmd.Short = utils.GenerateCustomDescription(scimCmd.Short, scim_schemas.Description, scim_users.Description, scim_serviceproviderconfig.Description, scim_v2.Description, scim_groups.Description, scim_resourcetypes.Description, )
