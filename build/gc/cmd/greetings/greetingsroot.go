...
func init() {
	...
	greetingsCmd.Short = utils.GenerateCustomDescription(greetingsCmd.Short, greetings_users.Description, greetings_groups.Description, greetings_downloads.Description, greetings_media.Description, greetings_defaults.Description, )
