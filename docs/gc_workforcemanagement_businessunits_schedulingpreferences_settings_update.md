## gc workforcemanagement businessunits schedulingpreferences settings update
...
```
gc workforcemanagement businessunits schedulingpreferences settings update [businessUnitId] [flags]
```
