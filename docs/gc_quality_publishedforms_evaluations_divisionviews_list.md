## gc quality publishedforms evaluations divisionviews list
...
```
gc quality publishedforms evaluations divisionviews list [flags]
```
...
```
  ...
  -h, --help                     help for list
      --id strings               A comma-delimited list of valid, published evaluation form ids - REQUIRED
      --name string              Name
