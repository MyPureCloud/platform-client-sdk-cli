...
func init() {
	...
	workforcemanagement_businessunitsCmd.Short = utils.GenerateCustomDescription(workforcemanagement_businessunitsCmd.Short, workforcemanagement_businessunits_scheduling.Description, workforcemanagement_businessunits_managementunits.Description, workforcemanagement_businessunits_planninggroups.Description, workforcemanagement_businessunits_agentschedules.Description, workforcemanagement_businessunits_servicegoaltemplates.Description, workforcemanagement_businessunits_weeks.Description, workforcemanagement_businessunits_activitycodes.Description, workforcemanagement_businessunits_divisionviews.Description, workforcemanagement_businessunits_intraday.Description, )
