## gc knowledge knowledgebases languages documents update
...
```
gc knowledge knowledgebases languages documents update [documentId] [knowledgeBaseId] [languageCode] [flags]
```
