...
var (
	Description = utils.FormatUsageDescription("analytics_reporting_exports", "SWAGGER_OVERRIDE_/api/v2/analytics/reporting/exports", "SWAGGER_OVERRIDE_/api/v2/analytics/reporting/exports", )
	analytics_reporting_exportsCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("analytics_reporting_exports"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(analytics_reporting_exportsCmd)
}
...
var createCmd = &cobra.Command{
	Use:   "create",
	Short: "Generate a view export request",
	Long:  "Generate a view export request",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if printReqBody {
			...
			reqModel := models.Reportingexportjobrequest{}
		...
		path := "/api/v2/analytics/reporting/exports"
...
var listCmd = &cobra.Command{
	Use:   "list",
	Short: "Get all view export requests for a user",
	Long:  "Get all view export requests for a user",
	Args:  utils.DetermineArgs([]string{ }),
