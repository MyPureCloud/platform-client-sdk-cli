...
func init() {
	...
	journey_deploymentsCmd.Short = utils.GenerateCustomDescription(journey_deploymentsCmd.Short, journey_deployments_actionevent.Description, journey_deployments_appevents.Description, journey_deployments_customers.Description, )
