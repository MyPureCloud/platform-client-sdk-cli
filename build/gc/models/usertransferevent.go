...
var (
    UsertransfereventMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type UsertransfereventDud struct { 
...
func (u *Usertransferevent) MarshalJSON() ([]byte, error) {
    type Alias Usertransferevent

    if UsertransfereventMarshalled {
        return []byte("{}"), nil
    }
    UsertransfereventMarshalled = true
