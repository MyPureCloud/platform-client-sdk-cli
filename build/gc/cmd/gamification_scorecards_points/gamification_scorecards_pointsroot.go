...
func init() {
	...
	gamification_scorecards_pointsCmd.Short = utils.GenerateCustomDescription(gamification_scorecards_pointsCmd.Short, gamification_scorecards_points_alltime.Description, gamification_scorecards_points_average.Description, gamification_scorecards_points_trends.Description, )
