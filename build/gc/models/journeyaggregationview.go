...
var (
    JourneyaggregationviewMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type JourneyaggregationviewDud struct { 
...
func (u *Journeyaggregationview) MarshalJSON() ([]byte, error) {
    type Alias Journeyaggregationview

    if JourneyaggregationviewMarshalled {
        return []byte("{}"), nil
    }
    JourneyaggregationviewMarshalled = true
