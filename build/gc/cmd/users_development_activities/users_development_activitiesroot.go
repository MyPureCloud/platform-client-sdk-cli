...
func init() {
	...
	users_development_activitiesCmd.Short = utils.GenerateCustomDescription(users_development_activitiesCmd.Short, users_development_activities_me.Description, users_development_activities_aggregates.Description, )
