...
var (
    BulkentityerrornoteMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type BulkentityerrornoteDud struct { 
...
func (u *Bulkentityerrornote) MarshalJSON() ([]byte, error) {
    type Alias Bulkentityerrornote

    if BulkentityerrornoteMarshalled {
        return []byte("{}"), nil
    }
    BulkentityerrornoteMarshalled = true
