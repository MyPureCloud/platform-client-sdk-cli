...
func Cmdworkforcemanagement_businessunits_weeks_shorttermforecasts_data() *cobra.Command { 
	...
	getCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", getCmd.UsageTemplate(), "GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekDateId}/shorttermforecasts/{forecastId}/data", utils.FormatPermissions([]string{ "wfm:shortTermForecast:view",  })))
