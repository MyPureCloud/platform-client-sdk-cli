## gc workforcemanagement businessunits alternativeshifts settings update
...
```
gc workforcemanagement businessunits alternativeshifts settings update [businessUnitId] [flags]
```
