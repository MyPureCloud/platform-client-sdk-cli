...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/recordings_retention"
...
func init() {
	...
	recordingsCmd.AddCommand(recordings_retention.Cmdrecordings_retention())
	recordingsCmd.AddCommand(recordings_screensessions.Cmdrecordings_screensessions())
	recordingsCmd.Short = utils.GenerateCustomDescription(recordingsCmd.Short, recordings_deletionprotection.Description, recordings_retention.Description, recordings_screensessions.Description, )
