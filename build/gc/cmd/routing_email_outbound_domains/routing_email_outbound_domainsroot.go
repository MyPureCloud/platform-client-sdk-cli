...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/routing_email_outbound_domains_testconnection"
...
func init() {
	...
	routing_email_outbound_domainsCmd.AddCommand(routing_email_outbound_domains_testconnection.Cmdrouting_email_outbound_domains_testconnection())
	...
	routing_email_outbound_domainsCmd.Short = utils.GenerateCustomDescription(routing_email_outbound_domainsCmd.Short, routing_email_outbound_domains_activation.Description, routing_email_outbound_domains_testconnection.Description, routing_email_outbound_domains_simulated.Description, )
