...
func init() {
	...
	conversations_emailsCmd.Short = utils.GenerateCustomDescription(conversations_emailsCmd.Short, conversations_emails_participants.Description, conversations_emails_agentless.Description, conversations_emails_settings.Description, conversations_emails_messages.Description, conversations_emails_inboundmessages.Description, conversations_emails_recordingstate.Description, )
