...
func init() {
	...
	conversations_calls_participantsCmd.Short = utils.GenerateCustomDescription(conversations_calls_participantsCmd.Short, conversations_calls_participants_wrapupcodes.Description, conversations_calls_participants_monitor.Description, conversations_calls_participants_coach.Description, conversations_calls_participants_consult.Description, conversations_calls_participants_attributes.Description, conversations_calls_participants_communications.Description, conversations_calls_participants_wrapup.Description, conversations_calls_participants_replace.Description, )
