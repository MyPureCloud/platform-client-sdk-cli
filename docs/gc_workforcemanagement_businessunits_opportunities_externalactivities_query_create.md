## gc workforcemanagement businessunits opportunities externalactivities query create
...
```
gc workforcemanagement businessunits opportunities externalactivities query create [businessUnitId] [flags]
```
