...
var (
    TranscriptsearchcriteriaMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type TranscriptsearchcriteriaDud struct { 
...
func (u *Transcriptsearchcriteria) MarshalJSON() ([]byte, error) {
    type Alias Transcriptsearchcriteria

    if TranscriptsearchcriteriaMarshalled {
        return []byte("{}"), nil
    }
