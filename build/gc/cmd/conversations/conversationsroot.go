...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/conversations_recordingstate"
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/conversations_communications"
...
func init() {
	...
	conversationsCmd.AddCommand(conversations_recordingstate.Cmdconversations_recordingstate())
	...
	conversationsCmd.AddCommand(conversations_communications.Cmdconversations_communications())
	...
	conversationsCmd.Short = utils.GenerateCustomDescription(conversationsCmd.Short, conversations_cobrowse.Description, conversations_keyconfigurations.Description, conversations_participants.Description, conversations_disconnect.Description, conversations_assign.Description, conversations_tags.Description, conversations_utilizationlabel.Description, conversations_secureattributes.Description, conversations_recordingstate.Description, conversations_barge.Description, conversations_faxes.Description, conversations_settings.Description, conversations_aftercallwork.Description, conversations_callbacks.Description, conversations_calls.Description, conversations_chats.Description, conversations_cobrowsesessions.Description, conversations_emails.Description, conversations_internalmessages.Description, conversations_messages.Description, conversations_screenshares.Description, conversations_socials.Description, conversations_videos.Description, conversations_communications.Description, conversations_messaging.Description, conversations_suggestions.Description, conversations_summaries.Description, conversations_recordingmetadata.Description, conversations_recordings.Description, )
