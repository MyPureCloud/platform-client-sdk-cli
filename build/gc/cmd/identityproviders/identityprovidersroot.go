...
func init() {
	...
	identityprovidersCmd.Short = utils.GenerateCustomDescription(identityprovidersCmd.Short, identityproviders_onelogin.Description, identityproviders_pureengage.Description, identityproviders_identitynow.Description, identityproviders_adfs.Description, identityproviders_cic.Description, identityproviders_generic.Description, identityproviders_ping.Description, identityproviders_gsuite.Description, identityproviders_purecloud.Description, identityproviders_salesforce.Description, identityproviders_okta.Description, )
