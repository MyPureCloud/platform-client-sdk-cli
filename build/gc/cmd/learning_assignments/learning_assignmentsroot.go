...
func init() {
	...
	learning_assignmentsCmd.Short = utils.GenerateCustomDescription(learning_assignmentsCmd.Short, learning_assignments_aggregates.Description, learning_assignments_reset.Description, learning_assignments_reschedule.Description, learning_assignments_me.Description, learning_assignments_reassign.Description, learning_assignments_bulkadd.Description, learning_assignments_bulkremove.Description, learning_assignments_steps.Description, )
