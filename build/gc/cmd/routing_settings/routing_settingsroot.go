...
func init() {
	...
	routing_settingsCmd.Short = utils.GenerateCustomDescription(routing_settingsCmd.Short, routing_settings_contactcenter.Description, routing_settings_transcription.Description, )
