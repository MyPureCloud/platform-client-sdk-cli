...
var (
	Description = utils.FormatUsageDescription("quality_surveys", "SWAGGER_OVERRIDE_/api/v2/quality/surveys", "SWAGGER_OVERRIDE_/api/v2/quality/surveys", )
...
func Cmdquality_surveys() *cobra.Command { 
	createCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", createCmd.UsageTemplate(), "POST", "/api/v2/quality/surveys", utils.FormatPermissions([]string{ "quality:survey:add",  }), utils.GenerateDevCentreLink("POST", "Quality", "/api/v2/quality/surveys")))
	utils.AddFileFlagIfUpsert(createCmd.Flags(), "POST", `{
  "description" : "Survey creation request",
  "content" : {
    "application/json" : {
      "schema" : {
  ...
  "content" : {
	...
	quality_surveysCmd.AddCommand(createCmd)
...
var createCmd = &cobra.Command{
	Use:   "create",
	Short: "Create a survey for a conversation",
	Long:  "Create a survey for a conversation",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if printReqBody {
			...
			reqModel := models.Createsurveyrequest{}
