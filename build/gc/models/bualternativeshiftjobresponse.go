...
var (
    BualternativeshiftjobresponseMarshalled = false
)
...
func (o *Bualternativeshiftjobresponse) String() string {
...
func (u *Bualternativeshiftjobresponse) MarshalJSON() ([]byte, error) {
    type Alias Bualternativeshiftjobresponse

    if BualternativeshiftjobresponseMarshalled {
        return []byte("{}"), nil
    }
