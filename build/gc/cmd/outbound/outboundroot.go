...
func init() {
	...
	outboundCmd.Short = utils.GenerateCustomDescription(outboundCmd.Short, outbound_campaigns.Description, outbound_attemptlimits.Description, outbound_callanalysisresponsesets.Description, outbound_callabletimesets.Description, outbound_campaignrules.Description, outbound_schedules.Description, outbound_contactlists.Description, outbound_contactlistfilters.Description, outbound_contactlisttemplates.Description, outbound_audits.Description, outbound_conversations.Description, outbound_dnclists.Description, outbound_events.Description, outbound_importtemplates.Description, outbound_messagingcampaigns.Description, outbound_settings.Description, outbound_rulesets.Description, outbound_sequences.Description, outbound_wrapupcodemappings.Description, outbound_digitalrulesets.Description, )
