...
var (
	ivrCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("ivr"),
		Short: utils.FormatUsageDescription("Manages Genesys Cloud ivr", "", "", "", "", "", ),
		Long:  utils.FormatUsageDescription(`Manages Genesys Cloud ivr`, "", "", "", "", "", ),
	}
	CommandService services.CommandService
)

func init() {
	CommandService = services.NewCommandService(ivrCmd)
}

func Cmdivr() *cobra.Command { 
  ...
  &quot;description&quot; : &quot;successful operation&quot;,
  &quot;schema&quot; : {
    &quot;$ref&quot; : &quot;#/definitions/IVREntityListing&quot;
  }
}`)
	ivrCmd.AddCommand(listCmd)
