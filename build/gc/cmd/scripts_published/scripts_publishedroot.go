...
func init() {
	...
	scripts_publishedCmd.Short = utils.GenerateCustomDescription(scripts_publishedCmd.Short, scripts_published_variables.Description, scripts_published_pages.Description, )
