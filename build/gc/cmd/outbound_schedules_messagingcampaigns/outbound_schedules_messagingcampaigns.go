package outbound_schedules_messagingcampaigns
...
var (
	Description = utils.FormatUsageDescription("outbound_schedules_messagingcampaigns", "SWAGGER_OVERRIDE_/api/v2/outbound/schedules/messagingcampaigns", "SWAGGER_OVERRIDE_/api/v2/outbound/schedules/messagingcampaigns", "SWAGGER_OVERRIDE_/api/v2/outbound/schedules/messagingcampaigns", "SWAGGER_OVERRIDE_/api/v2/outbound/schedules/messagingcampaigns", )
	outbound_schedules_messagingcampaignsCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("outbound_schedules_messagingcampaigns"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(outbound_schedules_messagingcampaignsCmd)
}
...
func Cmdoutbound_schedules_messagingcampaigns() *cobra.Command { 
  ...
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/MessagingCampaignSchedule"
      }
    }
  }
}`)
  ...
  "content" : {
	...
	outbound_schedules_messagingcampaignsCmd.AddCommand(updateCmd)
	return outbound_schedules_messagingcampaignsCmd
}

var deleteCmd = &cobra.Command{
	Use:   "delete [messagingCampaignId]",
	Short: "Delete a messaging campaign schedule.",
	Long:  "Delete a messaging campaign schedule.",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/outbound/schedules/messagingcampaigns/{messagingCampaignId}"
...
var getCmd = &cobra.Command{
	...
	Short: "Get a messaging campaign schedule.",
	Long:  "Get a messaging campaign schedule.",
	Args:  utils.DetermineArgs([]string{ "messagingCampaignId", }),
...
var listCmd = &cobra.Command{
	Use:   "list",
	Short: "Query for a list of messaging campaign schedules.",
	Long:  "Query for a list of messaging campaign schedules.",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/outbound/schedules/messagingcampaigns"
...
var updateCmd = &cobra.Command{
	...
	Short: "Update a new messaging campaign schedule.",
	Long:  "Update a new messaging campaign schedule.",
	Args:  utils.DetermineArgs([]string{ "messagingCampaignId", }),
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if printReqBody {
			...
			reqModel := models.Messagingcampaignschedule{}
