## gc workforcemanagement businessunits timeofflimits granularityconversion create
...
```
gc workforcemanagement businessunits timeofflimits granularityconversion create [businessUnitId] [timeOffLimitId] [flags]
```
