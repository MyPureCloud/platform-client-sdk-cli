...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/responsemanagement_libraries_divisionviews"
)
...
func init() {
	...
	responsemanagement_librariesCmd.AddCommand(responsemanagement_libraries_divisionviews.Cmdresponsemanagement_libraries_divisionviews())
	responsemanagement_librariesCmd.Short = utils.GenerateCustomDescription(responsemanagement_librariesCmd.Short, responsemanagement_libraries_bulk.Description, responsemanagement_libraries_query.Description, responsemanagement_libraries_divisionviews.Description, )
