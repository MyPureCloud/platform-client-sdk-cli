package casemanagement_cases_references
...
var (
	Description = utils.FormatUsageDescription("casemanagement_cases_references", "SWAGGER_OVERRIDE_/api/v2/casemanagement/cases/references", )
	casemanagement_cases_referencesCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("casemanagement_cases_references"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(casemanagement_cases_referencesCmd)
}
...
func Cmdcasemanagement_cases_references() *cobra.Command { 
  ...
  "content" : {
	...
	casemanagement_cases_referencesCmd.AddCommand(getCmd)
	return casemanagement_cases_referencesCmd
}
...
var getCmd = &cobra.Command{
	Use:   "get [referenceId]",
	Short: "Get a Case by reference.",
	Long:  "Get a Case by reference.",
	Args:  utils.DetermineArgs([]string{ "referenceId", }),
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/casemanagement/cases/references/{referenceId}"
