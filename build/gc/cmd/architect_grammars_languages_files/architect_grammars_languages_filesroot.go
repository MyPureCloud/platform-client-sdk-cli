...
func init() {
	...
	architect_grammars_languages_filesCmd.Short = utils.GenerateCustomDescription(architect_grammars_languages_filesCmd.Short, architect_grammars_languages_files_dtmf.Description, architect_grammars_languages_files_voice.Description, )
