...
var (
    BotaggregatequerypredicateMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type BotaggregatequerypredicateDud struct { 
...
func (u *Botaggregatequerypredicate) MarshalJSON() ([]byte, error) {
    ...
    if BotaggregatequerypredicateMarshalled {
        return []byte("{}"), nil
    }
    BotaggregatequerypredicateMarshalled = true
