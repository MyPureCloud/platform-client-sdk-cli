...
var (
    RoutingactivityentitydataMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type RoutingactivityentitydataDud struct { 
...
func (u *Routingactivityentitydata) MarshalJSON() ([]byte, error) {
    type Alias Routingactivityentitydata

    if RoutingactivityentitydataMarshalled {
        return []byte("{}"), nil
    }
    RoutingactivityentitydataMarshalled = true
