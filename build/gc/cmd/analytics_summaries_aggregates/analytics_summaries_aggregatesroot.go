...
func init() {
	...
	analytics_summaries_aggregatesCmd.Short = utils.GenerateCustomDescription(analytics_summaries_aggregatesCmd.Short, analytics_summaries_aggregates_jobs.Description, analytics_summaries_aggregates_query.Description, )
