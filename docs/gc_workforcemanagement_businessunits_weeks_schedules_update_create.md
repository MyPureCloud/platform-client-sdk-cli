## gc workforcemanagement businessunits weeks schedules update create
...
```
gc workforcemanagement businessunits weeks schedules update create [businessUnitId] [weekId] [scheduleId] [flags]
```
