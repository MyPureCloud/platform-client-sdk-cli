...
func Cmdoutbound_campaignrules() *cobra.Command { 
	createCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", createCmd.UsageTemplate(), "POST", "/api/v2/outbound/campaignrules", utils.FormatPermissions([]string{ "outbound:campaignRule:add",  })))
  ...
  &quot;schema&quot; : {
	...
	deleteCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", deleteCmd.UsageTemplate(), "DELETE", "/api/v2/outbound/campaignrules/{campaignRuleId}", utils.FormatPermissions([]string{ "outbound:campaignRule:delete",  })))
  ...
  &quot;description&quot; : &quot;Operation was successful.&quot;
	...
	getCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", getCmd.UsageTemplate(), "GET", "/api/v2/outbound/campaignrules/{campaignRuleId}", utils.FormatPermissions([]string{ "outbound:campaignRule:view",  })))
  ...
  &quot;schema&quot; : {
	...
	listCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", listCmd.UsageTemplate(), "GET", "/api/v2/outbound/campaignrules", utils.FormatPermissions([]string{ "outbound:campaignRule:view",  })))
  ...
  &quot;schema&quot; : {
	...
	updateCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", updateCmd.UsageTemplate(), "PUT", "/api/v2/outbound/campaignrules/{campaignRuleId}", utils.FormatPermissions([]string{ "outbound:campaignRule:edit",  })))
