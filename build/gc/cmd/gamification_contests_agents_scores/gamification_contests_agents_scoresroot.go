...
func init() {
	...
	gamification_contests_agents_scoresCmd.Short = utils.GenerateCustomDescription(gamification_contests_agents_scoresCmd.Short, gamification_contests_agents_scores_trends.Description, gamification_contests_agents_scores_me.Description, )
