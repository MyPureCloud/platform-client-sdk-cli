## gc telephony providers edges logicalinterfaces getedgelogicalinterfaces
...
```
gc telephony providers edges logicalinterfaces getedgelogicalinterfaces [edgeId] [flags]
```
...
```
  ...
  -h, --help                     help for getedgelogicalinterfaces
