...
var (
	Description = utils.FormatUsageDescription("teams", "SWAGGER_OVERRIDE_/api/v2/teams", "SWAGGER_OVERRIDE_/api/v2/teams", "SWAGGER_OVERRIDE_/api/v2/teams", "SWAGGER_OVERRIDE_/api/v2/teams", "SWAGGER_OVERRIDE_/api/v2/teams", )
	teamsCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("teams"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(teamsCmd)
}

func Cmdteams() *cobra.Command { 
	createCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", createCmd.UsageTemplate(), "POST", "/api/v2/teams", utils.FormatPermissions([]string{ "groups:team:add",  }), utils.GenerateDevCentreLink("POST", "Teams", "/api/v2/teams")))
  ...
  "content" : {
	...
	deleteCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", deleteCmd.UsageTemplate(), "DELETE", "/api/v2/teams/{teamId}", utils.FormatPermissions([]string{ "groups:team:delete",  }), utils.GenerateDevCentreLink("DELETE", "Teams", "/api/v2/teams/{teamId}")))
	utils.AddFileFlagIfUpsert(deleteCmd.Flags(), "DELETE", ``)
	
	utils.AddPaginateFlagsIfListingResponse(deleteCmd.Flags(), "DELETE", `{
  "description" : "Success, team was deleted",
  "content" : { }
}`)
  ...
  "content" : {
	...
	updateCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", updateCmd.UsageTemplate(), "PATCH", "/api/v2/teams/{teamId}", utils.FormatPermissions([]string{ "groups:team:edit",  }), utils.GenerateDevCentreLink("PATCH", "Teams", "/api/v2/teams/{teamId}")))
...
var listCmd = &cobra.Command{
	Use:   "list",
	Short: "Get Team listing",
	Long:  "Get Team listing",
	Args:  utils.DetermineArgs([]string{ }),
