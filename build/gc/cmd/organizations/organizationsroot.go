...
func init() {
	...
	organizationsCmd.Short = utils.GenerateCustomDescription(organizationsCmd.Short, organizations_limits.Description, organizations_ipaddressauthentication.Description, organizations_embeddedintegration.Description, organizations_me.Description, organizations_features.Description, organizations_whitelist.Description, )
