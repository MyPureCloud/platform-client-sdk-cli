...
func init() {
	...
	workforcemanagement_agentschedulesCmd.Short = utils.GenerateCustomDescription(workforcemanagement_agentschedulesCmd.Short, workforcemanagement_agentschedules_mine.Description, )
