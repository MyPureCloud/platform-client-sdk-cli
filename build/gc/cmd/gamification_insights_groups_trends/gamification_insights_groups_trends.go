...
var (
	Description = utils.FormatUsageDescription("gamification_insights_groups_trends", "SWAGGER_OVERRIDE_/api/v2/gamification/insights/groups/trends", )
	gamification_insights_groups_trendsCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("gamification_insights_groups_trends"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(gamification_insights_groups_trendsCmd)
}

func Cmdgamification_insights_groups_trends() *cobra.Command { 
	...
	utils.AddFlag(listCmd.Flags(), "string", "granularity", "", "Granularity - REQUIRED Valid values: Daily, Weekly, Monthly")
	...
	listCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", listCmd.UsageTemplate(), "GET", "/api/v2/gamification/insights/groups/trends", utils.FormatPermissions([]string{ "gamification:insights:view",  }), utils.GenerateDevCentreLink("GET", "Gamification", "/api/v2/gamification/insights/groups/trends")))
  ...
  "content" : {
	...
	gamification_insights_groups_trendsCmd.AddCommand(listCmd)
	return gamification_insights_groups_trendsCmd
}
...
var listCmd = &cobra.Command{
	Use:   "list",
	Short: "Get insights overall trend for the current user",
	Long:  "Get insights overall trend for the current user",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/gamification/insights/groups/trends"
