...
var (
    DataactioncontactcolumnfieldmappingMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type DataactioncontactcolumnfieldmappingDud struct { 
...
func (u *Dataactioncontactcolumnfieldmapping) MarshalJSON() ([]byte, error) {
    type Alias Dataactioncontactcolumnfieldmapping

    if DataactioncontactcolumnfieldmappingMarshalled {
        return []byte("{}"), nil
    }
    DataactioncontactcolumnfieldmappingMarshalled = true
