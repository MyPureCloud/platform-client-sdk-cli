...
func init() {
	...
	analytics_reporting_schedulesCmd.Short = utils.GenerateCustomDescription(analytics_reporting_schedulesCmd.Short, analytics_reporting_schedules_runreport.Description, analytics_reporting_schedules_history.Description, )
