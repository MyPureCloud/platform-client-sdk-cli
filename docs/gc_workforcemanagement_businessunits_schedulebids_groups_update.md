## gc workforcemanagement businessunits schedulebids groups update
...
```
gc workforcemanagement businessunits schedulebids groups update [businessUnitId] [bidId] [bidGroupId] [flags]
```
