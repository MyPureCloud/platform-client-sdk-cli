...
var (
    CopilotasyncaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type CopilotasyncaggregationqueryDud struct { 
...
type Copilotasyncaggregationquery struct { 
    ...
    Filter Copilotaggregatequeryfilter `json:"filter"`
    ...
    Views []Copilotaggregationview `json:"views"`
...
func (o *Copilotasyncaggregationquery) String() string {
     ...
     o.Views = []Copilotaggregationview{{}} 
...
func (u *Copilotasyncaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Copilotasyncaggregationquery

    if CopilotasyncaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    CopilotasyncaggregationqueryMarshalled = true
