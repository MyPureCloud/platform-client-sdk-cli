...
var (
    AgentcopilotaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type AgentcopilotaggregationqueryDud struct { 
...
func (u *Agentcopilotaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Agentcopilotaggregationquery

    if AgentcopilotaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    AgentcopilotaggregationqueryMarshalled = true
