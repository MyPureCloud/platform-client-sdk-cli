package routing_email_domains_routes_identityresolution
...
var (
	Description = utils.FormatUsageDescription("routing_email_domains_routes_identityresolution", "SWAGGER_OVERRIDE_/api/v2/routing/email/domains/{domainName}/routes/{routeId}/identityresolution", "SWAGGER_OVERRIDE_/api/v2/routing/email/domains/{domainName}/routes/{routeId}/identityresolution", )
	routing_email_domains_routes_identityresolutionCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("routing_email_domains_routes_identityresolution"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(routing_email_domains_routes_identityresolutionCmd)
}
...
func Cmdrouting_email_domains_routes_identityresolution() *cobra.Command { 
  ...
  "content" : {
	...
	routing_email_domains_routes_identityresolutionCmd.AddCommand(updateCmd)
	return routing_email_domains_routes_identityresolutionCmd
}
...
var getCmd = &cobra.Command{
	...
	Short: "Get a route identity resolution setting.",
	Long:  "Get a route identity resolution setting.",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/routing/email/domains/{domainName}/routes/{routeId}/identityresolution"
...
var updateCmd = &cobra.Command{
	...
	Short: "Update identity resolution settings for a route.",
	Long:  "Update identity resolution settings for a route.",
	Args:  utils.DetermineArgs([]string{ "domainName", "routeId", }),
