...
func init() {
	...
	diagnostics_logcapture_browserCmd.Short = utils.GenerateCustomDescription(diagnostics_logcapture_browserCmd.Short, diagnostics_logcapture_browser_entries.Description, )
