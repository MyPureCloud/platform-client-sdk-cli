...
var (
	schedulegroupsCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("schedulegroups"),
		Short: utils.FormatUsageDescription("Manages Genesys Cloud schedulegroups", "", "", "", "", "", ),
		Long:  utils.FormatUsageDescription(`Manages Genesys Cloud schedulegroups`, "", "", "", "", "", ),
	}
	CommandService services.CommandService
)

func init() {
	CommandService = services.NewCommandService(schedulegroupsCmd)
}

func Cmdschedulegroups() *cobra.Command { 
  ...
  &quot;schema&quot; : {
	...
	schedulegroupsCmd.AddCommand(createCmd)
  ...
  &quot;description&quot; : &quot;Operation was successful.&quot;
	...
	schedulegroupsCmd.AddCommand(deleteCmd)
  ...
  &quot;schema&quot; : {
	...
	schedulegroupsCmd.AddCommand(getCmd)
  ...
  &quot;description&quot; : &quot;successful operation&quot;,
  &quot;schema&quot; : {
    &quot;$ref&quot; : &quot;#/definitions/ScheduleGroupEntityListing&quot;
  }
}`)
	schedulegroupsCmd.AddCommand(listCmd)
  ...
  &quot;schema&quot; : {
	...
	schedulegroupsCmd.AddCommand(updateCmd)
	
	return schedulegroupsCmd
}
