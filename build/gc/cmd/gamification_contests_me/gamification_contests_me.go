package gamification_contests_me
...
var (
	Description = utils.FormatUsageDescription("gamification_contests_me", "SWAGGER_OVERRIDE_/api/v2/gamification/contests/me", )
	gamification_contests_meCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("gamification_contests_me"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(gamification_contests_meCmd)
}

func Cmdgamification_contests_me() *cobra.Command { 
	...
	utils.AddFlag(listCmd.Flags(), "string", "view", "participant", " Valid values: participant, creator")
	listCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", listCmd.UsageTemplate(), "GET", "/api/v2/gamification/contests/me", utils.FormatPermissions([]string{ "gamification:contest:view",  }), utils.GenerateDevCentreLink("GET", "Gamification", "/api/v2/gamification/contests/me")))
  ...
  "content" : {
	...
	gamification_contests_meCmd.AddCommand(listCmd)
	return gamification_contests_meCmd
}
...
var listCmd = &cobra.Command{
	Use:   "list",
	Short: "Get a List of Contests (Agent/Supervisor)",
	Long:  "Get a List of Contests (Agent/Supervisor)",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/gamification/contests/me"
		...
		view := utils.GetFlag(cmd.Flags(), "string", "view")
		if view != "" {
