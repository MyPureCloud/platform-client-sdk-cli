...
func Cmdconversations_messaging_integrations_twitter() *cobra.Command { 
	createCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", createCmd.UsageTemplate(), "POST", "/api/v2/conversations/messaging/integrations/twitter", utils.FormatPermissions([]string{ "messaging:integration:add",  })))
  ...
  &quot;schema&quot; : {
	...
	deleteCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", deleteCmd.UsageTemplate(), "DELETE", "/api/v2/conversations/messaging/integrations/twitter/{integrationId}", utils.FormatPermissions([]string{ "messaging:integration:delete",  })))
  ...
  &quot;description&quot; : &quot;Operation was successful&quot;
	...
	getCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", getCmd.UsageTemplate(), "GET", "/api/v2/conversations/messaging/integrations/twitter/{integrationId}", utils.FormatPermissions([]string{ "messaging:integration:view",  })))
  ...
  &quot;schema&quot; : {
	...
	listCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", listCmd.UsageTemplate(), "GET", "/api/v2/conversations/messaging/integrations/twitter", utils.FormatPermissions([]string{ "messaging:integration:view",  })))
  ...
  &quot;schema&quot; : {
	...
	updateCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", updateCmd.UsageTemplate(), "PATCH", "/api/v2/conversations/messaging/integrations/twitter/{integrationId}", utils.FormatPermissions([]string{ "messaging:integration:edit",  })))
