...
var (
    TeamssearchresponseMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type TeamssearchresponseDud struct { 
...
func (u *Teamssearchresponse) MarshalJSON() ([]byte, error) {
    type Alias Teamssearchresponse

    if TeamssearchresponseMarshalled {
        return []byte("{}"), nil
    }
    TeamssearchresponseMarshalled = true
