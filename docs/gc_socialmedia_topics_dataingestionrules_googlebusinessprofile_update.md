## gc socialmedia topics dataingestionrules googlebusinessprofile update
...
```
gc socialmedia topics dataingestionrules googlebusinessprofile update [topicId] [googleBusinessProfileIngestionRuleId] [flags]
```
