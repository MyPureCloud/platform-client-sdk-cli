package knowledge_knowledgebases_sources_salesforce_sync
...
var (
	Description = utils.FormatUsageDescription("knowledge_knowledgebases_sources_salesforce_sync", "SWAGGER_OVERRIDE_/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/sources/salesforce/{sourceId}/sync", )
	knowledge_knowledgebases_sources_salesforce_syncCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("knowledge_knowledgebases_sources_salesforce_sync"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(knowledge_knowledgebases_sources_salesforce_syncCmd)
}
...
func Cmdknowledge_knowledgebases_sources_salesforce_sync() *cobra.Command { 
  ...
  "content" : {
	...
	knowledge_knowledgebases_sources_salesforce_syncCmd.AddCommand(createCmd)
	return knowledge_knowledgebases_sources_salesforce_syncCmd
}
...
var createCmd = &cobra.Command{
	...
	Short: "Start sync on Salesforce Knowledge integration source",
	Long:  "Start sync on Salesforce Knowledge integration source",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/sources/salesforce/{sourceId}/sync"
