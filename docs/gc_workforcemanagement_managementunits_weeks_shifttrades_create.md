## gc workforcemanagement managementunits weeks shifttrades create
...
```
gc workforcemanagement managementunits weeks shifttrades create [managementUnitId] [weekDateId] [flags]
```
