...
var (
	Description = utils.FormatUsageDescription("mobiledevices", "SWAGGER_OVERRIDE_/api/v2/mobiledevices", "SWAGGER_OVERRIDE_/api/v2/mobiledevices", "SWAGGER_OVERRIDE_/api/v2/mobiledevices", "SWAGGER_OVERRIDE_/api/v2/mobiledevices", "SWAGGER_OVERRIDE_/api/v2/mobiledevices", )
	mobiledevicesCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("mobiledevices"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(mobiledevicesCmd)
}
