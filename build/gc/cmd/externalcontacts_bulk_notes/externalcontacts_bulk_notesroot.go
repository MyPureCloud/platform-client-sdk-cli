...
func init() {
	...
	externalcontacts_bulk_notesCmd.Short = utils.GenerateCustomDescription(externalcontacts_bulk_notesCmd.Short, externalcontacts_bulk_notes_update.Description, externalcontacts_bulk_notes_add.Description, externalcontacts_bulk_notes_remove.Description, )
