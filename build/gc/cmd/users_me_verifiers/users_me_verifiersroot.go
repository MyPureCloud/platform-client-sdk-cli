...
func init() {
	...
	users_me_verifiersCmd.Short = utils.GenerateCustomDescription(users_me_verifiersCmd.Short, users_me_verifiers_webauthn.Description, users_me_verifiers_totp.Description, )
