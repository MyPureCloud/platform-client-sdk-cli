...
func init() {
	...
	groupsCmd.Short = utils.GenerateCustomDescription(groupsCmd.Short, groups_individuals.Description, groups_members.Description, groups_profile.Description, groups_search.Description, groups_greetings.Description, )
