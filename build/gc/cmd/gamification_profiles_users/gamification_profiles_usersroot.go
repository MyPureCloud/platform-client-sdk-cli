...
func init() {
	...
	gamification_profiles_usersCmd.Short = utils.GenerateCustomDescription(gamification_profiles_usersCmd.Short, gamification_profiles_users_query.Description, gamification_profiles_users_me.Description, )
