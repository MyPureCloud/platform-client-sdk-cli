...
func init() {
	...
	webdeploymentsCmd.Short = utils.GenerateCustomDescription(webdeploymentsCmd.Short, webdeployments_token.Description, webdeployments_configurations.Description, webdeployments_deployments.Description, )
