package conversations_calls_participants_user
...
func init() {
	CommandService = services.NewCommandService(conversations_calls_participants_userCmd)
}

func Cmdconversations_calls_participants_user() *cobra.Command { 
	createCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", createCmd.UsageTemplate(), "POST", "/api/v2/conversations/calls/{conversationId}/participants/user/{userId}", utils.FormatPermissions([]string{ "conversation:agentlessCall:add",  }), utils.GenerateDevCentreLink("POST", "Conversations", "/api/v2/conversations/calls/{conversationId}/participants/user/{userId}")))
...
var createCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/conversations/calls/{conversationId}/participants/user/{userId}"
