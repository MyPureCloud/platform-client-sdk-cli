...
func init() {
	...
	externalcontacts_identifierlookupCmd.Short = utils.GenerateCustomDescription(externalcontacts_identifierlookupCmd.Short, externalcontacts_identifierlookup_contacts.Description, externalcontacts_identifierlookup_organizations.Description, )
