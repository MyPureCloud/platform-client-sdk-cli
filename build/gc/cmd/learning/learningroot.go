...
func init() {
	...
	learningCmd.Short = utils.GenerateCustomDescription(learningCmd.Short, learning_modules.Description, learning_assignments.Description, learning_rules.Description, )
