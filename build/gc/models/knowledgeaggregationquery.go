...
var (
    KnowledgeaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type KnowledgeaggregationqueryDud struct { 
...
type Knowledgeaggregationquery struct { 
...
func (o *Knowledgeaggregationquery) String() string {
...
func (u *Knowledgeaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Knowledgeaggregationquery

    if KnowledgeaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    KnowledgeaggregationqueryMarshalled = true
