...
func Cmdscim_groups() *cobra.Command { 
  ...
  "content" : {
	...
	utils.AddFlag(replaceCmd.Flags(), "string", "ifMatch", "", "The ETag of a resource in double quotes. Returned as header and meta.version with initial call to GET /api/v2/scim/groups/{groupId}. Example: 42. If the ETag is different from the version on the server, returns 400 with a scimType of invalidVers.")
  ...
  "content" : {
	...
	utils.AddFlag(updateCmd.Flags(), "string", "ifMatch", "", "The ETag of a resource in double quotes. Returned as header and meta.version with initial call to GET /api/v2/scim/groups/{groupId}. Example: 42. If the ETag is different from the version on the server, returns 400 with a scimType of invalidVers.")
