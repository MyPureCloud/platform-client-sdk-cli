package dependencies_type_id_connections_requiredby
...
var (
	Description = utils.FormatUsageDescription("dependencies_type_id_connections_requiredby", "SWAGGER_OVERRIDE_/api/v2/dependencies/type/{entityType}/id/{entityId}/connections/requiredby", )
	dependencies_type_id_connections_requiredbyCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("dependencies_type_id_connections_requiredby"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(dependencies_type_id_connections_requiredbyCmd)
}

func Cmddependencies_type_id_connections_requiredby() *cobra.Command { 
	...
	listCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", listCmd.UsageTemplate(), "GET", "/api/v2/dependencies/type/{entityType}/id/{entityId}/connections/requiredby", utils.FormatPermissions([]string{ "dependencies:dependency:view",  }), utils.GenerateDevCentreLink("GET", "Dependencies", "/api/v2/dependencies/type/{entityType}/id/{entityId}/connections/requiredby")))
  ...
  "content" : {
	...
	dependencies_type_id_connections_requiredbyCmd.AddCommand(listCmd)
	return dependencies_type_id_connections_requiredbyCmd
}
...
var listCmd = &cobra.Command{
	...
	Short: "Get entities that require the given entity",
	Long:  "Get entities that require the given entity",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/dependencies/type/{entityType}/id/{entityId}/connections/requiredby"
