package outbound_attemptlimits
...
var (
	Description = utils.FormatUsageDescription("outbound_attemptlimits", "SWAGGER_OVERRIDE_/api/v2/outbound/attemptlimits", "SWAGGER_OVERRIDE_/api/v2/outbound/attemptlimits", "SWAGGER_OVERRIDE_/api/v2/outbound/attemptlimits", "SWAGGER_OVERRIDE_/api/v2/outbound/attemptlimits", "SWAGGER_OVERRIDE_/api/v2/outbound/attemptlimits", )
	outbound_attemptlimitsCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("outbound_attemptlimits"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(outbound_attemptlimitsCmd)
}
...
var createCmd = &cobra.Command{
	Use:   "create",
	Short: "Create attempt limits",
	Long:  "Create attempt limits",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/outbound/attemptlimits"
...
var deleteCmd = &cobra.Command{
	Use:   "delete [attemptLimitsId]",
	Short: "Delete attempt limits",
	Long:  "Delete attempt limits",
	Args:  utils.DetermineArgs([]string{ "attemptLimitsId", }),
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/outbound/attemptlimits/{attemptLimitsId}"
		attemptLimitsId, args := args[0], args[1:]
...
var getCmd = &cobra.Command{
	Use:   "get [attemptLimitsId]",
	Short: "Get attempt limits",
	Long:  "Get attempt limits",
	Args:  utils.DetermineArgs([]string{ "attemptLimitsId", }),
...
var listCmd = &cobra.Command{
	Use:   "list",
	Short: "Query attempt limits list",
	Long:  "Query attempt limits list",
	Args:  utils.DetermineArgs([]string{ }),
...
var updateCmd = &cobra.Command{
	Use:   "update [attemptLimitsId]",
	Short: "Update attempt limits",
	Long:  "Update attempt limits",
	Args:  utils.DetermineArgs([]string{ "attemptLimitsId", }),
