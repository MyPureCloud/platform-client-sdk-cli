...
func init() {
	...
	contentmanagementCmd.Short = utils.GenerateCustomDescription(contentmanagementCmd.Short, contentmanagement_documents.Description, contentmanagement_query.Description, contentmanagement_securityprofiles.Description, contentmanagement_shares.Description, contentmanagement_shared.Description, contentmanagement_status.Description, contentmanagement_workspaces.Description, contentmanagement_usage.Description, )
