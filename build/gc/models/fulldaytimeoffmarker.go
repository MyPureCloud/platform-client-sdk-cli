...
var (
    FulldaytimeoffmarkerMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type FulldaytimeoffmarkerDud struct { 
...
func (u *Fulldaytimeoffmarker) MarshalJSON() ([]byte, error) {
    type Alias Fulldaytimeoffmarker

    if FulldaytimeoffmarkerMarshalled {
        return []byte("{}"), nil
    }
    FulldaytimeoffmarkerMarshalled = true
