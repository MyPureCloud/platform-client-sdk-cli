...
func init() {
	...
	users_presencesCmd.Short = utils.GenerateCustomDescription(users_presencesCmd.Short, users_presences_bulk.Description, users_presences_purecloud.Description, )
