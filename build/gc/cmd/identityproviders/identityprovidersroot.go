...
func init() {
	...
	identityprovidersCmd.Short = utils.GenerateCustomDescription(identityprovidersCmd.Short, identityproviders_pureengage.Description, identityproviders_generic.Description, identityproviders_gsuite.Description, identityproviders_ping.Description, identityproviders_purecloud.Description, identityproviders_identitynow.Description, identityproviders_adfs.Description, identityproviders_salesforce.Description, identityproviders_onelogin.Description, identityproviders_okta.Description, identityproviders_cic.Description, )
