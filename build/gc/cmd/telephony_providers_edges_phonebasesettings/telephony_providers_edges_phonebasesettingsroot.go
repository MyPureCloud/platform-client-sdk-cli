...
func init() {
	...
	telephony_providers_edges_phonebasesettingsCmd.Short = utils.GenerateCustomDescription(telephony_providers_edges_phonebasesettingsCmd.Short, telephony_providers_edges_phonebasesettings_template.Description, telephony_providers_edges_phonebasesettings_availablemetabases.Description, )
