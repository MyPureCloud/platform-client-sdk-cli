...
func Cmdlearning_modules() *cobra.Command { 
	createCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", createCmd.UsageTemplate(), "POST", "/api/v2/learning/modules", utils.FormatPermissions([]string{ "learning:module:add",  })))
  ...
  &quot;schema&quot; : {
	...
	deleteCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", deleteCmd.UsageTemplate(), "DELETE", "/api/v2/learning/modules/{moduleId}", utils.FormatPermissions([]string{ "learning:module:delete",  })))
  ...
  &quot;description&quot; : &quot;The learning module was deleted successfully&quot;
	...
	getCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", getCmd.UsageTemplate(), "GET", "/api/v2/learning/modules/{moduleId}", utils.FormatPermissions([]string{ "learning:module:view",  })))
  ...
  &quot;schema&quot; : {
	...
	utils.AddFlag(listCmd.Flags(), "[]string", "types", "", "Specifies the module types. Valid values: Informational, AssessedContent, Questionnaire")
	...
	listCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", listCmd.UsageTemplate(), "GET", "/api/v2/learning/modules", utils.FormatPermissions([]string{ "learning:module:view",  })))
  ...
  &quot;schema&quot; : {
	...
	updateCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", updateCmd.UsageTemplate(), "PUT", "/api/v2/learning/modules/{moduleId}", utils.FormatPermissions([]string{ "learning:module:edit",  })))
