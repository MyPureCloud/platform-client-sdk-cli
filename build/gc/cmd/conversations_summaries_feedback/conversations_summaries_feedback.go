...
var (
	Description = utils.FormatUsageDescription("conversations_summaries_feedback", "SWAGGER_OVERRIDE_/api/v2/conversations/{conversationId}/summaries/{summaryId}/feedback", )
