...
func init() {
	...
	conversations_cobrowsesessionsCmd.Short = utils.GenerateCustomDescription(conversations_cobrowsesessionsCmd.Short, conversations_cobrowsesessions_recordingstate.Description, conversations_cobrowsesessions_participants.Description, )
