...
func init() {
	...
	externalcontacts_bulkCmd.Short = utils.GenerateCustomDescription(externalcontacts_bulkCmd.Short, externalcontacts_bulk_contacts.Description, externalcontacts_bulk_notes.Description, externalcontacts_bulk_organizations.Description, externalcontacts_bulk_relationships.Description, )
