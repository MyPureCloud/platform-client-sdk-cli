...
var (
    SurveyasyncaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type SurveyasyncaggregationqueryDud struct { 
...
type Surveyasyncaggregationquery struct { 
...
func (o *Surveyasyncaggregationquery) String() string {
...
func (u *Surveyasyncaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Surveyasyncaggregationquery

    if SurveyasyncaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    SurveyasyncaggregationqueryMarshalled = true
