...
var (
    CommunicationdispositionappliedeventMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type CommunicationdispositionappliedeventDud struct { 
...
func (u *Communicationdispositionappliedevent) MarshalJSON() ([]byte, error) {
    type Alias Communicationdispositionappliedevent

    if CommunicationdispositionappliedeventMarshalled {
        return []byte("{}"), nil
    }
    CommunicationdispositionappliedeventMarshalled = true
