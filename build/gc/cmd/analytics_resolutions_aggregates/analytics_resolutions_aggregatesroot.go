...
func init() {
	...
	analytics_resolutions_aggregatesCmd.Short = utils.GenerateCustomDescription(analytics_resolutions_aggregatesCmd.Short, analytics_resolutions_aggregates_jobs.Description, analytics_resolutions_aggregates_query.Description, )
