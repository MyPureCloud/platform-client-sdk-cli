...
var (
    FlowasyncaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type FlowasyncaggregationqueryDud struct { 
...
type Flowasyncaggregationquery struct { 
...
func (o *Flowasyncaggregationquery) String() string {
...
func (u *Flowasyncaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Flowasyncaggregationquery

    if FlowasyncaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    FlowasyncaggregationqueryMarshalled = true
