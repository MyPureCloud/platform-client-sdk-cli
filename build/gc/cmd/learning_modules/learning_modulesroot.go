...
func init() {
	...
	learning_modulesCmd.Short = utils.GenerateCustomDescription(learning_modulesCmd.Short, learning_modules_preview.Description, learning_modules_jobs.Description, learning_modules_versions.Description, learning_modules_coverart.Description, learning_modules_assignments.Description, learning_modules_users.Description, learning_modules_publish.Description, learning_modules_rule.Description, )
