...
var (
	Description = utils.FormatUsageDescription("users_presences_bulk", "SWAGGER_OVERRIDE_/api/v2/users/presences/{sourceId}/bulk", "SWAGGER_OVERRIDE_/api/v2/users/presences/bulk", )
...
func Cmdusers_presences_bulk() *cobra.Command { 
	...
	getCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", getCmd.UsageTemplate(), "GET", "/api/v2/users/presences/{sourceId}/bulk", utils.FormatPermissions([]string{  }), utils.GenerateDevCentreLink("GET", "Presence", "/api/v2/users/presences/{sourceId}/bulk")))
  ...
  "content" : {
	...
	users_presences_bulkCmd.AddCommand(getCmd)
...
var getCmd = &cobra.Command{
	Use:   "get [sourceId]",
	Short: "Get bulk user presences for a single presence source",
	Long:  "Get bulk user presences for a single presence source",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path := "/api/v2/users/presences/{sourceId}/bulk"
