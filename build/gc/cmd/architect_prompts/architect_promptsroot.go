...
func init() {
	...
	architect_promptsCmd.Short = utils.GenerateCustomDescription(architect_promptsCmd.Short, architect_prompts_history.Description, architect_prompts_resources.Description, )
