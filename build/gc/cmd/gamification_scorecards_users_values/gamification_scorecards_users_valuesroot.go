...
func init() {
	...
	gamification_scorecards_users_valuesCmd.Short = utils.GenerateCustomDescription(gamification_scorecards_users_valuesCmd.Short, gamification_scorecards_users_values_trends.Description, gamification_scorecards_users_values_average.Description, )
