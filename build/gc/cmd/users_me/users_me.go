...
func Cmdusers_me() *cobra.Command { 
	...
	utils.AddFlag(getCmd.Flags(), "string", "integrationPresenceSource", "", "Get your presence for a given integration. This parameter will only be used when presence is provided as an expand. Valid values: MicrosoftTeams, ZoomPhone, EightByEight, RingCentral")
