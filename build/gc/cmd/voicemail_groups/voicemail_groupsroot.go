...
func init() {
	...
	voicemail_groupsCmd.Short = utils.GenerateCustomDescription(voicemail_groupsCmd.Short, voicemail_groups_messages.Description, voicemail_groups_policy.Description, voicemail_groups_mailbox.Description, )
