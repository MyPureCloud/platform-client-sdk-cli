...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/quality_programs"
...
func init() {
	...
	qualityCmd.AddCommand(quality_programs.Cmdquality_programs())
	...
	qualityCmd.Short = utils.GenerateCustomDescription(qualityCmd.Short, quality_surveys.Description, quality_agents.Description, quality_programs.Description, quality_calibrations.Description, quality_conversations.Description, quality_evaluations.Description, quality_forms.Description, quality_evaluators.Description, quality_publishedforms.Description, )
