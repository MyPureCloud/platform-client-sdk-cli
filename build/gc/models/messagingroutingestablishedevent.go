...
var (
    MessagingroutingestablishedeventMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type MessagingroutingestablishedeventDud struct { 
...
func (u *Messagingroutingestablishedevent) MarshalJSON() ([]byte, error) {
    type Alias Messagingroutingestablishedevent

    if MessagingroutingestablishedeventMarshalled {
        return []byte("{}"), nil
    }
    MessagingroutingestablishedeventMarshalled = true
