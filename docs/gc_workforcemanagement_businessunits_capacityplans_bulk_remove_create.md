## gc workforcemanagement businessunits capacityplans bulk remove create
...
```
gc workforcemanagement businessunits capacityplans bulk remove create [businessUnitId] [flags]
```
