...
func init() {
	...
	recordingCmd.Short = utils.GenerateCustomDescription(recordingCmd.Short, recording_crossplatform.Description, recording_recordingkeys.Description, recording_mediaretentionpolicies.Description, recording_jobs.Description, recording_localkeys.Description, recording_settings.Description, recording_batchrequests.Description, )
