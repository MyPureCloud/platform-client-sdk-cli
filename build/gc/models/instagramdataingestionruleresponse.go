...
var (
    InstagramdataingestionruleresponseMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type InstagramdataingestionruleresponseDud struct { 
...
type Instagramdataingestionruleresponse struct { 
...
func (u *Instagramdataingestionruleresponse) MarshalJSON() ([]byte, error) {
    type Alias Instagramdataingestionruleresponse

    if InstagramdataingestionruleresponseMarshalled {
        return []byte("{}"), nil
    }
    InstagramdataingestionruleresponseMarshalled = true
