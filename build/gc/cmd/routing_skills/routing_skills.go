...
var (
	Description = utils.FormatUsageDescription("routing_skills", "SWAGGER_OVERRIDE_/api/v2/routing/skills", "SWAGGER_OVERRIDE_/api/v2/routing/skills", "SWAGGER_OVERRIDE_/api/v2/routing/skills", "SWAGGER_OVERRIDE_/api/v2/routing/skills", "SWAGGER_OVERRIDE_/api/v2/routing/skills", )
	routing_skillsCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("routing_skills"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(routing_skillsCmd)
}
...
func Cmdrouting_skills() *cobra.Command { 
  ...
  "content" : {
	...
	routing_skillsCmd.AddCommand(getCmd)
  ...
  "content" : {
	...
	routing_skillsCmd.AddCommand(listCmd)

	updateCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", updateCmd.UsageTemplate(), "PATCH", "/api/v2/routing/skills/{skillId}", utils.FormatPermissions([]string{ "routing:skill:update",  }), utils.GenerateDevCentreLink("PATCH", "Routing", "/api/v2/routing/skills/{skillId}")))
	utils.AddFileFlagIfUpsert(updateCmd.Flags(), "PATCH", `{
  "description" : "updateSkillDivisionRequest",
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/UpdateSkillDivisionRequest"
      }
    }
  },
  "required" : true
  ...
  "content" : {
	...
	routing_skillsCmd.AddCommand(updateCmd)
	return routing_skillsCmd
}
...
var updateCmd = &cobra.Command{
	Use:   "update [skillId]",
	Short: "Update Routing Skill Division",
	Long:  "Update Routing Skill Division",
	Args:  utils.DetermineArgs([]string{ "skillId", }),
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if printReqBody {
			...
			reqModel := models.Updateskilldivisionrequest{}
			utils.Render(reqModel.String())
