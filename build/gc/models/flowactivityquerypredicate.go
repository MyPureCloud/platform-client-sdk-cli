...
var (
    FlowactivityquerypredicateMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type FlowactivityquerypredicateDud struct { 
...
func (u *Flowactivityquerypredicate) MarshalJSON() ([]byte, error) {
    type Alias Flowactivityquerypredicate

    if FlowactivityquerypredicateMarshalled {
        return []byte("{}"), nil
    }
    FlowactivityquerypredicateMarshalled = true
