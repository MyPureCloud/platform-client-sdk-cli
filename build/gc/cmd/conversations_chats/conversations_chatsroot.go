...
func init() {
	...
	conversations_chatsCmd.Short = utils.GenerateCustomDescription(conversations_chatsCmd.Short, conversations_chats_communications.Description, conversations_chats_participants.Description, conversations_chats_messages.Description, )
