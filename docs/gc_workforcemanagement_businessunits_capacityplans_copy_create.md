## gc workforcemanagement businessunits capacityplans copy create
...
```
gc workforcemanagement businessunits capacityplans copy create [businessUnitId] [capacityPlanId] [flags]
```
