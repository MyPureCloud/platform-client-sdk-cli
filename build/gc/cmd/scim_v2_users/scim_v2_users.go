...
func Cmdscim_v2_users() *cobra.Command { 
	createCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", createCmd.UsageTemplate(), "POST", "/api/v2/scim/v2/users", utils.FormatPermissions([]string{ "directory:user:add", "authorization:grant:add", "authorization:grant:delete", "routing:skill:assign", "routing:language:assign", "telephony:extension:assign",  }), utils.GenerateDevCentreLink("POST", "SCIM", "/api/v2/scim/v2/users")))
  ...
  "content" : {
	...
	utils.AddFlag(deleteCmd.Flags(), "string", "ifMatch", "", "The ETag of a resource in double quotes. Returned as header and meta.version with initial call to GET /api/v2/scim/v2/users/{userId}. Example: 42. If the ETag is different from the version on the server, returns 400 with a scimType of invalidVers.")
	deleteCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", deleteCmd.UsageTemplate(), "DELETE", "/api/v2/scim/v2/users/{userId}", utils.FormatPermissions([]string{ "directory:user:delete",  }), utils.GenerateDevCentreLink("DELETE", "SCIM", "/api/v2/scim/v2/users/{userId}")))
  ...
  "content" : {
	...
	utils.AddFlag(getCmd.Flags(), "string", "ifNoneMatch", "", "The ETag of a resource in double quotes. Returned as header and meta.version with initial call to GET /api/v2/scim/v2/users/{userId}. Example: 42. If the ETag is different from the version on the server, returns the current configuration of the resource. If the ETag is current, returns 304 Not Modified.")
	getCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", getCmd.UsageTemplate(), "GET", "/api/v2/scim/v2/users/{userId}", utils.FormatPermissions([]string{  }), utils.GenerateDevCentreLink("GET", "SCIM", "/api/v2/scim/v2/users/{userId}")))
  ...
  "content" : {
	...
	listCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", listCmd.UsageTemplate(), "GET", "/api/v2/scim/v2/users", utils.FormatPermissions([]string{  }), utils.GenerateDevCentreLink("GET", "SCIM", "/api/v2/scim/v2/users")))
  ...
  "content" : {
	...
	utils.AddFlag(modifyCmd.Flags(), "string", "ifMatch", "", "The ETag of a resource in double quotes. Returned as header and meta.version with initial call to GET /api/v2/scim/v2/users/{userId}. Example: 42. If the ETag is different from the version on the server, returns 400 with a scimType of invalidVers.")
	modifyCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", modifyCmd.UsageTemplate(), "PATCH", "/api/v2/scim/v2/users/{userId}", utils.FormatPermissions([]string{ "directory:user:edit", "directory:user:setPassword", "authorization:grant:add", "authorization:grant:delete", "routing:skill:assign", "routing:language:assign", "telephony:extension:assign",  }), utils.GenerateDevCentreLink("PATCH", "SCIM", "/api/v2/scim/v2/users/{userId}")))
  ...
  "content" : {
	...
	utils.AddFlag(replaceCmd.Flags(), "string", "ifMatch", "", "The ETag of a resource in double quotes. Returned as header and meta.version with initial call to GET /api/v2/scim/v2/users/{userId}. Example: 42. If the ETag is different from the version on the server, returns 400 with a scimType of invalidVers.")
	replaceCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s\n%s", replaceCmd.UsageTemplate(), "PUT", "/api/v2/scim/v2/users/{userId}", utils.FormatPermissions([]string{ "directory:user:edit", "directory:user:setPassword", "authorization:grant:add", "authorization:grant:delete", "routing:skill:assign", "routing:language:assign", "telephony:extension:assign",  }), utils.GenerateDevCentreLink("PUT", "SCIM", "/api/v2/scim/v2/users/{userId}")))
...
var deleteCmd = &cobra.Command{
	...
	"application/json",
		...
		ifMatch := utils.GetFlag(cmd.Flags(), "string", "ifMatch")
		if ifMatch != "" {
...
var getCmd = &cobra.Command{
	...
	"application/json",
		...
		ifNoneMatch := utils.GetFlag(cmd.Flags(), "string", "ifNoneMatch")
		if ifNoneMatch != "" {
