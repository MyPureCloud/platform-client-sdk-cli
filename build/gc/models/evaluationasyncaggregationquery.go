...
var (
    EvaluationasyncaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type EvaluationasyncaggregationqueryDud struct { 
...
type Evaluationasyncaggregationquery struct { 
...
func (o *Evaluationasyncaggregationquery) String() string {
     ...
     o.Views = []Evaluationaggregationview{{}} 
...
func (u *Evaluationasyncaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Evaluationasyncaggregationquery

    if EvaluationasyncaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    EvaluationasyncaggregationqueryMarshalled = true
    ...
    return json.Marshal(&struct {
        ...
        *Alias
        ...
        Views: []Evaluationaggregationview{{}},
