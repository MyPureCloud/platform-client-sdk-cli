...
func init() {
	...
	speechandtextanalytics_topicsCmd.Short = utils.GenerateCustomDescription(speechandtextanalytics_topicsCmd.Short, speechandtextanalytics_topics_general.Description, speechandtextanalytics_topics_publishjobs.Description, )
