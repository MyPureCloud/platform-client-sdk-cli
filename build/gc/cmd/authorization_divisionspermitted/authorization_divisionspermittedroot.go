...
func init() {
	...
	authorization_divisionspermittedCmd.Short = utils.GenerateCustomDescription(authorization_divisionspermittedCmd.Short, authorization_divisionspermitted_me.Description, authorization_divisionspermitted_paged.Description, )
