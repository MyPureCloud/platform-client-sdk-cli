...
func init() {
	...
	analytics_conversations_detailsCmd.Short = utils.GenerateCustomDescription(analytics_conversations_detailsCmd.Short, analytics_conversations_details_jobs.Description, analytics_conversations_details_query.Description, analytics_conversations_details_properties.Description, )
