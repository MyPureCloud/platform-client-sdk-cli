...
var (
    QueuefullreferenceMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type QueuefullreferenceDud struct { 
...
// Queuefullreference
type Queuefullreference struct { 
...
func (o *Queuefullreference) String() string {
...
func (u *Queuefullreference) MarshalJSON() ([]byte, error) {
    type Alias Queuefullreference

    if QueuefullreferenceMarshalled {
        return []byte("{}"), nil
    }
    QueuefullreferenceMarshalled = true
