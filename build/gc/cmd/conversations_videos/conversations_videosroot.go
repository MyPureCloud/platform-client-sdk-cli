...
func init() {
	...
	conversations_videosCmd.Short = utils.GenerateCustomDescription(conversations_videosCmd.Short, conversations_videos_meetings.Description, conversations_videos_recordingstate.Description, conversations_videos_participants.Description, conversations_videos_agentconference.Description, conversations_videos_details.Description, )
