...
func init() {
	...
	oauth_clients_usageCmd.Short = utils.GenerateCustomDescription(oauth_clients_usageCmd.Short, oauth_clients_usage_summary.Description, oauth_clients_usage_query.Description, )
