...
func init() {
	...
	quality_forms_evaluationsCmd.Short = utils.GenerateCustomDescription(quality_forms_evaluationsCmd.Short, quality_forms_evaluations_versions.Description, quality_forms_evaluations_bulk.Description, quality_forms_evaluations_aiscoring.Description, )
