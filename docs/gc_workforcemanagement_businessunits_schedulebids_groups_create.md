## gc workforcemanagement businessunits schedulebids groups create
...
```
gc workforcemanagement businessunits schedulebids groups create [businessUnitId] [bidId] [flags]
```
