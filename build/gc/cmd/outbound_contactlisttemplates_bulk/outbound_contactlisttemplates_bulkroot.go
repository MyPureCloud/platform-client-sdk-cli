...
func init() {
	...
	outbound_contactlisttemplates_bulkCmd.Short = utils.GenerateCustomDescription(outbound_contactlisttemplates_bulkCmd.Short, outbound_contactlisttemplates_bulk_add.Description, )
