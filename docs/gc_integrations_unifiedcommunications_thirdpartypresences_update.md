## gc integrations unifiedcommunications thirdpartypresences update
...
```
gc integrations unifiedcommunications thirdpartypresences update [ucIntegrationId] [flags]
```
