...
func Cmdworkforcemanagement_businessunits() *cobra.Command { 
  ...
  "content" : { }
	...
	utils.AddFlag(getCmd.Flags(), "[]string", "expand", "", "Include to access additional data on the business unit Valid values: settings, settings.timeZone, settings.startDayOfWeek, settings.shortTermForecasting, settings.scheduling")
