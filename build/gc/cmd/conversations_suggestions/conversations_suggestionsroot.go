...
func init() {
	...
	conversations_suggestionsCmd.Short = utils.GenerateCustomDescription(conversations_suggestionsCmd.Short, conversations_suggestions_feedback.Description, conversations_suggestions_engagement.Description, )
