...
func init() {
	...
	flowsCmd.Short = utils.GenerateCustomDescription(flowsCmd.Short, flows_datatables.Description, flows_actions.Description, flows_executions.Description, flows_milestones.Description, flows_outcomes.Description, flows_history.Description, flows_latestconfiguration.Description, flows_versions.Description, flows_divisionviews.Description, )
