## gc workforcemanagement businessunits activitycodes update
...
```
gc workforcemanagement businessunits activitycodes update [businessUnitId] [activityCodeId] [flags]
```
