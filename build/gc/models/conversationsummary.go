...
var (
    ConversationsummaryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type ConversationsummaryDud struct { 
...
func (u *Conversationsummary) MarshalJSON() ([]byte, error) {
    type Alias Conversationsummary

    if ConversationsummaryMarshalled {
        return []byte("{}"), nil
    }
    ConversationsummaryMarshalled = true
