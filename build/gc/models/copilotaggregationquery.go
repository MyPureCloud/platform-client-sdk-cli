...
var (
    CopilotaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type CopilotaggregationqueryDud struct { 
...
type Copilotaggregationquery struct { 
...
func (o *Copilotaggregationquery) String() string {
...
func (u *Copilotaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Copilotaggregationquery

    if CopilotaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    CopilotaggregationqueryMarshalled = true
