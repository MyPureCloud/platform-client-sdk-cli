...
func init() {
	...
	usersCmd.Short = utils.GenerateCustomDescription(usersCmd.Short, users_roles.Description, users_callforwarding.Description, users_directreports.Description, users_favorites.Description, users_adjacents.Description, users_superiors.Description, users_profile.Description, users_geolocations.Description, users_greetings.Description, users_outofoffice.Description, users_presences.Description, users_me.Description, users_password.Description, users_profileskills.Description, users_queues.Description, users_invite.Description, users_routinglanguages.Description, users_routingskills.Description, users_routingstatus.Description, users_state.Description, users_station.Description, users_trustors.Description, users_bulk.Description, users_search.Description, users_development.Description, )
