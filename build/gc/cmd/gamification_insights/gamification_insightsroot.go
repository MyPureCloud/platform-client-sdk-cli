...
func init() {
	...
	gamification_insightsCmd.Short = utils.GenerateCustomDescription(gamification_insightsCmd.Short, gamification_insights_users.Description, gamification_insights_details.Description, gamification_insights_members.Description, gamification_insights_groups.Description, gamification_insights_trends.Description, )
