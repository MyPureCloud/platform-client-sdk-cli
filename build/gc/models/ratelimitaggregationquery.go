...
var (
    RatelimitaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type RatelimitaggregationqueryDud struct { 
...
type Ratelimitaggregationquery struct { 
    ...
    Filter Ratelimitaggregatequeryfilter `json:"filter"`
    ...
    Views []Ratelimitaggregationview `json:"views"`
...
func (o *Ratelimitaggregationquery) String() string {
     ...
     o.Views = []Ratelimitaggregationview{{}} 
...
func (u *Ratelimitaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Ratelimitaggregationquery

    if RatelimitaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    RatelimitaggregationqueryMarshalled = true
    ...
    return json.Marshal(&struct {
        ...
        *Alias
        ...
        Views: []Ratelimitaggregationview{{}},
