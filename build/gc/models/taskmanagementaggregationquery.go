...
var (
    TaskmanagementaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type TaskmanagementaggregationqueryDud struct { 
...
type Taskmanagementaggregationquery struct { 
...
func (o *Taskmanagementaggregationquery) String() string {
...
func (u *Taskmanagementaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Taskmanagementaggregationquery

    if TaskmanagementaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    TaskmanagementaggregationqueryMarshalled = true
