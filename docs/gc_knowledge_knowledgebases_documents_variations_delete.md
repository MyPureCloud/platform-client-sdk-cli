## gc knowledge knowledgebases documents variations delete
...
```
gc knowledge knowledgebases documents variations delete [documentVariationId] [documentId] [knowledgeBaseId] [flags]
```
