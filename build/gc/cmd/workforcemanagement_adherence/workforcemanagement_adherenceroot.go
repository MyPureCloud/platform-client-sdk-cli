...
func init() {
	...
	workforcemanagement_adherenceCmd.Short = utils.GenerateCustomDescription(workforcemanagement_adherenceCmd.Short, workforcemanagement_adherence_historical.Description, )
