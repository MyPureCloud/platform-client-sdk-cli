...
func init() {
	...
	usage_eventsCmd.Short = utils.GenerateCustomDescription(usage_eventsCmd.Short, usage_events_definitions.Description, usage_events_aggregates.Description, usage_events_query.Description, )
