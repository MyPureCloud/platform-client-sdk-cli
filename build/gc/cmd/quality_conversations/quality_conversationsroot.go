...
func init() {
	...
	quality_conversationsCmd.Short = utils.GenerateCustomDescription(quality_conversationsCmd.Short, quality_conversations_surveys.Description, quality_conversations_audits.Description, quality_conversations_evaluations.Description, )
