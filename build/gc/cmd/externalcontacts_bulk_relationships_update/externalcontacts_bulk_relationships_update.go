...
func Cmdexternalcontacts_bulk_relationships_update() *cobra.Command { 
	createCmd.SetUsageTemplate(fmt.Sprintf("%s\nOperation:\n  %s %s\n%s", createCmd.UsageTemplate(), "POST", "/api/v2/externalcontacts/bulk/relationships/update", utils.FormatPermissions([]string{ "externalContacts:contact:edit", "externalContacts:externalOrganization:edit",  })))
