...
var (
    SocialtopicwithdataingestionrulemetadataresponseMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type SocialtopicwithdataingestionrulemetadataresponseDud struct { 
...
type Socialtopicwithdataingestionrulemetadataresponse struct { 
...
func (o *Socialtopicwithdataingestionrulemetadataresponse) String() string {
...
func (u *Socialtopicwithdataingestionrulemetadataresponse) MarshalJSON() ([]byte, error) {
    type Alias Socialtopicwithdataingestionrulemetadataresponse

    if SocialtopicwithdataingestionrulemetadataresponseMarshalled {
        return []byte("{}"), nil
    }
    SocialtopicwithdataingestionrulemetadataresponseMarshalled = true
