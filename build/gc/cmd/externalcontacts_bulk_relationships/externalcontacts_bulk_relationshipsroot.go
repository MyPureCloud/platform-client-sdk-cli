...
func init() {
	...
	externalcontacts_bulk_relationshipsCmd.Short = utils.GenerateCustomDescription(externalcontacts_bulk_relationshipsCmd.Short, externalcontacts_bulk_relationships_remove.Description, externalcontacts_bulk_relationships_update.Description, externalcontacts_bulk_relationships_add.Description, )
