...
func init() {
	...
	flowsCmd.Short = utils.GenerateCustomDescription(flowsCmd.Short, flows_milestones.Description, flows_versions.Description, flows_datatables.Description, flows_latestconfiguration.Description, flows_history.Description, flows_executions.Description, flows_divisionviews.Description, flows_outcomes.Description, flows_actions.Description, )
