...
func init() {
	...
	integrationsCmd.Short = utils.GenerateCustomDescription(integrationsCmd.Short, integrations_speech.Description, integrations_types.Description, integrations_actions.Description, integrations_credentials.Description, integrations_userapps.Description, integrations_eventlog.Description, integrations_config.Description, integrations_workforcemanagement.Description, integrations_clientapps.Description, )
