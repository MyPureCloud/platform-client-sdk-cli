...
func init() {
	...
	conversations_messagingCmd.Short = utils.GenerateCustomDescription(conversations_messagingCmd.Short, conversations_messaging_integrations.Description, conversations_messaging_threadingtimeline.Description, conversations_messaging_facebook.Description, conversations_messaging_settings.Description, conversations_messaging_supportedcontent.Description, )
