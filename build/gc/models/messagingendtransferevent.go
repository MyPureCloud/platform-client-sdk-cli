...
var (
    MessagingendtransfereventMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type MessagingendtransfereventDud struct { 
...
type Messagingendtransferevent struct { 
...
func (o *Messagingendtransferevent) String() string {
...
func (u *Messagingendtransferevent) MarshalJSON() ([]byte, error) {
    type Alias Messagingendtransferevent

    if MessagingendtransfereventMarshalled {
        return []byte("{}"), nil
    }
    MessagingendtransfereventMarshalled = true
