...
func init() {
	...
	telephony_providers_edges_diagnosticCmd.Short = utils.GenerateCustomDescription(telephony_providers_edges_diagnosticCmd.Short, telephony_providers_edges_diagnostic_tracepath.Description, telephony_providers_edges_diagnostic_nslookup.Description, telephony_providers_edges_diagnostic_route.Description, telephony_providers_edges_diagnostic_ping.Description, )
