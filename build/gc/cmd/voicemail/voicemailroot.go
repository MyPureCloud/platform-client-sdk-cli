...
func init() {
	...
	voicemailCmd.Short = utils.GenerateCustomDescription(voicemailCmd.Short, voicemail_groups.Description, voicemail_queues.Description, voicemail_users.Description, voicemail_me.Description, voicemail_mailbox.Description, voicemail_messages.Description, voicemail_policy.Description, voicemail_userpolicies.Description, voicemail_search.Description, )
