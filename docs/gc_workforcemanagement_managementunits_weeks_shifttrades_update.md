## gc workforcemanagement managementunits weeks shifttrades update
...
```
gc workforcemanagement managementunits weeks shifttrades update [managementUnitId] [weekDateId] [tradeId] [flags]
```
