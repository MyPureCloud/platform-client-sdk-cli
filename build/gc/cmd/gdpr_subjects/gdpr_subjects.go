...
func Cmdgdpr_subjects() *cobra.Command { 
	utils.AddFlag(listCmd.Flags(), "string", "searchType", "", "Search Type - REQUIRED Valid values: NAME, ADDRESS, PHONE, EMAIL, TWITTER, INSTAGRAM, FACEBOOK, APPLE_MESSAGES, EXTERNAL_ID")
