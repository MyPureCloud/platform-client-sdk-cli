...
import (
	...
	"github.com/mypurecloud/platform-client-sdk-cli/build/gc/cmd/orgauthorization_trustees_care"
...
func init() {
	...
	orgauthorization_trusteesCmd.AddCommand(orgauthorization_trustees_care.Cmdorgauthorization_trustees_care())
	...
	orgauthorization_trusteesCmd.Short = utils.GenerateCustomDescription(orgauthorization_trusteesCmd.Short, orgauthorization_trustees_audits.Description, orgauthorization_trustees_care.Description, orgauthorization_trustees_default.Description, orgauthorization_trustees_groups.Description, orgauthorization_trustees_users.Description, orgauthorization_trustees_clonedusers.Description, )
