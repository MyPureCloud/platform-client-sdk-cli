...
var (
    WorkplanlistitemresponseMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type WorkplanlistitemresponseDud struct { 
    Id string `json:"id"`
...
func (u *Workplanlistitemresponse) MarshalJSON() ([]byte, error) {
    ...
    if WorkplanlistitemresponseMarshalled {
        return []byte("{}"), nil
    }
    WorkplanlistitemresponseMarshalled = true
