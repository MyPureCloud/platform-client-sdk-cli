package conversations_communications_agentchecklists_jobs
...
var (
	Description = utils.FormatUsageDescription("conversations_communications_agentchecklists_jobs", "SWAGGER_OVERRIDE_/api/v2/conversations/{conversationId}/communications/{communicationId}/agentchecklists/{agentChecklistId}/jobs", "SWAGGER_OVERRIDE_/api/v2/conversations/{conversationId}/communications/{communicationId}/agentchecklists/{agentChecklistId}/jobs", )
	conversations_communications_agentchecklists_jobsCmd = &cobra.Command{
		Use:   utils.FormatUsageDescription("conversations_communications_agentchecklists_jobs"),
		Short: Description,
		Long:  Description,
	}
...
func init() {
	CommandService = services.NewCommandService(conversations_communications_agentchecklists_jobsCmd)
}
...
func Cmdconversations_communications_agentchecklists_jobs() *cobra.Command { 
  ...
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/ChecklistInferenceJobPayload"
      }
    }
  },
  "required" : true
  ...
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/ChecklistInferenceJobCreationResponse"
      }
    }
  }
}`)
  ...
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/ChecklistInferenceJobResponse"
      }
    }
  }
}`)
	conversations_communications_agentchecklists_jobsCmd.AddCommand(getCmd)
	return conversations_communications_agentchecklists_jobsCmd
}
...
var createCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if printReqBody {
			...
			reqModel := models.Checklistinferencejobpayload{}
...
var getCmd = &cobra.Command{
	Use:   "get [conversationId] [communicationId] [agentChecklistId] [jobId]",
	Short: "Get inference job status",
	Long:  "Get inference job status",
	Args:  utils.DetermineArgs([]string{ "conversationId", "communicationId", "agentChecklistId", "jobId", }),
