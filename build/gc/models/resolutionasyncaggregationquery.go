...
var (
    ResolutionasyncaggregationqueryMarshalled = false
)

// This struct is here to use the useless readonly properties so that their required imports don't throw an unused error (time, etc.)
type ResolutionasyncaggregationqueryDud struct { 
...
type Resolutionasyncaggregationquery struct { 
    ...
    Filter Resolutionaggregatequeryfilter `json:"filter"`
...
func (o *Resolutionasyncaggregationquery) String() string {
     ...
     o.Views = []Resolutionaggregationview{{}} 
...
func (u *Resolutionasyncaggregationquery) MarshalJSON() ([]byte, error) {
    type Alias Resolutionasyncaggregationquery

    if ResolutionasyncaggregationqueryMarshalled {
        return []byte("{}"), nil
    }
    ResolutionasyncaggregationqueryMarshalled = true
    ...
    return json.Marshal(&struct {
        ...
        *Alias
        ...
        Views: []Resolutionaggregationview{{}},
